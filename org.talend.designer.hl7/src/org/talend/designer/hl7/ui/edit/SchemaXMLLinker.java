 ...
 */
public class SchemaXMLLinker extends TableToTreeLinker<Object, Object> {
     ...
     * @param table
     */
    public SchemaXMLLinker(Composite commonParent) {
        super(commonParent);
    }
    ...
    private void initListeners() {
        new SchemaXMLDragAndDropHandler(this);
    }
     ...
     * @param dataItem2
     */
    public void addLoopLink(Item tableItem, Object dataItem1, Tree tree, HL7TreeNode dataItem2, boolean lastOne) {
    ...
    public boolean removeLinksFromTreeNode(HL7TreeNode node) {
