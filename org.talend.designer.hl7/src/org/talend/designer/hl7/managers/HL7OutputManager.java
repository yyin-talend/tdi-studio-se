...
public class HL7OutputManager extends HL7Manager {
    ...
    protected List<HL7TreeNode> treeData;

    protected String currentSchema;

    protected Map<String, List<HL7TreeNode>> contents = new HashMap<String, List<HL7TreeNode>>();
    ...
    public void initModel() {
        ...
        for (IConnection connection : incomingConnections) {
            ...
            List<Map<String, String>> groupTable = (List<Map<String, String>>) hl7Component.getTableList(HL7InputComponent.GROUP);
            if (groupTable != null) {
            ...
            currentPath = mainPath;
            isFirst = true;
            List<Map<String, String>> loopTable = (List<Map<String, String>>) hl7Component.getTableList(HL7InputComponent.LOOP);
            if (loopTable != null) {
