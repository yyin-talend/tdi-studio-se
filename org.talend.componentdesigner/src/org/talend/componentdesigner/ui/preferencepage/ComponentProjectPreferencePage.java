...
public class ComponentProjectPreferencePage extends PreferencePage implements IWorkbenchPreferencePage {
	...
	public void init(IWorkbench workbench) {
		setPreferenceStore(ComponentDesigenerPlugin.getDefault()
				.getPreferenceStore());
	}
	...
	protected Control createContents(Composite parent) {
		...
		settingsLabel
				.setText("Choose a project folder for this component desigener"); //$NON-NLS-1$
		...
		if (this.getPreferenceStore().getString(PluginConstant.PROJECT_URL) != null) {
			this.directoryText.setText(getPreferenceStore().getString(
	...
	private String getPathFromDialog() {
	 ...
	 public boolean performOk() {
		ComponentDesigenerPlugin.getDefault().getPreferenceStore().setValue(
				PluginConstant.PROJECT_URL, this.directoryText.getText());
