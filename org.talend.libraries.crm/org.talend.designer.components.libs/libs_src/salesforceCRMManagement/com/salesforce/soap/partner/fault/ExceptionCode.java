...
public class ExceptionCode implements org.apache.axis2.databinding.ADBBean {
	...
	public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
			"urn:fault.partner.soap.sforce.com", "ExceptionCode", "ns3");
	...
	public static final ExceptionCode APEX_TRIGGER_COUPLING_LIMIT = new ExceptionCode(
			_APEX_TRIGGER_COUPLING_LIMIT, true);

	public static final ExceptionCode API_CURRENTLY_DISABLED = new ExceptionCode(
			_API_CURRENTLY_DISABLED, true);

	public static final ExceptionCode API_DISABLED_FOR_ORG = new ExceptionCode(
			_API_DISABLED_FOR_ORG, true);

	public static final ExceptionCode ARGUMENT_OBJECT_PARSE_ERROR = new ExceptionCode(
			_ARGUMENT_OBJECT_PARSE_ERROR, true);

	public static final ExceptionCode CANNOT_DELETE_OWNER = new ExceptionCode(
			_CANNOT_DELETE_OWNER, true);
	...
	public static final ExceptionCode CIRCULAR_OBJECT_GRAPH = new ExceptionCode(
			_CIRCULAR_OBJECT_GRAPH, true);

	public static final ExceptionCode CLIENT_NOT_ACCESSIBLE_FOR_USER = new ExceptionCode(
			_CLIENT_NOT_ACCESSIBLE_FOR_USER, true);

	public static final ExceptionCode CLIENT_REQUIRE_UPDATE_FOR_USER = new ExceptionCode(
			_CLIENT_REQUIRE_UPDATE_FOR_USER, true);

	public static final ExceptionCode CUSTOM_METADATA_LIMIT_EXCEEDED = new ExceptionCode(
			_CUSTOM_METADATA_LIMIT_EXCEEDED, true);

	public static final ExceptionCode DATACLOUD_API_CLIENT_EXCEPTION = new ExceptionCode(
			_DATACLOUD_API_CLIENT_EXCEPTION, true);
	...
	public static final ExceptionCode DATACLOUD_API_SERVER_EXCEPTION = new ExceptionCode(
			_DATACLOUD_API_SERVER_EXCEPTION, true);

	public static final ExceptionCode DATACLOUD_API_UNAVAILABLE = new ExceptionCode(
			_DATACLOUD_API_UNAVAILABLE, true);

	public static final ExceptionCode DUPLICATE_ARGUMENT_VALUE = new ExceptionCode(
			_DUPLICATE_ARGUMENT_VALUE, true);

	public static final ExceptionCode DUPLICATE_VALUE = new ExceptionCode(
			_DUPLICATE_VALUE, true);

	public static final ExceptionCode EMAIL_BATCH_SIZE_LIMIT_EXCEEDED = new ExceptionCode(
			_EMAIL_BATCH_SIZE_LIMIT_EXCEEDED, true);

	public static final ExceptionCode EMAIL_TO_CASE_INVALID_ROUTING = new ExceptionCode(
			_EMAIL_TO_CASE_INVALID_ROUTING, true);

	public static final ExceptionCode EMAIL_TO_CASE_LIMIT_EXCEEDED = new ExceptionCode(
			_EMAIL_TO_CASE_LIMIT_EXCEEDED, true);

	public static final ExceptionCode EMAIL_TO_CASE_NOT_ENABLED = new ExceptionCode(
			_EMAIL_TO_CASE_NOT_ENABLED, true);

	public static final ExceptionCode EXCEEDED_ID_LIMIT = new ExceptionCode(
			_EXCEEDED_ID_LIMIT, true);

	public static final ExceptionCode EXCEEDED_LEAD_CONVERT_LIMIT = new ExceptionCode(
			_EXCEEDED_LEAD_CONVERT_LIMIT, true);

	public static final ExceptionCode EXCEEDED_MAX_SIZE_REQUEST = new ExceptionCode(
			_EXCEEDED_MAX_SIZE_REQUEST, true);

	public static final ExceptionCode EXCEEDED_MAX_TYPES_LIMIT = new ExceptionCode(
			_EXCEEDED_MAX_TYPES_LIMIT, true);

	public static final ExceptionCode EXCEEDED_QUOTA = new ExceptionCode(
			_EXCEEDED_QUOTA, true);

	public static final ExceptionCode FEDERATED_SEARCH_ERROR = new ExceptionCode(
			_FEDERATED_SEARCH_ERROR, true);

	public static final ExceptionCode FEED_NOT_ENABLED_FOR_OBJECT = new ExceptionCode(
			_FEED_NOT_ENABLED_FOR_OBJECT, true);

	public static final ExceptionCode FUNCTIONALITY_NOT_ENABLED = new ExceptionCode(
			_FUNCTIONALITY_NOT_ENABLED, true);
	...
	public static final ExceptionCode ILLEGAL_QUERY_PARAMETER_VALUE = new ExceptionCode(
			_ILLEGAL_QUERY_PARAMETER_VALUE, true);

	public static final ExceptionCode INACTIVE_OWNER_OR_USER = new ExceptionCode(
			_INACTIVE_OWNER_OR_USER, true);

	public static final ExceptionCode INACTIVE_PORTAL = new ExceptionCode(
			_INACTIVE_PORTAL, true);

	public static final ExceptionCode INSUFFICIENT_ACCESS = new ExceptionCode(
			_INSUFFICIENT_ACCESS, true);

	public static final ExceptionCode INVALID_ASSIGNMENT_RULE = new ExceptionCode(
			_INVALID_ASSIGNMENT_RULE, true);

	public static final ExceptionCode INVALID_BATCH_SIZE = new ExceptionCode(
			_INVALID_BATCH_SIZE, true);

	public static final ExceptionCode INVALID_CLIENT = new ExceptionCode(
			_INVALID_CLIENT, true);

	public static final ExceptionCode INVALID_CROSS_REFERENCE_KEY = new ExceptionCode(
			_INVALID_CROSS_REFERENCE_KEY, true);

	public static final ExceptionCode INVALID_FIELD = new ExceptionCode(
			_INVALID_FIELD, true);

	public static final ExceptionCode INVALID_FILTER_LANGUAGE = new ExceptionCode(
			_INVALID_FILTER_LANGUAGE, true);

	public static final ExceptionCode INVALID_FILTER_VALUE = new ExceptionCode(
			_INVALID_FILTER_VALUE, true);

	public static final ExceptionCode INVALID_ID_FIELD = new ExceptionCode(
			_INVALID_ID_FIELD, true);

	public static final ExceptionCode INVALID_INPUT_COMBINATION = new ExceptionCode(
			_INVALID_INPUT_COMBINATION, true);

	public static final ExceptionCode INVALID_LOCALE_LANGUAGE = new ExceptionCode(
			_INVALID_LOCALE_LANGUAGE, true);

	public static final ExceptionCode INVALID_LOCATOR = new ExceptionCode(
			_INVALID_LOCATOR, true);

	public static final ExceptionCode INVALID_LOGIN = new ExceptionCode(
			_INVALID_LOGIN, true);

	public static final ExceptionCode INVALID_MULTIPART_REQUEST = new ExceptionCode(
			_INVALID_MULTIPART_REQUEST, true);

	public static final ExceptionCode INVALID_NEW_PASSWORD = new ExceptionCode(
			_INVALID_NEW_PASSWORD, true);

	public static final ExceptionCode INVALID_OPERATION = new ExceptionCode(
	...
	public static final ExceptionCode INVALID_PAGING_OPTION = new ExceptionCode(
			_INVALID_PAGING_OPTION, true);

	public static final ExceptionCode INVALID_QUERY_FILTER_OPERATOR = new ExceptionCode(
			_INVALID_QUERY_FILTER_OPERATOR, true);

	public static final ExceptionCode INVALID_QUERY_LOCATOR = new ExceptionCode(
			_INVALID_QUERY_LOCATOR, true);

	public static final ExceptionCode INVALID_QUERY_SCOPE = new ExceptionCode(
			_INVALID_QUERY_SCOPE, true);

	public static final ExceptionCode INVALID_REPLICATION_DATE = new ExceptionCode(
			_INVALID_REPLICATION_DATE, true);

	public static final ExceptionCode INVALID_SEARCH = new ExceptionCode(
			_INVALID_SEARCH, true);

	public static final ExceptionCode INVALID_SEARCH_SCOPE = new ExceptionCode(
			_INVALID_SEARCH_SCOPE, true);

	public static final ExceptionCode INVALID_SESSION_ID = new ExceptionCode(
			_INVALID_SESSION_ID, true);

	public static final ExceptionCode INVALID_SOAP_HEADER = new ExceptionCode(
			_INVALID_SOAP_HEADER, true);

	public static final ExceptionCode INVALID_SORT_OPTION = new ExceptionCode(
			_INVALID_SORT_OPTION, true);

	public static final ExceptionCode INVALID_SSO_GATEWAY_URL = new ExceptionCode(
			_INVALID_SSO_GATEWAY_URL, true);

	public static final ExceptionCode INVALID_TYPE = new ExceptionCode(
			_INVALID_TYPE, true);

	public static final ExceptionCode INVALID_TYPE_FOR_OPERATION = new ExceptionCode(
			_INVALID_TYPE_FOR_OPERATION, true);

	public static final ExceptionCode JIGSAW_IMPORT_LIMIT_EXCEEDED = new ExceptionCode(
			_JIGSAW_IMPORT_LIMIT_EXCEEDED, true);

	public static final ExceptionCode JIGSAW_REQUEST_NOT_SUPPORTED = new ExceptionCode(
			_JIGSAW_REQUEST_NOT_SUPPORTED, true);

	public static final ExceptionCode JSON_PARSER_ERROR = new ExceptionCode(
			_JSON_PARSER_ERROR, true);

	public static final ExceptionCode LICENSING_UNKNOWN_ERROR = new ExceptionCode(
			_LICENSING_UNKNOWN_ERROR, true);

	public static final ExceptionCode LIMIT_EXCEEDED = new ExceptionCode(
			_LIMIT_EXCEEDED, true);

	public static final ExceptionCode LOGIN_CHALLENGE_ISSUED = new ExceptionCode(
			_LOGIN_CHALLENGE_ISSUED, true);

	public static final ExceptionCode LOGIN_CHALLENGE_PENDING = new ExceptionCode(
			_LOGIN_CHALLENGE_PENDING, true);

	public static final ExceptionCode LOGIN_DURING_RESTRICTED_DOMAIN = new ExceptionCode(
			_LOGIN_DURING_RESTRICTED_DOMAIN, true);

	public static final ExceptionCode LOGIN_DURING_RESTRICTED_TIME = new ExceptionCode(
			_LOGIN_DURING_RESTRICTED_TIME, true);

	public static final ExceptionCode LOGIN_MUST_USE_SECURITY_TOKEN = new ExceptionCode(
			_LOGIN_MUST_USE_SECURITY_TOKEN, true);

	public static final ExceptionCode MALFORMED_ID = new ExceptionCode(
			_MALFORMED_ID, true);

	public static final ExceptionCode MALFORMED_QUERY = new ExceptionCode(
			_MALFORMED_QUERY, true);

	public static final ExceptionCode MALFORMED_SEARCH = new ExceptionCode(
			_MALFORMED_SEARCH, true);

	public static final ExceptionCode MISSING_ARGUMENT = new ExceptionCode(
			_MISSING_ARGUMENT, true);

	public static final ExceptionCode NOT_MODIFIED = new ExceptionCode(
			_NOT_MODIFIED, true);

	public static final ExceptionCode NO_SOFTPHONE_LAYOUT = new ExceptionCode(
			_NO_SOFTPHONE_LAYOUT, true);

	public static final ExceptionCode NUMBER_OUTSIDE_VALID_RANGE = new ExceptionCode(
			_NUMBER_OUTSIDE_VALID_RANGE, true);

	public static final ExceptionCode OPERATION_TOO_LARGE = new ExceptionCode(
			_OPERATION_TOO_LARGE, true);

	public static final ExceptionCode ORG_IN_MAINTENANCE = new ExceptionCode(
			_ORG_IN_MAINTENANCE, true);

	public static final ExceptionCode ORG_IS_DOT_ORG = new ExceptionCode(
			_ORG_IS_DOT_ORG, true);

	public static final ExceptionCode ORG_LOCKED = new ExceptionCode(
			_ORG_LOCKED, true);

	public static final ExceptionCode ORG_NOT_OWNED_BY_INSTANCE = new ExceptionCode(
			_ORG_NOT_OWNED_BY_INSTANCE, true);

	public static final ExceptionCode PASSWORD_LOCKOUT = new ExceptionCode(
			_PASSWORD_LOCKOUT, true);

	public static final ExceptionCode PORTAL_NO_ACCESS = new ExceptionCode(
			_PORTAL_NO_ACCESS, true);

	public static final ExceptionCode POST_BODY_PARSE_ERROR = new ExceptionCode(
			_POST_BODY_PARSE_ERROR, true);

	public static final ExceptionCode QUERY_TIMEOUT = new ExceptionCode(
			_QUERY_TIMEOUT, true);

	public static final ExceptionCode QUERY_TOO_COMPLICATED = new ExceptionCode(
			_QUERY_TOO_COMPLICATED, true);

	public static final ExceptionCode REQUEST_LIMIT_EXCEEDED = new ExceptionCode(
			_REQUEST_LIMIT_EXCEEDED, true);

	public static final ExceptionCode REQUEST_RUNNING_TOO_LONG = new ExceptionCode(
			_REQUEST_RUNNING_TOO_LONG, true);

	public static final ExceptionCode SERVER_UNAVAILABLE = new ExceptionCode(
	...
	public static final ExceptionCode SSO_SERVICE_DOWN = new ExceptionCode(
			_SSO_SERVICE_DOWN, true);

	public static final ExceptionCode TOO_MANY_APEX_REQUESTS = new ExceptionCode(
			_TOO_MANY_APEX_REQUESTS, true);

	public static final ExceptionCode TOO_MANY_RECIPIENTS = new ExceptionCode(
			_TOO_MANY_RECIPIENTS, true);

	public static final ExceptionCode TRIAL_EXPIRED = new ExceptionCode(
			_TRIAL_EXPIRED, true);

	public static final ExceptionCode UNKNOWN_ATTACHMENT_EXCEPTION = new ExceptionCode(
			_UNKNOWN_ATTACHMENT_EXCEPTION, true);

	public static final ExceptionCode UNKNOWN_EXCEPTION = new ExceptionCode(
			_UNKNOWN_EXCEPTION, true);

	public static final ExceptionCode UNSUPPORTED_API_VERSION = new ExceptionCode(
			_UNSUPPORTED_API_VERSION, true);

	public static final ExceptionCode UNSUPPORTED_ATTACHMENT_ENCODING = new ExceptionCode(
			_UNSUPPORTED_ATTACHMENT_ENCODING, true);

	public static final ExceptionCode UNSUPPORTED_CLIENT = new ExceptionCode(
			_UNSUPPORTED_CLIENT, true);

	public static final ExceptionCode UNSUPPORTED_MEDIA_TYPE = new ExceptionCode(
			_UNSUPPORTED_MEDIA_TYPE, true);

	public static final ExceptionCode XML_PARSER_ERROR = new ExceptionCode(
			_XML_PARSER_ERROR, true);
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null)
				...
				writeAttribute("xsi",
						...
						namespacePrefix + ":ExceptionCode", xmlWriter);
			} else {
				writeAttribute("xsi",
						"http://www.w3.org/2001/XMLSchema-instance", "type",
						"ExceptionCode", xmlWriter);
			}
		}
	...
	public javax.xml.stream.XMLStreamReader getPullParser(
		...
		return new org.apache.axis2.databinding.utils.reader.ADBXMLStreamReaderImpl(
				...
				new java.lang.Object[] {
						...
						org.apache.axis2.databinding.utils.ConverterUtil
								.convertToString(localExceptionCode) }, null);
	...
	public static class Factory {
		...
		public static ExceptionCode fromString(
		 ...
		 * outer element
		 */
		public static ExceptionCode parse(
