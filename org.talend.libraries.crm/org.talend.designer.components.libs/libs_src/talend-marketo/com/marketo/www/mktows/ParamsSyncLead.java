...
public class ParamsSyncLead  implements java.io.Serializable {
    ...
    public ParamsSyncLead(
           ...
           boolean returnLead,
           java.lang.String marketoCookie) {
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ParamsSyncLead)) return false;
        ...
        boolean _equals;
        _equals = true && 
            ((this.leadRecord==null && other.getLeadRecord()==null) || 
             (this.leadRecord!=null &&
              this.leadRecord.equals(other.getLeadRecord()))) &&
            this.returnLead == other.isReturnLead() &&
            ((this.marketoCookie==null && other.getMarketoCookie()==null) || 
             (this.marketoCookie!=null &&
              this.marketoCookie.equals(other.getMarketoCookie())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ParamsSyncLead.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.marketo.com/mktows/", "ParamsSyncLead"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("", "marketoCookie"));
