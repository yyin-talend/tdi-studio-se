...
public class ParamsGetCustomObjects  implements java.io.Serializable {
     ...
     */
    public void setCustomObjKeyList(com.marketo.www.mktows.Attribute[] customObjKeyList) {
        this.customObjKeyList = customObjKeyList;
    }
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ParamsGetCustomObjects)) return false;
        ...
        boolean _equals;
        _equals = true && 
            ((this.objTypeName==null && other.getObjTypeName()==null) || 
             (this.objTypeName!=null &&
              this.objTypeName.equals(other.getObjTypeName()))) &&
            ...
            ((this.customObjKeyList==null && other.getCustomObjKeyList()==null) || 
             (this.customObjKeyList!=null &&
              java.util.Arrays.equals(this.customObjKeyList, other.getCustomObjKeyList()))) &&
            ((this.includeAttributes==null && other.getIncludeAttributes()==null) || 
             (this.includeAttributes!=null &&
              java.util.Arrays.equals(this.includeAttributes, other.getIncludeAttributes())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getCustomObjKeyList() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getCustomObjKeyList());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getCustomObjKeyList(), i);
                if (obj != null &&
        ...
        if (getIncludeAttributes() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getIncludeAttributes());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getIncludeAttributes(), i);
                if (obj != null &&
                    !obj.getClass().isArray()) {
                    _hashCode += obj.hashCode();
                }
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ParamsGetCustomObjects.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.marketo.com/mktows/", "ParamsGetCustomObjects"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("", "streamPosition"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("", "customObjKeyList"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("", "includeAttributes"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setNillable(false);
