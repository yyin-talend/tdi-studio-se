...
public interface ISpagoBITalendEngineClient {
    ...
    /**
     * Calls properly the EngineInfo-Service in order to get the version number of the remote engine instance
     * 
    ...
    /**
     * Calls properly the EngineInfo-Service in order to get the full name of the remote engine instance
     * 
    ...
    /**
     * Calls properly the EngineInfo-Service in order to check if the remote engine is available
     * 
    ...
    /**
     * 
     * @param jobDeploymentDescriptor an object containing some deployment informations (i.e. project name, project
     * language)
     * @param executableJobFiles the zip file produced by TOS exportation functionality
     * 
     * @return true if the job is succesfully deployed into the runtime repository of the engine
     * 
     * @throws EngineUnavailableException when is not possible to connect to the service
     * @throws AuthenticationFailedException when the user is not authenticated succefully
     * @throws ServiceInvocationFailedException when the service execution generate an error
     */
    public abstract boolean deployJob(JobDeploymentDescriptor jobDeploymentDescriptor, File executableJobFiles)
