...
public class ResultGetImportToListStatus  implements java.io.Serializable {
    ...
    public ResultGetImportToListStatus(
           ...
           java.util.Calendar startedTime,
           java.util.Calendar endedTime,
           java.lang.Integer estimatedTime,
           java.lang.Integer estimatedRows,
           java.lang.Integer rowsImported,
           java.lang.Integer rowsFailed,
           java.lang.Integer rowsIgnored,
           java.lang.String importSummary) {
           this.status = status;
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ResultGetImportToListStatus)) return false;
        ...
        _equals = true && 
            ...
            ((this.startedTime==null && other.getStartedTime()==null) || 
             (this.startedTime!=null &&
              this.startedTime.equals(other.getStartedTime()))) &&
            ((this.endedTime==null && other.getEndedTime()==null) || 
             (this.endedTime!=null &&
              this.endedTime.equals(other.getEndedTime()))) &&
            ((this.estimatedTime==null && other.getEstimatedTime()==null) || 
             (this.estimatedTime!=null &&
              this.estimatedTime.equals(other.getEstimatedTime()))) &&
            ((this.estimatedRows==null && other.getEstimatedRows()==null) || 
             (this.estimatedRows!=null &&
              this.estimatedRows.equals(other.getEstimatedRows()))) &&
            ((this.rowsImported==null && other.getRowsImported()==null) || 
             (this.rowsImported!=null &&
              this.rowsImported.equals(other.getRowsImported()))) &&
            ((this.rowsFailed==null && other.getRowsFailed()==null) || 
             (this.rowsFailed!=null &&
              this.rowsFailed.equals(other.getRowsFailed()))) &&
            ((this.rowsIgnored==null && other.getRowsIgnored()==null) || 
             (this.rowsIgnored!=null &&
              this.rowsIgnored.equals(other.getRowsIgnored()))) &&
            ((this.importSummary==null && other.getImportSummary()==null) || 
             (this.importSummary!=null &&
              this.importSummary.equals(other.getImportSummary())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ResultGetImportToListStatus.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.marketo.com/mktows/", "ResultGetImportToListStatus"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("status");
        elemField.setXmlName(new javax.xml.namespace.QName("", "status"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.marketo.com/mktows/", "ImportToListStatusEnum"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("", "estimatedRows"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "int"));
        elemField.setMinOccurs(0);
        elemField.setNillable(true);
        typeDesc.addFieldDesc(elemField);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("", "importSummary"));
