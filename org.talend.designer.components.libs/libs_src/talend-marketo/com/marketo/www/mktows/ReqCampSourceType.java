...
public class ReqCampSourceType implements java.io.Serializable {
    ...
    public static final ReqCampSourceType MKTOWS = new ReqCampSourceType(_MKTOWS);
    ...
    public static ReqCampSourceType fromValue(java.lang.String value)
        ...
        ReqCampSourceType enumeration = (ReqCampSourceType)
            _table_.get(value);
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ReqCampSourceType.class);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.marketo.com/mktows/", "ReqCampSourceType"));
    }
    /**
