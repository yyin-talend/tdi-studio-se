...
public class MObjFieldMetadata  implements java.io.Serializable {
    ...
    public MObjFieldMetadata(
           ...
           boolean isCustom,
           boolean isDynamic,
           java.lang.String dynamicFieldRef,
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof MObjFieldMetadata)) return false;
        ...
        _equals = true && 
            ...
            ((this.isName==null && other.getIsName()==null) || 
             (this.isName!=null &&
              this.isName.equals(other.getIsName()))) &&
            this.isPrimaryKey == other.isIsPrimaryKey() &&
            this.isCustom == other.isIsCustom() &&
            this.isDynamic == other.isIsDynamic() &&
            ((this.dynamicFieldRef==null && other.getDynamicFieldRef()==null) || 
             (this.dynamicFieldRef!=null &&
              this.dynamicFieldRef.equals(other.getDynamicFieldRef()))) &&
    ...
    public synchronized int hashCode() {
        ...
        _hashCode += (isIsUpdateBlocked() ? Boolean.TRUE : Boolean.FALSE).hashCode();
        if (getIsName() != null) {
            _hashCode += getIsName().hashCode();
        }
        _hashCode += (isIsPrimaryKey() ? Boolean.TRUE : Boolean.FALSE).hashCode();
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(MObjFieldMetadata.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.marketo.com/mktows/", "MObjFieldMetadata"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("", "isUpdateBlocked"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "boolean"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("", "dynamicFieldRef"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setNillable(true);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
