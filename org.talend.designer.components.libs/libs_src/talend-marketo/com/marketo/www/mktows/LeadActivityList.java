...
public class LeadActivityList  implements java.io.Serializable {
     ...
     */
    public void setActivityRecordList(com.marketo.www.mktows.ActivityRecord[] activityRecordList) {
        this.activityRecordList = activityRecordList;
    }

    private java.lang.Object __equalsCalc = null;
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof LeadActivityList)) return false;
        ...
        _equals = true && 
            ...
            ((this.activityRecordList==null && other.getActivityRecordList()==null) || 
             (this.activityRecordList!=null &&
              java.util.Arrays.equals(this.activityRecordList, other.getActivityRecordList())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getActivityRecordList() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getActivityRecordList());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getActivityRecordList(), i);
                if (obj != null &&
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(LeadActivityList.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.marketo.com/mktows/", "LeadActivityList"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("", "activityRecordList"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.marketo.com/mktows/", "ActivityRecord"));
        elemField.setMinOccurs(0);
        elemField.setNillable(true);
        elemField.setItemQName(new javax.xml.namespace.QName("", "activityRecord"));
        typeDesc.addFieldDesc(elemField);
    }
