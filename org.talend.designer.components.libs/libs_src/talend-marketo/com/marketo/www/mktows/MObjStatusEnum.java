...
public class MObjStatusEnum implements java.io.Serializable {
    ...
    public static final MObjStatusEnum UNCHANGED = new MObjStatusEnum(_UNCHANGED);
    ...
    public static MObjStatusEnum fromValue(java.lang.String value)
        ...
        MObjStatusEnum enumeration = (MObjStatusEnum)
            _table_.get(value);
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(MObjStatusEnum.class);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.marketo.com/mktows/", "MObjStatusEnum"));
    }
    /**
