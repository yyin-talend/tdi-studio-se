...
public class ListKeyType implements java.io.Serializable {
    ...
    public static final ListKeyType MKTOLISTNAME = new ListKeyType(_MKTOLISTNAME);
    public static final ListKeyType MKTOSALESUSERID = new ListKeyType(_MKTOSALESUSERID);
    public static final ListKeyType SFDCLEADOWNERID = new ListKeyType(_SFDCLEADOWNERID);
    public java.lang.String getValue() { return _value_;}
    public static ListKeyType fromValue(java.lang.String value)
          throws java.lang.IllegalArgumentException {
        ListKeyType enumeration = (ListKeyType)
            _table_.get(value);
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ListKeyType.class);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.marketo.com/mktows/", "ListKeyType"));
    }
    /**
