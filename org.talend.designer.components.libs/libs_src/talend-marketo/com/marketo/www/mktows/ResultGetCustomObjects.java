...
public class ResultGetCustomObjects  implements java.io.Serializable {
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ResultGetCustomObjects)) return false;
        ...
        _equals = true && 
            ...
            ((this.newStreamPosition==null && other.getNewStreamPosition()==null) || 
             (this.newStreamPosition!=null &&
              this.newStreamPosition.equals(other.getNewStreamPosition()))) &&
            ((this.customObjList==null && other.getCustomObjList()==null) || 
             (this.customObjList!=null &&
              java.util.Arrays.equals(this.customObjList, other.getCustomObjList())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getCustomObjList() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getCustomObjList());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getCustomObjList(), i);
                if (obj != null &&
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ResultGetCustomObjects.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.marketo.com/mktows/", "ResultGetCustomObjects"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("", "newStreamPosition"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("customObjList");
        elemField.setXmlName(new javax.xml.namespace.QName("", "customObjList"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.marketo.com/mktows/", "CustomObj"));
