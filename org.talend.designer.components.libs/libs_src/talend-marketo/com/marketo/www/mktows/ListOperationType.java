...
public class ListOperationType implements java.io.Serializable {
    ...
    public static ListOperationType fromValue(java.lang.String value)
        ...
        ListOperationType enumeration = (ListOperationType)
            _table_.get(value);
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ListOperationType.class);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.marketo.com/mktows/", "ListOperationType"));
    }
    /**
