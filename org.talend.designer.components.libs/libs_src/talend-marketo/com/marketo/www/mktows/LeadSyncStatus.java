...
public class LeadSyncStatus implements java.io.Serializable {
    ...
    public static LeadSyncStatus fromValue(java.lang.String value)
        ...
        LeadSyncStatus enumeration = (LeadSyncStatus)
            _table_.get(value);
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(LeadSyncStatus.class);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.marketo.com/mktows/", "LeadSyncStatus"));
    }
    /**
