...
public class MergeStatus  implements java.io.Serializable {
    ...
    public MergeStatus(
           java.lang.Integer winningLeadId,
           int[] losingLeadIdList,
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof MergeStatus)) return false;
        ...
        boolean _equals;
        _equals = true && 
            ((this.winningLeadId==null && other.getWinningLeadId()==null) || 
             (this.winningLeadId!=null &&
              this.winningLeadId.equals(other.getWinningLeadId()))) &&
            ((this.losingLeadIdList==null && other.getLosingLeadIdList()==null) || 
             (this.losingLeadIdList!=null &&
              java.util.Arrays.equals(this.losingLeadIdList, other.getLosingLeadIdList()))) &&
    ...
    public synchronized int hashCode() {
        ...
        if (getLosingLeadIdList() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getLosingLeadIdList());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getLosingLeadIdList(), i);
                if (obj != null &&
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(MergeStatus.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.marketo.com/mktows/", "MergeStatus"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("winningLeadId");
        elemField.setXmlName(new javax.xml.namespace.QName("", "winningLeadId"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("", "losingLeadIdList"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "int"));
        elemField.setMinOccurs(0);
        elemField.setNillable(true);
        elemField.setItemQName(new javax.xml.namespace.QName("", "integerItem"));
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("status");
        elemField.setXmlName(new javax.xml.namespace.QName("", "status"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.marketo.com/mktows/", "LeadMergeStatusEnum"));
