...
public class ResultGetLeadChanges  implements java.io.Serializable {
     ...
     */
    public void setNewStartPosition(com.marketo.www.mktows.StreamPosition newStartPosition) {
        this.newStartPosition = newStartPosition;
    }
     ...
     */
    public void setLeadChangeRecordList(com.marketo.www.mktows.LeadChangeRecord[] leadChangeRecordList) {
        this.leadChangeRecordList = leadChangeRecordList;
    }

    private java.lang.Object __equalsCalc = null;
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ResultGetLeadChanges)) return false;
        ...
        _equals = true && 
            ...
            ((this.newStartPosition==null && other.getNewStartPosition()==null) || 
             (this.newStartPosition!=null &&
              this.newStartPosition.equals(other.getNewStartPosition()))) &&
            ((this.leadChangeRecordList==null && other.getLeadChangeRecordList()==null) || 
             (this.leadChangeRecordList!=null &&
              java.util.Arrays.equals(this.leadChangeRecordList, other.getLeadChangeRecordList())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getLeadChangeRecordList() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getLeadChangeRecordList());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getLeadChangeRecordList(), i);
                if (obj != null &&
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ResultGetLeadChanges.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.marketo.com/mktows/", "ResultGetLeadChanges"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("", "remainingCount"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "int"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("newStartPosition");
        elemField.setXmlName(new javax.xml.namespace.QName("", "newStartPosition"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("", "leadChangeRecordList"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.marketo.com/mktows/", "LeadChangeRecord"));
        elemField.setMinOccurs(0);
        elemField.setNillable(true);
        elemField.setItemQName(new javax.xml.namespace.QName("", "leadChangeRecord"));
        typeDesc.addFieldDesc(elemField);
    }
