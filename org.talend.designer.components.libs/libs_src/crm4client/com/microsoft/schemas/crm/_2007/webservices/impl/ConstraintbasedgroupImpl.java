 ...
 */
public class ConstraintbasedgroupImpl extends com.microsoft.schemas.crm._2006.webservices.impl.BusinessEntityImpl implements com.microsoft.schemas.crm._2007.webservices.Constraintbasedgroup
{
    
    public ConstraintbasedgroupImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    private static final javax.xml.namespace.QName CONSTRAINTBASEDGROUPID$2 = 
        new javax.xml.namespace.QName("http://schemas.microsoft.com/crm/2007/WebServices", "constraintbasedgroupid");
    ...
    private static final javax.xml.namespace.QName GROUPTYPECODE$12 = 
     ...
     */
    public com.microsoft.schemas.crm._2006.webservices.Key getConstraintbasedgroupid()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.microsoft.schemas.crm._2006.webservices.Key target = null;
            target = (com.microsoft.schemas.crm._2006.webservices.Key)get_store().find_element_user(CONSTRAINTBASEDGROUPID$2, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public boolean isSetConstraintbasedgroupid()
    {
        synchronized (monitor())
        {
            check_orphaned();
            return get_store().count_elements(CONSTRAINTBASEDGROUPID$2) != 0;
        }
    }
     ...
     */
    public void setConstraintbasedgroupid(com.microsoft.schemas.crm._2006.webservices.Key constraintbasedgroupid)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (com.microsoft.schemas.crm._2006.webservices.Key)get_store().add_element_user(CONSTRAINTBASEDGROUPID$2);
            }
            target.set(constraintbasedgroupid);
        }
    }
     ...
     */
    public com.microsoft.schemas.crm._2006.webservices.Key addNewConstraintbasedgroupid()
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public void unsetConstraintbasedgroupid()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(CONSTRAINTBASEDGROUPID$2, 0);
        }
    }
    ...
    public com.microsoft.schemas.crm._2006.webservices.Picklist getGrouptypecode()
    {
        synchronized (monitor())
        {
            ...
            target = (com.microsoft.schemas.crm._2006.webservices.Picklist)get_store().find_element_user(GROUPTYPECODE$12, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public boolean isSetGrouptypecode()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(GROUPTYPECODE$12) != 0;
        }
    }
    ...
    public void setGrouptypecode(com.microsoft.schemas.crm._2006.webservices.Picklist grouptypecode)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (com.microsoft.schemas.crm._2006.webservices.Picklist)get_store().add_element_user(GROUPTYPECODE$12);
            }
    ...
    public void unsetGrouptypecode()
    {
        ...
        {
            check_orphaned();
            get_store().remove_element(GROUPTYPECODE$12, 0);
        }
    }
