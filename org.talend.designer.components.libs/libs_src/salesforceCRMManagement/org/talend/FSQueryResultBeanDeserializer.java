 ...
 */
public class FSQueryResultBeanDeserializer extends DeserializerImpl implements Serializable {

    protected static Log log = LogFactory.getLog(FSQueryResultBeanDeserializer.class.getName());
    ...
    public FSQueryResultBeanDeserializer(Class javaType, QName xmlType) {
    ...
    public FSQueryResultBeanDeserializer(Class javaType, QName xmlType, TypeDesc typeDesc) {
        this(javaType, xmlType, typeDesc, BeanDeserializerFactory.getProperties(javaType, typeDesc));
    }

    // Construct BeanDeserializer for the indicated class/qname and meta Data
    public FSQueryResultBeanDeserializer(Class javaType, QName xmlType, TypeDesc typeDesc, Map propertyMap) {
     ...
     * startElement
     * 
     * The ONLY reason that this method is overridden is so that the object value can be set or a reasonable exception
     * is thrown indicating that the object cannot be created. This is done at this point so that it occurs BEFORE
     * href/id processing.
     * 
    ...
    private boolean isFirstId() {
        if (value instanceof SObject) {
            SObject soject = (SObject) value;
            String id = soject.getId();
            if (id == null) {
                return true;
            }
        }
     ...
     * @return is a Deserializer to use to deserialize a child (must be a derived class of SOAPHandler) or null if no
    ...
    public SOAPHandler onStartChild(String namespace, String localName, String prefix, Attributes attributes,
        ...
        if (propDesc == null
                || !isFirstId()
                || (((prevQName != null) && prevQName.equals(elemQName) && !(propDesc.isIndexed() || isArray) && getAnyPropertyDesc() != null))) {
    ...
    /**
     * Get a BeanPropertyDescriptor which indicates where we should put extensibility elements (i.e. XML which falls
     * under the auspices of an &lt;xsd:any&gt; declaration in the schema)
     * 
     ...
     * 
     * This method is invoked after startElement when the element requires deserialization (i.e. the element is not an
     * href and the value is not nil.)
     * 
     * @param namespace is the namespace of the element
     * @param localName is the name of the element
     * @param prefix is the prefix of the element
            ...
            if (bpd != null) {
                ...
                if (dSer == null) {
                    ...
                    if (dSer instanceof ArrayDeserializer) {
                        SimpleListDeserializerFactory factory = new SimpleListDeserializerFactory(bpd.getType(), fieldDesc
                                .getXmlType());
     ...
     * @param href String is the value of the href attribute, which is used to determine whether the child element is
     * complete or an href to another element.
    ...
    protected Deserializer getDeserializer(QName xmlType, Class javaType, String href, DeserializationContext context) {
        ...
        if (cacheStringDSer != null) {
            if (String.class.equals(javaType) && href == null
                    && (cacheXMLType == null && xmlType == null || cacheXMLType != null && cacheXMLType.equals(xmlType))) {
