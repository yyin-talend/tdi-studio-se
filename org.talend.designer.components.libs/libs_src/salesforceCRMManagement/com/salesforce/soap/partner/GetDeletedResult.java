...
public class GetDeletedResult  implements java.io.Serializable {
    private com.salesforce.soap.partner.DeletedRecord[] deletedRecords;
    ...
    public GetDeletedResult(
           com.salesforce.soap.partner.DeletedRecord[] deletedRecords,
     ...
     */
    public void setDeletedRecords(com.salesforce.soap.partner.DeletedRecord[] deletedRecords) {
        this.deletedRecords = deletedRecords;
    }

    public com.salesforce.soap.partner.DeletedRecord getDeletedRecords(int i) {
        return this.deletedRecords[i];
    }

    public void setDeletedRecords(int i, com.salesforce.soap.partner.DeletedRecord _value) {
