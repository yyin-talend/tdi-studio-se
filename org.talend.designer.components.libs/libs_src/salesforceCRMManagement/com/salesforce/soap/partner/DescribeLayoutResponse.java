...
public class DescribeLayoutResponse  implements java.io.Serializable {
    private com.salesforce.soap.partner.DescribeLayoutResult result;

    public DescribeLayoutResponse() {
    }

    public DescribeLayoutResponse(
           com.salesforce.soap.partner.DescribeLayoutResult result) {
           this.result = result;
    }
     ...
     * @param result
     */
    public void setResult(com.salesforce.soap.partner.DescribeLayoutResult result) {
        this.result = result;
    }
