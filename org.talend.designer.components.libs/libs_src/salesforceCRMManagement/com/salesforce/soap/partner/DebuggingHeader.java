...
public class DebuggingHeader  implements java.io.Serializable {
    private com.salesforce.soap.partner.DebugLevel debugLevel;

    public DebuggingHeader() {
    }

    public DebuggingHeader(
           com.salesforce.soap.partner.DebugLevel debugLevel) {
     ...
     * @param debugLevel
     */
    public void setDebugLevel(com.salesforce.soap.partner.DebugLevel debugLevel) {
        this.debugLevel = debugLevel;
    }
