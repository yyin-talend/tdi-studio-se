...
public class DescribeDataCategoryGroupStructures  implements java.io.Serializable {
    private com.salesforce.soap.partner.DataCategoryGroupSobjectTypePair[] pairs;
    ...
    public DescribeDataCategoryGroupStructures(
           com.salesforce.soap.partner.DataCategoryGroupSobjectTypePair[] pairs,
     ...
     * @param pairs
     */
    public void setPairs(com.salesforce.soap.partner.DataCategoryGroupSobjectTypePair[] pairs) {
        this.pairs = pairs;
    }

    public com.salesforce.soap.partner.DataCategoryGroupSobjectTypePair getPairs(int i) {
        return this.pairs[i];
    }

    public void setPairs(int i, com.salesforce.soap.partner.DataCategoryGroupSobjectTypePair _value) {
        this.pairs[i] = _value;
    }
