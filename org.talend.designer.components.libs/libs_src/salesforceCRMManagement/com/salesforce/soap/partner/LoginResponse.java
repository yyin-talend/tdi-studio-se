...
public class LoginResponse  implements java.io.Serializable {
    private com.salesforce.soap.partner.LoginResult result;

    public LoginResponse() {
    }

    public LoginResponse(
           com.salesforce.soap.partner.LoginResult result) {
           this.result = result;
    }
     ...
     * @param result
     */
    public void setResult(com.salesforce.soap.partner.LoginResult result) {
        this.result = result;
    }
