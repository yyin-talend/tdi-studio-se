...
public class GetServerTimestampResponse  implements java.io.Serializable {
    private com.salesforce.soap.partner.GetServerTimestampResult result;

    public GetServerTimestampResponse() {
    }

    public GetServerTimestampResponse(
           com.salesforce.soap.partner.GetServerTimestampResult result) {
           this.result = result;
    }
     ...
     * @param result
     */
    public void setResult(com.salesforce.soap.partner.GetServerTimestampResult result) {
        this.result = result;
    }
