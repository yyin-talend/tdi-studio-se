...
public class ChildRelationship implements org.apache.axis2.databinding.ADBBean {
	 ...
	 * ChildRelationship Namespace URI = urn:partner.soap.sforce.com Namespace
	 * Prefix = ns1
	 */
	...
	public javax.xml.stream.XMLStreamReader getPullParser(
		...
		if (localChildSObject != null) {
			elementList.add(org.apache.axis2.databinding.utils.ConverterUtil
					.convertToString(localChildSObject));
		} else {
			throw new org.apache.axis2.databinding.ADBException(
					"childSObject cannot be null!!");
		}
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static ChildRelationship parse(
			...
			try {
						...
						if (!"ChildRelationship".equals(type)) {
							...
							java.lang.String nsUri = reader
									.getNamespaceContext().getNamespaceURI(
											nsPrefix);
							return (ChildRelationship) com.salesforce.soap.partner.sobject.ExtensionMapper
				...
				if (reader.isStartElement()
					...
					if ("true".equals(nillableValue)
						...
						throw new org.apache.axis2.databinding.ADBException(
								"The element: " + "cascadeDelete"
										+ "  cannot be null");
					}

					java.lang.String content = reader.getElementText();

					object.setCascadeDelete(org.apache.axis2.databinding.utils.ConverterUtil
				...
				if (reader.isStartElement()
					...
					if ("true".equals(nillableValue)
							|| "1".equals(nillableValue)) {
						throw new org.apache.axis2.databinding.ADBException(
								"The element: " + "childSObject"
										+ "  cannot be null");
					}

					java.lang.String content = reader.getElementText();

					object.setChildSObject(org.apache.axis2.databinding.utils.ConverterUtil
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName(
								"urn:partner.soap.sforce.com",
								"deprecatedAndHidden").equals(reader.getName())) {
					...
					if ("true".equals(nillableValue)
							|| "1".equals(nillableValue)) {
						throw new org.apache.axis2.databinding.ADBException(
								"The element: " + "deprecatedAndHidden"
										+ "  cannot be null");
					}

					java.lang.String content = reader.getElementText();

					object.setDeprecatedAndHidden(org.apache.axis2.databinding.utils.ConverterUtil
							.convertToBoolean(content));
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName(
								"urn:partner.soap.sforce.com",
								"relationshipName").equals(reader.getName())) {
					...
					if ("true".equals(nillableValue)
							|| "1".equals(nillableValue)) {
						throw new org.apache.axis2.databinding.ADBException(
								"The element: " + "relationshipName"
										+ "  cannot be null");
					}

					java.lang.String content = reader.getElementText();

					object.setRelationshipName(org.apache.axis2.databinding.utils.ConverterUtil
							.convertToString(content));
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName(
								"urn:partner.soap.sforce.com",
								"restrictedDelete").equals(reader.getName())) {
					...
					if ("true".equals(nillableValue)
							|| "1".equals(nillableValue)) {
						throw new org.apache.axis2.databinding.ADBException(
								"The element: " + "restrictedDelete"
										+ "  cannot be null");
					}

					java.lang.String content = reader.getElementText();

					object.setRestrictedDelete(org.apache.axis2.databinding.utils.ConverterUtil
							.convertToBoolean(content));
