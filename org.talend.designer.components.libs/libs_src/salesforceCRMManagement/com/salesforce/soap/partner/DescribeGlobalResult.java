...
public class DescribeGlobalResult  implements java.io.Serializable {
    ...
    private com.salesforce.soap.partner.DescribeGlobalSObjectResult[] sobjects;
    ...
    public DescribeGlobalResult(
           ...
           int maxBatchSize,
           com.salesforce.soap.partner.DescribeGlobalSObjectResult[] sobjects) {
     ...
     * @param sobjects
     */
    public void setSobjects(com.salesforce.soap.partner.DescribeGlobalSObjectResult[] sobjects) {
        this.sobjects = sobjects;
    }

    public com.salesforce.soap.partner.DescribeGlobalSObjectResult getSobjects(int i) {
        return this.sobjects[i];
    }

    public void setSobjects(int i, com.salesforce.soap.partner.DescribeGlobalSObjectResult _value) {
