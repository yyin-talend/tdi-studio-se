...
public class LoginResult implements org.apache.axis2.databinding.ADBBean {

    /*
     * This type was generated from the piece of schema that had name = LoginResult Namespace URI =
    ...
    protected com.salesforce.soap.partner.GetUserInfoResult localUserInfo;
    ...
    public void serialize(final javax.xml.namespace.QName parentQName, javax.xml.stream.XMLStreamWriter xmlWriter,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix + ":LoginResult",
                        xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "LoginResult", xmlWriter);
            }

        }

        namespace = "urn:partner.soap.sforce.com";
        writeStartElement(null, namespace, "metadataServerUrl", xmlWriter);
        ...
        namespace = "urn:partner.soap.sforce.com";
        writeStartElement(null, namespace, "passwordExpired", xmlWriter);
        ...
        namespace = "urn:partner.soap.sforce.com";
        writeStartElement(null, namespace, "sandbox", xmlWriter);
        ...
        if (localUserId == null) {
            ...
            writeStartElement(null, "urn:partner.soap.sforce.com", "userId", xmlWriter);
        ...
        if (localUserInfoTracker) {
            ...
            localUserInfo.serialize(new javax.xml.namespace.QName("urn:partner.soap.sforce.com", "userInfo"), xmlWriter);
        }
        xmlWriter.writeEndElement();
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
        ...
        elementList.add(new javax.xml.namespace.QName("urn:partner.soap.sforce.com", "metadataServerUrl"));

        elementList.add(localMetadataServerUrl == null ? null : org.apache.axis2.databinding.utils.ConverterUtil
                .convertToString(localMetadataServerUrl));

        elementList.add(new javax.xml.namespace.QName("urn:partner.soap.sforce.com", "passwordExpired"));

        elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localPasswordExpired));

        elementList.add(new javax.xml.namespace.QName("urn:partner.soap.sforce.com", "sandbox"));

        elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localSandbox));

        elementList.add(new javax.xml.namespace.QName("urn:partner.soap.sforce.com", "serverUrl"));

        elementList.add(localServerUrl == null ? null : org.apache.axis2.databinding.utils.ConverterUtil
                .convertToString(localServerUrl));

        elementList.add(new javax.xml.namespace.QName("urn:partner.soap.sforce.com", "sessionId"));

        elementList.add(localSessionId == null ? null : org.apache.axis2.databinding.utils.ConverterUtil
                .convertToString(localSessionId));

        elementList.add(new javax.xml.namespace.QName("urn:partner.soap.sforce.com", "userId"));

        elementList.add(localUserId == null ? null : localUserId);
        if (localUserInfoTracker) {
            elementList.add(new javax.xml.namespace.QName("urn:partner.soap.sforce.com", "userInfo"));
    ...
    public static class Factory {
        ...
        public static LoginResult parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            LoginResult object = new LoginResult();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"LoginResult".equals(type)) {
                            ...
                            return (LoginResult) com.salesforce.soap.partner.sobject.ExtensionMapper.getTypeObject(nsUri, type,
                                    reader);
                        }
                ...
                // nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "nil");
                // if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
                // throw new org.apache.axis2.databinding.ADBException("The element: " + "passwordExpired"
                // + "  cannot be null");
                // }
                //
                // java.lang.String content = reader.getElementText();
                ...
                // nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "nil");
                // if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
                // throw new org.apache.axis2.databinding.ADBException("The element: " + "sandbox" +
                // "  cannot be null");
                // }
                //
                // java.lang.String content = reader.getElementText();
