...
public class LoginResult  implements java.io.Serializable {
    ...
    private com.salesforce.soap.partner.GetUserInfoResult userInfo;
    ...
    public LoginResult(
           ...
           com.salesforce.soap.partner.GetUserInfoResult userInfo) {
     ...
     * @param userInfo
     */
    public void setUserInfo(com.salesforce.soap.partner.GetUserInfoResult userInfo) {
        this.userInfo = userInfo;
    }
