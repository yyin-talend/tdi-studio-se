...
public class QueryMoreResponse  implements java.io.Serializable {
    private com.salesforce.soap.partner.QueryResult result;

    public QueryMoreResponse() {
    }

    public QueryMoreResponse(
           com.salesforce.soap.partner.QueryResult result) {
           this.result = result;
    }
     ...
     * @param result
     */
    public void setResult(com.salesforce.soap.partner.QueryResult result) {
        this.result = result;
    }
