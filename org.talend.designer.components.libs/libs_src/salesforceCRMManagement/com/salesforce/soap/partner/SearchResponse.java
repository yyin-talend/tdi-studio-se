...
public class SearchResponse  implements java.io.Serializable {
    private com.salesforce.soap.partner.SearchResult result;

    public SearchResponse() {
    }

    public SearchResponse(
           com.salesforce.soap.partner.SearchResult result) {
           this.result = result;
    }
     ...
     * @param result
     */
    public void setResult(com.salesforce.soap.partner.SearchResult result) {
        this.result = result;
    }
