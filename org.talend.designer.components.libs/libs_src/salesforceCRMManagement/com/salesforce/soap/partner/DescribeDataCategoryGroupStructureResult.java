...
public class DescribeDataCategoryGroupStructureResult  implements java.io.Serializable {
    ...
    private com.salesforce.soap.partner.DataCategory[] topCategories;
    ...
    public DescribeDataCategoryGroupStructureResult(
           ...
           com.salesforce.soap.partner.DataCategory[] topCategories) {
     ...
     * @param topCategories
     */
    public void setTopCategories(com.salesforce.soap.partner.DataCategory[] topCategories) {
        this.topCategories = topCategories;
    }

    public com.salesforce.soap.partner.DataCategory getTopCategories(int i) {
        return this.topCategories[i];
    }

    public void setTopCategories(int i, com.salesforce.soap.partner.DataCategory _value) {
