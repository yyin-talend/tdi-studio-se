...
public class SaveResult implements org.apache.axis2.databinding.ADBBean {
    ...
    /*
     * This type was generated from the piece of schema that had name = SaveResult Namespace URI =
    ...
    public void serialize(final javax.xml.namespace.QName parentQName, final org.apache.axiom.om.OMFactory factory,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix + ":SaveResult",
                        xmlWriter);
            } else {
    ...
    public static class Factory {
        ...
        public static SaveResult parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            SaveResult object = new SaveResult();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"SaveResult".equals(type)) {
                            ...
                            return (SaveResult) com.salesforce.soap.partner.sobject.ExtensionMapper.getTypeObject(nsUri, type,
                                    reader);
                        }
