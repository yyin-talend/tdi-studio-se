...
public class DescribeLayout  implements java.io.Serializable {
    private com.salesforce.soap.partner.DescribeLayoutButton[] buttonLayoutSection;

    private com.salesforce.soap.partner.DescribeLayoutSection[] detailLayoutSections;

    private com.salesforce.soap.partner.DescribeLayoutSection[] editLayoutSections;

    private java.lang.String id;

    private com.salesforce.soap.partner.RelatedList[] relatedLists;

    public DescribeLayout() {
    }

    public DescribeLayout(
           com.salesforce.soap.partner.DescribeLayoutButton[] buttonLayoutSection,
           com.salesforce.soap.partner.DescribeLayoutSection[] detailLayoutSections,
           com.salesforce.soap.partner.DescribeLayoutSection[] editLayoutSections,
           java.lang.String id,
           com.salesforce.soap.partner.RelatedList[] relatedLists) {
     ...
     */
    public com.salesforce.soap.partner.DescribeLayoutButton[] getButtonLayoutSection() {
        return buttonLayoutSection;
    }
     ...
     */
    public void setButtonLayoutSection(com.salesforce.soap.partner.DescribeLayoutButton[] buttonLayoutSection) {
        this.buttonLayoutSection = buttonLayoutSection;
    }
     ...
     */
    public void setDetailLayoutSections(com.salesforce.soap.partner.DescribeLayoutSection[] detailLayoutSections) {
        this.detailLayoutSections = detailLayoutSections;
    }

    public com.salesforce.soap.partner.DescribeLayoutSection getDetailLayoutSections(int i) {
        return this.detailLayoutSections[i];
    }

    public void setDetailLayoutSections(int i, com.salesforce.soap.partner.DescribeLayoutSection _value) {
     ...
     */
    public void setEditLayoutSections(com.salesforce.soap.partner.DescribeLayoutSection[] editLayoutSections) {
        this.editLayoutSections = editLayoutSections;
    }

    public com.salesforce.soap.partner.DescribeLayoutSection getEditLayoutSections(int i) {
        return this.editLayoutSections[i];
    }

    public void setEditLayoutSections(int i, com.salesforce.soap.partner.DescribeLayoutSection _value) {
     ...
     * @param relatedLists
     */
    public void setRelatedLists(com.salesforce.soap.partner.RelatedList[] relatedLists) {
        this.relatedLists = relatedLists;
    }

    public com.salesforce.soap.partner.RelatedList getRelatedLists(int i) {
        return this.relatedLists[i];
    }

    public void setRelatedLists(int i, com.salesforce.soap.partner.RelatedList _value) {
