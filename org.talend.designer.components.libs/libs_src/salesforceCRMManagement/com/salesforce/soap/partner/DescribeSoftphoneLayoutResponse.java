...
public class DescribeSoftphoneLayoutResponse  implements java.io.Serializable {
    private com.salesforce.soap.partner.DescribeSoftphoneLayoutResult result;

    public DescribeSoftphoneLayoutResponse() {
    }

    public DescribeSoftphoneLayoutResponse(
           com.salesforce.soap.partner.DescribeSoftphoneLayoutResult result) {
           this.result = result;
    }
     ...
     * @param result
     */
    public void setResult(com.salesforce.soap.partner.DescribeSoftphoneLayoutResult result) {
        this.result = result;
    }
