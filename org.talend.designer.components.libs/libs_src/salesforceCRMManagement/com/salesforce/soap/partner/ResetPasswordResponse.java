...
public class ResetPasswordResponse  implements java.io.Serializable {
    private com.salesforce.soap.partner.ResetPasswordResult result;

    public ResetPasswordResponse() {
    }

    public ResetPasswordResponse(
           com.salesforce.soap.partner.ResetPasswordResult result) {
           this.result = result;
    }
     ...
     * @param result
     */
    public void setResult(com.salesforce.soap.partner.ResetPasswordResult result) {
        this.result = result;
    }
