...
public class DescribeSoftphoneLayoutCallType  implements java.io.Serializable {
    private com.salesforce.soap.partner.DescribeSoftphoneLayoutInfoField[] infoFields;

    private java.lang.String name;

    private com.salesforce.soap.partner.DescribeSoftphoneScreenPopOption[] screenPopOptions;

    private java.lang.String screenPopsOpenWithin;

    private com.salesforce.soap.partner.DescribeSoftphoneLayoutSection[] sections;

    public DescribeSoftphoneLayoutCallType() {
    }

    public DescribeSoftphoneLayoutCallType(
           com.salesforce.soap.partner.DescribeSoftphoneLayoutInfoField[] infoFields,
           java.lang.String name,
           com.salesforce.soap.partner.DescribeSoftphoneScreenPopOption[] screenPopOptions,
           java.lang.String screenPopsOpenWithin,
           com.salesforce.soap.partner.DescribeSoftphoneLayoutSection[] sections) {
     ...
     * @param infoFields
     */
    public void setInfoFields(com.salesforce.soap.partner.DescribeSoftphoneLayoutInfoField[] infoFields) {
        this.infoFields = infoFields;
    }

    public com.salesforce.soap.partner.DescribeSoftphoneLayoutInfoField getInfoFields(int i) {
        return this.infoFields[i];
    }

    public void setInfoFields(int i, com.salesforce.soap.partner.DescribeSoftphoneLayoutInfoField _value) {
     ...
     */
    public void setScreenPopOptions(com.salesforce.soap.partner.DescribeSoftphoneScreenPopOption[] screenPopOptions) {
        this.screenPopOptions = screenPopOptions;
    }

    public com.salesforce.soap.partner.DescribeSoftphoneScreenPopOption getScreenPopOptions(int i) {
        return this.screenPopOptions[i];
    }

    public void setScreenPopOptions(int i, com.salesforce.soap.partner.DescribeSoftphoneScreenPopOption _value) {
     ...
     * @param sections
     */
    public void setSections(com.salesforce.soap.partner.DescribeSoftphoneLayoutSection[] sections) {
        this.sections = sections;
    }

    public com.salesforce.soap.partner.DescribeSoftphoneLayoutSection getSections(int i) {
        return this.sections[i];
    }

    public void setSections(int i, com.salesforce.soap.partner.DescribeSoftphoneLayoutSection _value) {
