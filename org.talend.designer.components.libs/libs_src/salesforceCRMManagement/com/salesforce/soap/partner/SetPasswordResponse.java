...
public class SetPasswordResponse  implements java.io.Serializable {
    private com.salesforce.soap.partner.SetPasswordResult result;

    public SetPasswordResponse() {
    }

    public SetPasswordResponse(
           com.salesforce.soap.partner.SetPasswordResult result) {
           this.result = result;
    }
     ...
     * @param result
     */
    public void setResult(com.salesforce.soap.partner.SetPasswordResult result) {
        this.result = result;
    }
