...
public class DescribeLayoutResult  implements java.io.Serializable {
    private com.salesforce.soap.partner.DescribeLayout[] layouts;

    private com.salesforce.soap.partner.RecordTypeMapping[] recordTypeMappings;
    ...
    public DescribeLayoutResult(
           com.salesforce.soap.partner.DescribeLayout[] layouts,
           com.salesforce.soap.partner.RecordTypeMapping[] recordTypeMappings,
     ...
     * @param layouts
     */
    public void setLayouts(com.salesforce.soap.partner.DescribeLayout[] layouts) {
        this.layouts = layouts;
    }

    public com.salesforce.soap.partner.DescribeLayout getLayouts(int i) {
        return this.layouts[i];
    }

    public void setLayouts(int i, com.salesforce.soap.partner.DescribeLayout _value) {
     ...
     */
    public void setRecordTypeMappings(com.salesforce.soap.partner.RecordTypeMapping[] recordTypeMappings) {
        this.recordTypeMappings = recordTypeMappings;
    }

    public com.salesforce.soap.partner.RecordTypeMapping getRecordTypeMappings(int i) {
        return this.recordTypeMappings[i];
    }

    public void setRecordTypeMappings(int i, com.salesforce.soap.partner.RecordTypeMapping _value) {
