...
public class DescribeLayoutItem  implements java.io.Serializable {
    ...
    private com.salesforce.soap.partner.DescribeLayoutComponent[] layoutComponents;
    ...
    public DescribeLayoutItem(
           ...
           com.salesforce.soap.partner.DescribeLayoutComponent[] layoutComponents,
           boolean placeholder,
           boolean required) {
     ...
     */
    public void setLayoutComponents(com.salesforce.soap.partner.DescribeLayoutComponent[] layoutComponents) {
        this.layoutComponents = layoutComponents;
    }

    public com.salesforce.soap.partner.DescribeLayoutComponent getLayoutComponents(int i) {
        return this.layoutComponents[i];
    }

    public void setLayoutComponents(int i, com.salesforce.soap.partner.DescribeLayoutComponent _value) {
