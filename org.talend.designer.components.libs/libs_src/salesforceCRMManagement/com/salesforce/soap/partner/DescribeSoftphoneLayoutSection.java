...
public class DescribeSoftphoneLayoutSection  implements java.io.Serializable {
    ...
    private com.salesforce.soap.partner.DescribeSoftphoneLayoutItem[] items;
    ...
    public DescribeSoftphoneLayoutSection(
           ...
           com.salesforce.soap.partner.DescribeSoftphoneLayoutItem[] items) {
     ...
     * @param items
     */
    public void setItems(com.salesforce.soap.partner.DescribeSoftphoneLayoutItem[] items) {
        this.items = items;
    }

    public com.salesforce.soap.partner.DescribeSoftphoneLayoutItem getItems(int i) {
        return this.items[i];
    }

    public void setItems(int i, com.salesforce.soap.partner.DescribeSoftphoneLayoutItem _value) {
        this.items[i] = _value;
    }
