...
public class EmptyRecycleBin implements org.apache.axis2.databinding.ADBBean {
    ...
    public void serialize(final javax.xml.namespace.QName parentQName, final org.apache.axiom.om.OMFactory factory,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix + ":emptyRecycleBin",
                        xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "emptyRecycleBin", xmlWriter);
            }
        ...
        if (localIds != null) {
            for (int i = 0; i < localIds.length; i++) {
                if (localIds[i] != null) {
                    localIds[i]
                            .serialize(new javax.xml.namespace.QName("urn:partner.soap.sforce.com", "ids"), factory, xmlWriter);
                } else {
    ...
    public static class Factory {
        ...
        public static EmptyRecycleBin parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            EmptyRecycleBin object = new EmptyRecycleBin();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"emptyRecycleBin".equals(type)) {
                            ...
                            return (EmptyRecycleBin) com.salesforce.soap.partner.sobject.ExtensionMapper.getTypeObject(nsUri,
                                    type, reader);
                        }
