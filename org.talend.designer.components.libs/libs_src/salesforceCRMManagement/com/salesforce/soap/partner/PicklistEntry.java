...
public class PicklistEntry implements org.apache.axis2.databinding.ADBBean {

    /*
     * This type was generated from the piece of schema that had name = PicklistEntry Namespace URI =
    ...
    public boolean isValidForSpecified() {
        return localValidForTracker;
    }
    ...
    public void setValidFor(javax.activation.DataHandler param) {
        localValidForTracker = param != null;
    ...
    public void serialize(final javax.xml.namespace.QName parentQName, javax.xml.stream.XMLStreamWriter xmlWriter,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix + ":PicklistEntry",
                        xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "PicklistEntry", xmlWriter);
            }
        ...
        if (localValidForTracker) {
            namespace = "urn:partner.soap.sforce.com";
            writeStartElement(null, namespace, "validFor", xmlWriter);

            if (localValidFor != null) {
                try {
                    org.apache.axiom.util.stax.XMLStreamWriterUtils.writeDataHandler(xmlWriter, localValidFor, null, true);
                } catch (java.io.IOException ex) {
                    throw new javax.xml.stream.XMLStreamException("Unable to read data handler for validFor", ex);
                }
            } else {
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
        ...
        elementList.add(new javax.xml.namespace.QName("urn:partner.soap.sforce.com", "active"));

        elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localActive));

        elementList.add(new javax.xml.namespace.QName("urn:partner.soap.sforce.com", "defaultValue"));
        ...
        if (localValidForTracker) {
            elementList.add(new javax.xml.namespace.QName("urn:partner.soap.sforce.com", "validFor"));
        ...
        public static PicklistEntry parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"PicklistEntry".equals(type)) {
                            ...
                            return (PicklistEntry) com.salesforce.soap.partner.sobject.ExtensionMapper.getTypeObject(nsUri, type,
                                    reader);
                        }
                ...
                if (reader.isStartElement()
                        && new javax.xml.namespace.QName("urn:partner.soap.sforce.com", "active").equals(reader.getName())) {
                ...
                if (reader.isStartElement()
                        && new javax.xml.namespace.QName("urn:partner.soap.sforce.com", "defaultValue").equals(reader.getName())) {
                ...
                if (reader.isStartElement()
                        && new javax.xml.namespace.QName("urn:partner.soap.sforce.com", "validFor").equals(reader.getName())) {

                    object.setValidFor(org.apache.axiom.util.stax.XMLStreamReaderUtils.getDataHandlerFromElement(reader));
