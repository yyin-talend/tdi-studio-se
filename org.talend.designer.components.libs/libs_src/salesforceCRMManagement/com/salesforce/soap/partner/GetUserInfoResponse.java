...
public class GetUserInfoResponse  implements java.io.Serializable {
    private com.salesforce.soap.partner.GetUserInfoResult result;

    public GetUserInfoResponse() {
    }

    public GetUserInfoResponse(
           com.salesforce.soap.partner.GetUserInfoResult result) {
           this.result = result;
    }
     ...
     * @param result
     */
    public void setResult(com.salesforce.soap.partner.GetUserInfoResult result) {
        this.result = result;
    }
