...
public class SendEmailResult  implements java.io.Serializable {
    private com.salesforce.soap.partner.SendEmailError[] errors;
    ...
    public SendEmailResult(
           com.salesforce.soap.partner.SendEmailError[] errors,
           boolean success) {
           this.errors = errors;
     ...
     * @param errors
     */
    public void setErrors(com.salesforce.soap.partner.SendEmailError[] errors) {
        this.errors = errors;
    }

    public com.salesforce.soap.partner.SendEmailError getErrors(int i) {
        return this.errors[i];
    }

    public void setErrors(int i, com.salesforce.soap.partner.SendEmailError _value) {
