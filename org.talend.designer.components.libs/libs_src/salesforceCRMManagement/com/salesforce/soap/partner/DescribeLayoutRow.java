...
public class DescribeLayoutRow  implements java.io.Serializable {
    private com.salesforce.soap.partner.DescribeLayoutItem[] layoutItems;
    ...
    public DescribeLayoutRow(
           com.salesforce.soap.partner.DescribeLayoutItem[] layoutItems,
           int numItems) {
     ...
     * @param layoutItems
     */
    public void setLayoutItems(com.salesforce.soap.partner.DescribeLayoutItem[] layoutItems) {
        this.layoutItems = layoutItems;
    }

    public com.salesforce.soap.partner.DescribeLayoutItem getLayoutItems(int i) {
        return this.layoutItems[i];
    }

    public void setLayoutItems(int i, com.salesforce.soap.partner.DescribeLayoutItem _value) {
