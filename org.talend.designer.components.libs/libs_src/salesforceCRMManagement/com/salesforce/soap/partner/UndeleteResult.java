...
public class UndeleteResult  implements java.io.Serializable {
    private com.salesforce.soap.partner.Error[] errors;
    ...
    public UndeleteResult(
           com.salesforce.soap.partner.Error[] errors,
           java.lang.String id,
           boolean success) {
           this.errors = errors;
           this.id = id;
     ...
     * @param errors
     */
    public void setErrors(com.salesforce.soap.partner.Error[] errors) {
        this.errors = errors;
    }

    public com.salesforce.soap.partner.Error getErrors(int i) {
        return this.errors[i];
    }

    public void setErrors(int i, com.salesforce.soap.partner.Error _value) {
