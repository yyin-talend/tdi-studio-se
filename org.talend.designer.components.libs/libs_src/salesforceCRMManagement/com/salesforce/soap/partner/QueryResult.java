...
public class QueryResult  implements java.io.Serializable {
    ...
    private com.salesforce.soap.partner.sobject.SObject[] records;
    ...
    public QueryResult(
           ...
           com.salesforce.soap.partner.sobject.SObject[] records,
           int size) {
           this.done = done;
     ...
     * @param records
     */
    public void setRecords(com.salesforce.soap.partner.sobject.SObject[] records) {
        this.records = records;
    }

    public com.salesforce.soap.partner.sobject.SObject getRecords(int i) {
        return this.records[i];
    }

    public void setRecords(int i, com.salesforce.soap.partner.sobject.SObject _value) {
