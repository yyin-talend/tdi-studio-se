...
public class GetDeletedResponse  implements java.io.Serializable {
    private com.salesforce.soap.partner.GetDeletedResult result;

    public GetDeletedResponse() {
    }

    public GetDeletedResponse(
           com.salesforce.soap.partner.GetDeletedResult result) {
           this.result = result;
    }
     ...
     * @param result
     */
    public void setResult(com.salesforce.soap.partner.GetDeletedResult result) {
        this.result = result;
    }
