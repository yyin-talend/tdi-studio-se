...
public class DescribeGlobalResponse  implements java.io.Serializable {
    private com.salesforce.soap.partner.DescribeGlobalResult result;

    public DescribeGlobalResponse() {
    }

    public DescribeGlobalResponse(
           com.salesforce.soap.partner.DescribeGlobalResult result) {
           this.result = result;
    }
     ...
     * @param result
     */
    public void setResult(com.salesforce.soap.partner.DescribeGlobalResult result) {
        this.result = result;
    }
