...
public class DataCategory  implements java.io.Serializable {
    private com.salesforce.soap.partner.DataCategory[] childCategories;
    ...
    public DataCategory(
           com.salesforce.soap.partner.DataCategory[] childCategories,
     ...
     */
    public void setChildCategories(com.salesforce.soap.partner.DataCategory[] childCategories) {
        this.childCategories = childCategories;
    }

    public com.salesforce.soap.partner.DataCategory getChildCategories(int i) {
        return this.childCategories[i];
    }

    public void setChildCategories(int i, com.salesforce.soap.partner.DataCategory _value) {
