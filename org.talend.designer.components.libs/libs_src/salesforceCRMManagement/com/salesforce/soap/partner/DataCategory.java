                           ...
                           public  com.salesforce.soap.partner.DataCategory[] getChildCategories(){
                              ...
                              public void setChildCategories(com.salesforce.soap.partner.DataCategory[] param){
                                   ...
                                   validateChildCategories(param);
                                          ...
                                          if (param != null){
                                             ...
                                             localChildCategoriesTracker = false;
                             ...
                             */
                             public void addChildCategories(com.salesforce.soap.partner.DataCategory param){
                               ...
                               java.util.List list =
                            org.apache.axis2.databinding.utils.ConverterUtil.toList(localChildCategories);
                               list.add(param);
                               this.localChildCategories =
                             (com.salesforce.soap.partner.DataCategory[])list.toArray(
                            new com.salesforce.soap.partner.DataCategory[list.size()]);
       ...
       public org.apache.axiom.om.OMElement getOMElement (
               ...
               org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       DataCategory.this.serialize(parentQName,factory,xmlWriter);
                 }
               };
                                       ...
                                       if (localChildCategories!=null){
                                            for (int i = 0;i < localChildCategories.length;i++){
                                                if (localChildCategories[i] != null){
                                                 localChildCategories[i].serialize(new javax.xml.namespace.QName("urn:partner.soap.sforce.com","childCategories"),
                                                           factory,xmlWriter);
                                                } else {
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"DataCategory".equals(type)){
                                ...
                                return (DataCategory)com.salesforce.soap.partner.sobject.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list1 = new java.util.ArrayList();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("urn:partner.soap.sforce.com","childCategories").equals(reader.getName())){
                                    ...
                                    list1.add(com.salesforce.soap.partner.DataCategory.Factory.parse(reader));
                                                        ...
                                                        while(!loopDone1){
                                                            ...
                                                            if (reader.isEndElement()){
                                                                ...
                                                                if (new javax.xml.namespace.QName("urn:partner.soap.sforce.com","childCategories").equals(reader.getName())){
                                                                    list1.add(com.salesforce.soap.partner.DataCategory.Factory.parse(reader));
                                                        ...
                                                        object.setChildCategories((com.salesforce.soap.partner.DataCategory[])
                                                            org.apache.axis2.databinding.utils.ConverterUtil.convertToArray(
                                                                com.salesforce.soap.partner.DataCategory.class,
                                                                list1));
