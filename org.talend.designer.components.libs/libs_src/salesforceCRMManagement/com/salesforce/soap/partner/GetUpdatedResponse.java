...
public class GetUpdatedResponse  implements java.io.Serializable {
    private com.salesforce.soap.partner.GetUpdatedResult result;

    public GetUpdatedResponse() {
    }

    public GetUpdatedResponse(
           com.salesforce.soap.partner.GetUpdatedResult result) {
           this.result = result;
    }
     ...
     * @param result
     */
    public void setResult(com.salesforce.soap.partner.GetUpdatedResult result) {
        this.result = result;
    }
