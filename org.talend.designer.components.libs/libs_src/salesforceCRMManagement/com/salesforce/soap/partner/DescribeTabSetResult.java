...
public class DescribeTabSetResult  implements java.io.Serializable {
    ...
    private com.salesforce.soap.partner.DescribeTab[] tabs;
    ...
    public DescribeTabSetResult(
           ...
           boolean selected,
           com.salesforce.soap.partner.DescribeTab[] tabs) {
           this.label = label;
     ...
     * @param tabs
     */
    public void setTabs(com.salesforce.soap.partner.DescribeTab[] tabs) {
        this.tabs = tabs;
    }

    public com.salesforce.soap.partner.DescribeTab getTabs(int i) {
        return this.tabs[i];
    }

    public void setTabs(int i, com.salesforce.soap.partner.DescribeTab _value) {
        this.tabs[i] = _value;
    }
