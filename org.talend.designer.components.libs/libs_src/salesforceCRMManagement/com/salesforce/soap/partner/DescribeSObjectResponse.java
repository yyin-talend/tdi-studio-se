...
public class DescribeSObjectResponse  implements java.io.Serializable {
    private com.salesforce.soap.partner.DescribeSObjectResult result;

    public DescribeSObjectResponse() {
    }

    public DescribeSObjectResponse(
           com.salesforce.soap.partner.DescribeSObjectResult result) {
           this.result = result;
    }
     ...
     * @param result
     */
    public void setResult(com.salesforce.soap.partner.DescribeSObjectResult result) {
        this.result = result;
    }
