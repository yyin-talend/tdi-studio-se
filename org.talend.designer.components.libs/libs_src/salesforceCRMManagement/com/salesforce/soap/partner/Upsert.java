...
public class Upsert  implements java.io.Serializable {
    ...
    private com.salesforce.soap.partner.sobject.SObject[] sObjects;
    ...
    public Upsert(
           ...
           com.salesforce.soap.partner.sobject.SObject[] sObjects) {
     ...
     * @param sObjects
     */
    public void setSObjects(com.salesforce.soap.partner.sobject.SObject[] sObjects) {
        this.sObjects = sObjects;
    }

    public com.salesforce.soap.partner.sobject.SObject getSObjects(int i) {
        return this.sObjects[i];
    }

    public void setSObjects(int i, com.salesforce.soap.partner.sobject.SObject _value) {
