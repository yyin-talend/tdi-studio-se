...
public class QueryMoreResponse  implements java.io.Serializable {
    private com.sforce16.soap.partner.QueryResult result;

    public QueryMoreResponse() {
    }

    public QueryMoreResponse(
           com.sforce16.soap.partner.QueryResult result) {
           this.result = result;
    }
     ...
     * @return result
     */
    public com.sforce16.soap.partner.QueryResult getResult() {
        return result;
    }
     ...
     * @param result
     */
    public void setResult(com.sforce16.soap.partner.QueryResult result) {
        this.result = result;
    }
