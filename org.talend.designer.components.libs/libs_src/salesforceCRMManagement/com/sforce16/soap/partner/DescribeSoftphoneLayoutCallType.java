...
public class DescribeSoftphoneLayoutCallType  implements java.io.Serializable {
    private com.sforce16.soap.partner.DescribeSoftphoneLayoutInfoField[] infoFields;

    private java.lang.String name;

    private com.sforce16.soap.partner.DescribeSoftphoneLayoutSection[] sections;

    public DescribeSoftphoneLayoutCallType() {
    }

    public DescribeSoftphoneLayoutCallType(
           com.sforce16.soap.partner.DescribeSoftphoneLayoutInfoField[] infoFields,
           java.lang.String name,
           com.sforce16.soap.partner.DescribeSoftphoneLayoutSection[] sections) {
     ...
     * @return infoFields
     */
    public com.sforce16.soap.partner.DescribeSoftphoneLayoutInfoField[] getInfoFields() {
        return infoFields;
    }
     ...
     * @param infoFields
     */
    public void setInfoFields(com.sforce16.soap.partner.DescribeSoftphoneLayoutInfoField[] infoFields) {
        this.infoFields = infoFields;
    }

    public com.sforce16.soap.partner.DescribeSoftphoneLayoutInfoField getInfoFields(int i) {
        return this.infoFields[i];
    }

    public void setInfoFields(int i, com.sforce16.soap.partner.DescribeSoftphoneLayoutInfoField _value) {
     ...
     * @return sections
     */
    public com.sforce16.soap.partner.DescribeSoftphoneLayoutSection[] getSections() {
        return sections;
    }
     ...
     * @param sections
     */
    public void setSections(com.sforce16.soap.partner.DescribeSoftphoneLayoutSection[] sections) {
        this.sections = sections;
    }

    public com.sforce16.soap.partner.DescribeSoftphoneLayoutSection getSections(int i) {
        return this.sections[i];
    }

    public void setSections(int i, com.sforce16.soap.partner.DescribeSoftphoneLayoutSection _value) {
