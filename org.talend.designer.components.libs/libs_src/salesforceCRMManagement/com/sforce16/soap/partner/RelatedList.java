...
public class RelatedList  implements java.io.Serializable {
    private com.sforce16.soap.partner.RelatedListColumn[] columns;
    ...
    private com.sforce16.soap.partner.RelatedListSort[] sort;

    public RelatedList() {
    }

    public RelatedList(
           com.sforce16.soap.partner.RelatedListColumn[] columns,
           boolean custom,
           ...
           com.sforce16.soap.partner.RelatedListSort[] sort) {
     ...
     * @return columns
     */
    public com.sforce16.soap.partner.RelatedListColumn[] getColumns() {
        return columns;
    }
     ...
     * @param columns
     */
    public void setColumns(com.sforce16.soap.partner.RelatedListColumn[] columns) {
        this.columns = columns;
    }

    public com.sforce16.soap.partner.RelatedListColumn getColumns(int i) {
        return this.columns[i];
    }

    public void setColumns(int i, com.sforce16.soap.partner.RelatedListColumn _value) {
     ...
     * @return sort
     */
    public com.sforce16.soap.partner.RelatedListSort[] getSort() {
        return sort;
    }
     ...
     * @param sort
     */
    public void setSort(com.sforce16.soap.partner.RelatedListSort[] sort) {
        this.sort = sort;
    }

    public com.sforce16.soap.partner.RelatedListSort getSort(int i) {
        return this.sort[i];
    }

    public void setSort(int i, com.sforce16.soap.partner.RelatedListSort _value) {
        this.sort[i] = _value;
    }
