...
public class SetPasswordResponse  implements java.io.Serializable {
    private com.sforce16.soap.partner.SetPasswordResult result;

    public SetPasswordResponse() {
    }

    public SetPasswordResponse(
           com.sforce16.soap.partner.SetPasswordResult result) {
           this.result = result;
    }
     ...
     * @return result
     */
    public com.sforce16.soap.partner.SetPasswordResult getResult() {
        return result;
    }
     ...
     * @param result
     */
    public void setResult(com.sforce16.soap.partner.SetPasswordResult result) {
        this.result = result;
    }
