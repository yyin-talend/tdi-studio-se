...
public class DescribeGlobalResponse  implements java.io.Serializable {
    private com.sforce16.soap.partner.DescribeGlobalResult result;

    public DescribeGlobalResponse() {
    }

    public DescribeGlobalResponse(
           com.sforce16.soap.partner.DescribeGlobalResult result) {
           this.result = result;
    }
     ...
     * @return result
     */
    public com.sforce16.soap.partner.DescribeGlobalResult getResult() {
        return result;
    }
     ...
     * @param result
     */
    public void setResult(com.sforce16.soap.partner.DescribeGlobalResult result) {
        this.result = result;
    }
