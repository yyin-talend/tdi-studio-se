...
public class GetDeletedResponse  implements java.io.Serializable {
    private com.sforce16.soap.partner.GetDeletedResult result;

    public GetDeletedResponse() {
    }

    public GetDeletedResponse(
           com.sforce16.soap.partner.GetDeletedResult result) {
           this.result = result;
    }
     ...
     * @return result
     */
    public com.sforce16.soap.partner.GetDeletedResult getResult() {
        return result;
    }
     ...
     * @param result
     */
    public void setResult(com.sforce16.soap.partner.GetDeletedResult result) {
        this.result = result;
    }
