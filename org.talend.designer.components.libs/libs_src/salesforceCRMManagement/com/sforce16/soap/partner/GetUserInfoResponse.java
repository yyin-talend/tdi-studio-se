...
public class GetUserInfoResponse  implements java.io.Serializable {
    private com.sforce16.soap.partner.GetUserInfoResult result;

    public GetUserInfoResponse() {
    }

    public GetUserInfoResponse(
           com.sforce16.soap.partner.GetUserInfoResult result) {
           this.result = result;
    }
     ...
     * @return result
     */
    public com.sforce16.soap.partner.GetUserInfoResult getResult() {
        return result;
    }
     ...
     * @param result
     */
    public void setResult(com.sforce16.soap.partner.GetUserInfoResult result) {
        this.result = result;
    }
