...
public class QueryResult  implements java.io.Serializable {
    ...
    private com.sforce16.soap.partner.sobject.SObject[] records;
    ...
    public QueryResult(
           ...
           com.sforce16.soap.partner.sobject.SObject[] records,
           int size) {
           this.done = done;
     ...
     * @return records
     */
    public com.sforce16.soap.partner.sobject.SObject[] getRecords() {
        return records;
    }
     ...
     * @param records
     */
    public void setRecords(com.sforce16.soap.partner.sobject.SObject[] records) {
        this.records = records;
    }

    public com.sforce16.soap.partner.sobject.SObject getRecords(int i) {
        return this.records[i];
    }

    public void setRecords(int i, com.sforce16.soap.partner.sobject.SObject _value) {
