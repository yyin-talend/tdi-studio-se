...
public class DescribeTabSetResult  implements java.io.Serializable {
    ...
    private com.sforce16.soap.partner.DescribeTab[] tabs;
    ...
    public DescribeTabSetResult(
           ...
           boolean selected,
           com.sforce16.soap.partner.DescribeTab[] tabs) {
           this.label = label;
     ...
     * @return tabs
     */
    public com.sforce16.soap.partner.DescribeTab[] getTabs() {
        return tabs;
    }
     ...
     * @param tabs
     */
    public void setTabs(com.sforce16.soap.partner.DescribeTab[] tabs) {
        this.tabs = tabs;
    }

    public com.sforce16.soap.partner.DescribeTab getTabs(int i) {
        return this.tabs[i];
    }

    public void setTabs(int i, com.sforce16.soap.partner.DescribeTab _value) {
        this.tabs[i] = _value;
    }
