...
public class SearchResponse  implements java.io.Serializable {
    private com.sforce16.soap.partner.SearchResult result;

    public SearchResponse() {
    }

    public SearchResponse(
           com.sforce16.soap.partner.SearchResult result) {
           this.result = result;
    }
     ...
     * @return result
     */
    public com.sforce16.soap.partner.SearchResult getResult() {
        return result;
    }
     ...
     * @param result
     */
    public void setResult(com.sforce16.soap.partner.SearchResult result) {
        this.result = result;
    }
