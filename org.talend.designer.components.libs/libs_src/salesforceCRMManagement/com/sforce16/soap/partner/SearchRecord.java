...
public class SearchRecord  implements java.io.Serializable {
    private com.sforce16.soap.partner.sobject.SObject record;

    public SearchRecord() {
    }

    public SearchRecord(
           com.sforce16.soap.partner.sobject.SObject record) {
           this.record = record;
    }
     ...
     * @return record
     */
    public com.sforce16.soap.partner.sobject.SObject getRecord() {
        return record;
    }
     ...
     * @param record
     */
    public void setRecord(com.sforce16.soap.partner.sobject.SObject record) {
        this.record = record;
    }
