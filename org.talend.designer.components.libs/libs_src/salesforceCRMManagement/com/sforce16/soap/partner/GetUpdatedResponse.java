...
public class GetUpdatedResponse  implements java.io.Serializable {
    private com.sforce16.soap.partner.GetUpdatedResult result;

    public GetUpdatedResponse() {
    }

    public GetUpdatedResponse(
           com.sforce16.soap.partner.GetUpdatedResult result) {
           this.result = result;
    }
     ...
     * @return result
     */
    public com.sforce16.soap.partner.GetUpdatedResult getResult() {
        return result;
    }
     ...
     * @param result
     */
    public void setResult(com.sforce16.soap.partner.GetUpdatedResult result) {
        this.result = result;
    }
