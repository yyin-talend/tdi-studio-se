...
public class ResetPasswordResponse  implements java.io.Serializable {
    private com.sforce16.soap.partner.ResetPasswordResult result;

    public ResetPasswordResponse() {
    }

    public ResetPasswordResponse(
           com.sforce16.soap.partner.ResetPasswordResult result) {
           this.result = result;
    }
     ...
     * @return result
     */
    public com.sforce16.soap.partner.ResetPasswordResult getResult() {
        return result;
    }
     ...
     * @param result
     */
    public void setResult(com.sforce16.soap.partner.ResetPasswordResult result) {
        this.result = result;
    }
