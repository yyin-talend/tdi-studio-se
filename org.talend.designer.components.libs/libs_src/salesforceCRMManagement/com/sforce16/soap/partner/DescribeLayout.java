...
public class DescribeLayout  implements java.io.Serializable {
    private com.sforce16.soap.partner.DescribeLayoutButton[] buttonLayoutSection;

    private com.sforce16.soap.partner.DescribeLayoutSection[] detailLayoutSections;

    private com.sforce16.soap.partner.DescribeLayoutSection[] editLayoutSections;

    private java.lang.String id;

    private com.sforce16.soap.partner.RelatedList[] relatedLists;

    public DescribeLayout() {
    }

    public DescribeLayout(
           com.sforce16.soap.partner.DescribeLayoutButton[] buttonLayoutSection,
           com.sforce16.soap.partner.DescribeLayoutSection[] detailLayoutSections,
           com.sforce16.soap.partner.DescribeLayoutSection[] editLayoutSections,
           java.lang.String id,
           com.sforce16.soap.partner.RelatedList[] relatedLists) {
     ...
     */
    public com.sforce16.soap.partner.DescribeLayoutButton[] getButtonLayoutSection() {
        return buttonLayoutSection;
    }
     ...
     */
    public void setButtonLayoutSection(com.sforce16.soap.partner.DescribeLayoutButton[] buttonLayoutSection) {
        this.buttonLayoutSection = buttonLayoutSection;
    }
     ...
     */
    public com.sforce16.soap.partner.DescribeLayoutSection[] getDetailLayoutSections() {
        return detailLayoutSections;
    }
     ...
     */
    public void setDetailLayoutSections(com.sforce16.soap.partner.DescribeLayoutSection[] detailLayoutSections) {
        this.detailLayoutSections = detailLayoutSections;
    }

    public com.sforce16.soap.partner.DescribeLayoutSection getDetailLayoutSections(int i) {
        return this.detailLayoutSections[i];
    }

    public void setDetailLayoutSections(int i, com.sforce16.soap.partner.DescribeLayoutSection _value) {
     ...
     */
    public com.sforce16.soap.partner.DescribeLayoutSection[] getEditLayoutSections() {
        return editLayoutSections;
    }
     ...
     */
    public void setEditLayoutSections(com.sforce16.soap.partner.DescribeLayoutSection[] editLayoutSections) {
        this.editLayoutSections = editLayoutSections;
    }

    public com.sforce16.soap.partner.DescribeLayoutSection getEditLayoutSections(int i) {
        return this.editLayoutSections[i];
    }

    public void setEditLayoutSections(int i, com.sforce16.soap.partner.DescribeLayoutSection _value) {
     ...
     * @return relatedLists
     */
    public com.sforce16.soap.partner.RelatedList[] getRelatedLists() {
        return relatedLists;
    }
     ...
     * @param relatedLists
     */
    public void setRelatedLists(com.sforce16.soap.partner.RelatedList[] relatedLists) {
        this.relatedLists = relatedLists;
    }

    public com.sforce16.soap.partner.RelatedList getRelatedLists(int i) {
        return this.relatedLists[i];
    }

    public void setRelatedLists(int i, com.sforce16.soap.partner.RelatedList _value) {
