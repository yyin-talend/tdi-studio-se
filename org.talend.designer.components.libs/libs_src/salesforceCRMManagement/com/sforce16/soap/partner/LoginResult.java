...
public class LoginResult  implements java.io.Serializable {
    ...
    private com.sforce16.soap.partner.GetUserInfoResult userInfo;
    ...
    public LoginResult(
           ...
           com.sforce16.soap.partner.GetUserInfoResult userInfo) {
     ...
     * @return userInfo
     */
    public com.sforce16.soap.partner.GetUserInfoResult getUserInfo() {
        return userInfo;
    }
     ...
     * @param userInfo
     */
    public void setUserInfo(com.sforce16.soap.partner.GetUserInfoResult userInfo) {
        this.userInfo = userInfo;
    }
