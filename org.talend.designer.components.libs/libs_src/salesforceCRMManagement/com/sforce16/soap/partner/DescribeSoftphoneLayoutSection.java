...
public class DescribeSoftphoneLayoutSection  implements java.io.Serializable {
    ...
    private com.sforce16.soap.partner.DescribeSoftphoneLayoutItem[] items;
    ...
    public DescribeSoftphoneLayoutSection(
           ...
           com.sforce16.soap.partner.DescribeSoftphoneLayoutItem[] items) {
     ...
     * @return items
     */
    public com.sforce16.soap.partner.DescribeSoftphoneLayoutItem[] getItems() {
        return items;
    }
     ...
     * @param items
     */
    public void setItems(com.sforce16.soap.partner.DescribeSoftphoneLayoutItem[] items) {
        this.items = items;
    }

    public com.sforce16.soap.partner.DescribeSoftphoneLayoutItem getItems(int i) {
        return this.items[i];
    }

    public void setItems(int i, com.sforce16.soap.partner.DescribeSoftphoneLayoutItem _value) {
        this.items[i] = _value;
    }
