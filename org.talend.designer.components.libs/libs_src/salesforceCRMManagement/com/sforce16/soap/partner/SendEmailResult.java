...
public class SendEmailResult  implements java.io.Serializable {
    private com.sforce16.soap.partner.SendEmailError[] errors;
    ...
    public SendEmailResult(
           com.sforce16.soap.partner.SendEmailError[] errors,
           boolean success) {
           this.errors = errors;
     ...
     * @return errors
     */
    public com.sforce16.soap.partner.SendEmailError[] getErrors() {
        return errors;
    }
     ...
     * @param errors
     */
    public void setErrors(com.sforce16.soap.partner.SendEmailError[] errors) {
        this.errors = errors;
    }

    public com.sforce16.soap.partner.SendEmailError getErrors(int i) {
        return this.errors[i];
    }

    public void setErrors(int i, com.sforce16.soap.partner.SendEmailError _value) {
