...
public class DescribeLayoutResponse  implements java.io.Serializable {
    private com.sforce16.soap.partner.DescribeLayoutResult result;

    public DescribeLayoutResponse() {
    }

    public DescribeLayoutResponse(
           com.sforce16.soap.partner.DescribeLayoutResult result) {
           this.result = result;
    }
     ...
     * @return result
     */
    public com.sforce16.soap.partner.DescribeLayoutResult getResult() {
        return result;
    }
     ...
     * @param result
     */
    public void setResult(com.sforce16.soap.partner.DescribeLayoutResult result) {
        this.result = result;
    }
