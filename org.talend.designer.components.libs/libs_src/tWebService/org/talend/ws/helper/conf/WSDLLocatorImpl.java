...
public class WSDLLocatorImpl implements WSDLLocator {
    ...
    public void close() {
        for (InputStream is : inputStreams) {
            try {
                ...
                Logger.getLogger(WSDLLocatorImpl.class.getName()).
    ...
    private HttpClient createHttpClient() {
        ...
        if (configuration.getProxyServer() != null) {
            ...
            hostConfiguration.setProxy(configuration.getProxyServer(), configuration.
                    getProxyPort());
            httpClient.setHostConfiguration(hostConfiguration);
        }

        if (configuration.getUsername() != null) {
            Credentials credentials = new UsernamePasswordCredentials(configuration.
        ...
        if (configuration.getProxyUsername() != null) {
            ...
            httpClient.getHostConfiguration().setProxy(configuration.
                    getProxyServer(), configuration.getProxyPort());
        }
