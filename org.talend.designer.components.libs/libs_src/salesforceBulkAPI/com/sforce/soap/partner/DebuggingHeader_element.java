...
public class DebuggingHeader_element extends com.sforce.ws.bind.SoapHeaderObject implements com.sforce.ws.bind.XMLizable {
    ...
    /**
     * * element : debugLevel of type {urn:partner.soap.sforce.com}DebugLevel * java type:
    ...
    private static final com.sforce.ws.bind.TypeInfo debugLevel__typeInfo = new com.sforce.ws.bind.TypeInfo(
            "urn:partner.soap.sforce.com", "debugLevel", "urn:partner.soap.sforce.com", "DebugLevel", 1, 1, true);
