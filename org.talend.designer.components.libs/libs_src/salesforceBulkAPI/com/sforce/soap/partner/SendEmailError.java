...
public class SendEmailError implements com.sforce.ws.bind.XMLizable {
    ...
    private static final com.sforce.ws.bind.TypeInfo fields__typeInfo = new com.sforce.ws.bind.TypeInfo(
            "urn:partner.soap.sforce.com", "fields", "http://www.w3.org/2001/XMLSchema", "string", 0, -1, true);
    ...
    private static final com.sforce.ws.bind.TypeInfo message__typeInfo = new com.sforce.ws.bind.TypeInfo(
            "urn:partner.soap.sforce.com", "message", "http://www.w3.org/2001/XMLSchema", "string", 1, 1, true);
    ...
    /**
     * * element : statusCode of type {urn:partner.soap.sforce.com}StatusCode * java type:
     * com.sforce.soap.partner.StatusCode
     */
    private static final com.sforce.ws.bind.TypeInfo statusCode__typeInfo = new com.sforce.ws.bind.TypeInfo(
            "urn:partner.soap.sforce.com", "statusCode", "urn:partner.soap.sforce.com", "StatusCode", 1, 1, true);
    ...
    private static final com.sforce.ws.bind.TypeInfo targetObjectId__typeInfo = new com.sforce.ws.bind.TypeInfo(
            "urn:partner.soap.sforce.com", "targetObjectId", "urn:partner.soap.sforce.com", "ID", 1, 1, true);
    ...
    protected void loadFields(com.sforce.ws.parser.XmlInputStream __in, com.sforce.ws.bind.TypeMapper __typeMapper)
        ...
        if (__typeMapper.verifyElement(__in, statusCode__typeInfo)) {
            setStatusCode((com.sforce.soap.partner.StatusCode) __typeMapper.readObject(__in, statusCode__typeInfo,
                    com.sforce.soap.partner.StatusCode.class));
        }
        __in.peekTag();
