...
public class StreamingEnabledHeader_element extends com.sforce.ws.bind.SoapHeaderObject implements com.sforce.ws.bind.XMLizable {
    ...
    /** * element : streamingEnabled of type {http://www.w3.org/2001/XMLSchema}boolean * java type: boolean */
    private static final com.sforce.ws.bind.TypeInfo streamingEnabled__typeInfo = new com.sforce.ws.bind.TypeInfo(
            "urn:partner.soap.sforce.com", "streamingEnabled", "http://www.w3.org/2001/XMLSchema", "boolean", 1, 1, true);
    ...
    protected void loadFields(com.sforce.ws.parser.XmlInputStream __in, com.sforce.ws.bind.TypeMapper __typeMapper)
        ...
        if (__typeMapper.verifyElement(__in, streamingEnabled__typeInfo)) {
            setStreamingEnabled((boolean) __typeMapper.readBoolean(__in, streamingEnabled__typeInfo, boolean.class));
        }
    }
    ...
    public String toString() {
        ...
        sb.append("'" + com.sforce.ws.util.Verbose.toString(streamingEnabled) + "'\n");
        sb.append("]\n");
        return sb.toString();
    }
}
