...
public class SearchRecord implements com.sforce.ws.bind.XMLizable {
    ...
    /**
     * * element : record of type {urn:sobject.partner.soap.sforce.com}sObject * java type:
    ...
    private static final com.sforce.ws.bind.TypeInfo record__typeInfo = new com.sforce.ws.bind.TypeInfo(
            "urn:partner.soap.sforce.com", "record", "urn:sobject.partner.soap.sforce.com", "sObject", 1, 1, true);
    ...
    protected void loadFields(com.sforce.ws.parser.XmlInputStream __in, com.sforce.ws.bind.TypeMapper __typeMapper)
        ...
        if (__typeMapper.verifyElement(__in, record__typeInfo)) {
            setRecord((com.sforce.soap.partner.sobject.SObject) __typeMapper.readObject(__in, record__typeInfo,
