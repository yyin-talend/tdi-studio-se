...
public class DescribeSoftphoneLayoutCallType implements com.sforce.ws.bind.XMLizable {
    ...
    /**
     * * element : infoFields of type {urn:partner.soap.sforce.com}DescribeSoftphoneLayoutInfoField * java type:
     * com.sforce.soap.partner.DescribeSoftphoneLayoutInfoField[]
     */
    private static final com.sforce.ws.bind.TypeInfo infoFields__typeInfo = new com.sforce.ws.bind.TypeInfo(
            "urn:partner.soap.sforce.com", "infoFields", "urn:partner.soap.sforce.com", "DescribeSoftphoneLayoutInfoField", 1,
            -1, true);
    ...
    /**
     * * element : screenPopOptions of type {urn:partner.soap.sforce.com}DescribeSoftphoneScreenPopOption * java type:
     * com.sforce.soap.partner.DescribeSoftphoneScreenPopOption[]
     */
    private static final com.sforce.ws.bind.TypeInfo screenPopOptions__typeInfo = new com.sforce.ws.bind.TypeInfo(
            "urn:partner.soap.sforce.com", "screenPopOptions", "urn:partner.soap.sforce.com", "DescribeSoftphoneScreenPopOption",
            0, -1, true);
    ...
    private static final com.sforce.ws.bind.TypeInfo screenPopsOpenWithin__typeInfo = new com.sforce.ws.bind.TypeInfo(
            "urn:partner.soap.sforce.com", "screenPopsOpenWithin", "http://www.w3.org/2001/XMLSchema", "string", 0, 1, true);
    ...
    /**
     * * element : sections of type {urn:partner.soap.sforce.com}DescribeSoftphoneLayoutSection * java type:
     * com.sforce.soap.partner.DescribeSoftphoneLayoutSection[]
     */
    private static final com.sforce.ws.bind.TypeInfo sections__typeInfo = new com.sforce.ws.bind.TypeInfo(
            "urn:partner.soap.sforce.com", "sections", "urn:partner.soap.sforce.com", "DescribeSoftphoneLayoutSection", 0, -1,
            true);
    ...
    protected void loadFields(com.sforce.ws.parser.XmlInputStream __in, com.sforce.ws.bind.TypeMapper __typeMapper)
        ...
        if (__typeMapper.verifyElement(__in, infoFields__typeInfo)) {
            setInfoFields((com.sforce.soap.partner.DescribeSoftphoneLayoutInfoField[]) __typeMapper.readObject(__in,
                    infoFields__typeInfo, com.sforce.soap.partner.DescribeSoftphoneLayoutInfoField[].class));
        }
        __in.peekTag();
        ...
        if (__typeMapper.isElement(__in, screenPopOptions__typeInfo)) {
            setScreenPopOptions((com.sforce.soap.partner.DescribeSoftphoneScreenPopOption[]) __typeMapper.readObject(__in,
                    screenPopOptions__typeInfo, com.sforce.soap.partner.DescribeSoftphoneScreenPopOption[].class));
        }
        __in.peekTag();
        if (__typeMapper.isElement(__in, screenPopsOpenWithin__typeInfo)) {
            setScreenPopsOpenWithin((java.lang.String) __typeMapper.readString(__in, screenPopsOpenWithin__typeInfo,
                    java.lang.String.class));
        }
        __in.peekTag();
        if (__typeMapper.isElement(__in, sections__typeInfo)) {
            setSections((com.sforce.soap.partner.DescribeSoftphoneLayoutSection[]) __typeMapper.readObject(__in,
                    sections__typeInfo, com.sforce.soap.partner.DescribeSoftphoneLayoutSection[].class));
        }
    }
