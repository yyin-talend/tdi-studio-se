...
public class DescribeLayoutComponent implements com.sforce.ws.bind.XMLizable {
    ...
    private static final com.sforce.ws.bind.TypeInfo displayLines__typeInfo = new com.sforce.ws.bind.TypeInfo(
            "urn:partner.soap.sforce.com", "displayLines", "http://www.w3.org/2001/XMLSchema", "int", 1, 1, true);
    ...
    private static final com.sforce.ws.bind.TypeInfo tabOrder__typeInfo = new com.sforce.ws.bind.TypeInfo(
            "urn:partner.soap.sforce.com", "tabOrder", "http://www.w3.org/2001/XMLSchema", "int", 1, 1, true);
    ...
    /**
     * * element : type of type {urn:partner.soap.sforce.com}layoutComponentType * java type:
     * com.sforce.soap.partner.LayoutComponentType
     */
    private static final com.sforce.ws.bind.TypeInfo type__typeInfo = new com.sforce.ws.bind.TypeInfo(
            "urn:partner.soap.sforce.com", "type", "urn:partner.soap.sforce.com", "layoutComponentType", 1, 1, true);
    ...
    private static final com.sforce.ws.bind.TypeInfo value__typeInfo = new com.sforce.ws.bind.TypeInfo(
            "urn:partner.soap.sforce.com", "value", "http://www.w3.org/2001/XMLSchema", "string", 1, 1, true);
    ...
    protected void loadFields(com.sforce.ws.parser.XmlInputStream __in, com.sforce.ws.bind.TypeMapper __typeMapper)
        ...
        if (__typeMapper.verifyElement(__in, type__typeInfo)) {
            setType((com.sforce.soap.partner.LayoutComponentType) __typeMapper.readObject(__in, type__typeInfo,
                    com.sforce.soap.partner.LayoutComponentType.class));
        }
        __in.peekTag();
