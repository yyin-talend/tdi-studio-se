...
public class DescribeLayoutResult implements com.sforce.ws.bind.XMLizable {
    ...
    /**
     * * element : layouts of type {urn:partner.soap.sforce.com}DescribeLayout * java type:
     * com.sforce.soap.partner.DescribeLayout[]
     */
    private static final com.sforce.ws.bind.TypeInfo layouts__typeInfo = new com.sforce.ws.bind.TypeInfo(
            "urn:partner.soap.sforce.com", "layouts", "urn:partner.soap.sforce.com", "DescribeLayout", 1, -1, true);
    ...
    /**
     * * element : recordTypeMappings of type {urn:partner.soap.sforce.com}RecordTypeMapping * java type:
     * com.sforce.soap.partner.RecordTypeMapping[]
     */
    private static final com.sforce.ws.bind.TypeInfo recordTypeMappings__typeInfo = new com.sforce.ws.bind.TypeInfo(
            "urn:partner.soap.sforce.com", "recordTypeMappings", "urn:partner.soap.sforce.com", "RecordTypeMapping", 0, -1, true);
    ...
    private static final com.sforce.ws.bind.TypeInfo recordTypeSelectorRequired__typeInfo = new com.sforce.ws.bind.TypeInfo(
            "urn:partner.soap.sforce.com", "recordTypeSelectorRequired", "http://www.w3.org/2001/XMLSchema", "boolean", 1, 1,
            true);
    ...
    protected void writeFields(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper)
        ...
        __typeMapper.writeBoolean(__out, recordTypeSelectorRequired__typeInfo, recordTypeSelectorRequired,
                recordTypeSelectorRequired__is_set);
    }
    ...
    protected void loadFields(com.sforce.ws.parser.XmlInputStream __in, com.sforce.ws.bind.TypeMapper __typeMapper)
        ...
        if (__typeMapper.verifyElement(__in, layouts__typeInfo)) {
            setLayouts((com.sforce.soap.partner.DescribeLayout[]) __typeMapper.readObject(__in, layouts__typeInfo,
                    com.sforce.soap.partner.DescribeLayout[].class));
        }
        __in.peekTag();
        if (__typeMapper.isElement(__in, recordTypeMappings__typeInfo)) {
            setRecordTypeMappings((com.sforce.soap.partner.RecordTypeMapping[]) __typeMapper.readObject(__in,
                    recordTypeMappings__typeInfo, com.sforce.soap.partner.RecordTypeMapping[].class));
        }
        __in.peekTag();
        if (__typeMapper.verifyElement(__in, recordTypeSelectorRequired__typeInfo)) {
            setRecordTypeSelectorRequired((boolean) __typeMapper.readBoolean(__in, recordTypeSelectorRequired__typeInfo,
                    boolean.class));
        }
    }
