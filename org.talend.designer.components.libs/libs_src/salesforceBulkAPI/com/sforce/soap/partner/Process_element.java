...
public class Process_element implements com.sforce.ws.bind.XMLizable {
    ...
    /**
     * * element : actions of type {urn:partner.soap.sforce.com}ProcessRequest * java type:
    ...
    private static final com.sforce.ws.bind.TypeInfo actions__typeInfo = new com.sforce.ws.bind.TypeInfo(
            "urn:partner.soap.sforce.com", "actions", "urn:partner.soap.sforce.com", "ProcessRequest", 0, -1, true);
    ...
    protected void loadFields(com.sforce.ws.parser.XmlInputStream __in, com.sforce.ws.bind.TypeMapper __typeMapper)
        ...
        if (__typeMapper.isElement(__in, actions__typeInfo)) {
            setActions((com.sforce.soap.partner.ProcessRequest[]) __typeMapper.readObject(__in, actions__typeInfo,
