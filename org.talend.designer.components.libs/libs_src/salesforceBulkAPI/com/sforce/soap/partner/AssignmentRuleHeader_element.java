...
public class AssignmentRuleHeader_element extends com.sforce.ws.bind.SoapHeaderObject implements com.sforce.ws.bind.XMLizable {
    ...
    /** * element : assignmentRuleId of type {urn:partner.soap.sforce.com}ID * java type: java.lang.String */
    private static final com.sforce.ws.bind.TypeInfo assignmentRuleId__typeInfo = new com.sforce.ws.bind.TypeInfo(
            "urn:partner.soap.sforce.com", "assignmentRuleId", "urn:partner.soap.sforce.com", "ID", 1, 1, true);
    ...
    /** * element : useDefaultRule of type {http://www.w3.org/2001/XMLSchema}boolean * java type: java.lang.Boolean */
    private static final com.sforce.ws.bind.TypeInfo useDefaultRule__typeInfo = new com.sforce.ws.bind.TypeInfo(
            "urn:partner.soap.sforce.com", "useDefaultRule", "http://www.w3.org/2001/XMLSchema", "boolean", 1, 1, true);
    ...
    protected void loadFields(com.sforce.ws.parser.XmlInputStream __in, com.sforce.ws.bind.TypeMapper __typeMapper)
        ...
        if (__typeMapper.verifyElement(__in, assignmentRuleId__typeInfo)) {
            setAssignmentRuleId((java.lang.String) __typeMapper.readString(__in, assignmentRuleId__typeInfo,
                    java.lang.String.class));
        }
        __in.peekTag();
        if (__typeMapper.verifyElement(__in, useDefaultRule__typeInfo)) {
            setUseDefaultRule((java.lang.Boolean) __typeMapper
                    .readObject(__in, useDefaultRule__typeInfo, java.lang.Boolean.class));
        }
    }
