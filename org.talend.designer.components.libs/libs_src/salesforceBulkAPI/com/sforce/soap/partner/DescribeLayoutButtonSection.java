...
public class DescribeLayoutButtonSection implements com.sforce.ws.bind.XMLizable {
    ...
    /**
     * * element : detailButtons of type {urn:partner.soap.sforce.com}DescribeLayoutButton * java type:
    ...
    private static final com.sforce.ws.bind.TypeInfo detailButtons__typeInfo = new com.sforce.ws.bind.TypeInfo(
            "urn:partner.soap.sforce.com", "detailButtons", "urn:partner.soap.sforce.com", "DescribeLayoutButton", 1, -1, true);
    ...
    protected void loadFields(com.sforce.ws.parser.XmlInputStream __in, com.sforce.ws.bind.TypeMapper __typeMapper)
        ...
        if (__typeMapper.verifyElement(__in, detailButtons__typeInfo)) {
            setDetailButtons((com.sforce.soap.partner.DescribeLayoutButton[]) __typeMapper.readObject(__in,
                    detailButtons__typeInfo, com.sforce.soap.partner.DescribeLayoutButton[].class));
        }
    }
