...
public class SendEmailResult implements com.sforce.ws.bind.XMLizable {
    ...
    /**
     * * element : errors of type {urn:partner.soap.sforce.com}SendEmailError * java type:
    ...
    private static final com.sforce.ws.bind.TypeInfo errors__typeInfo = new com.sforce.ws.bind.TypeInfo(
            "urn:partner.soap.sforce.com", "errors", "urn:partner.soap.sforce.com", "SendEmailError", 0, -1, true);
    ...
    protected void loadFields(com.sforce.ws.parser.XmlInputStream __in, com.sforce.ws.bind.TypeMapper __typeMapper)
        ...
        if (__typeMapper.isElement(__in, errors__typeInfo)) {
            setErrors((com.sforce.soap.partner.SendEmailError[]) __typeMapper.readObject(__in, errors__typeInfo,
