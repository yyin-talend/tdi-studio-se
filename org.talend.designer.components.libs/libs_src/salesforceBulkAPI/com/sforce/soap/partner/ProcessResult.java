...
public class ProcessResult implements com.sforce.ws.bind.XMLizable {
    ...
    private static final com.sforce.ws.bind.TypeInfo actorIds__typeInfo = new com.sforce.ws.bind.TypeInfo(
            "urn:partner.soap.sforce.com", "actorIds", "urn:partner.soap.sforce.com", "ID", 0, -1, true);
    ...
    private static final com.sforce.ws.bind.TypeInfo entityId__typeInfo = new com.sforce.ws.bind.TypeInfo(
            "urn:partner.soap.sforce.com", "entityId", "urn:partner.soap.sforce.com", "ID", 1, 1, true);
    ...
    private static final com.sforce.ws.bind.TypeInfo instanceId__typeInfo = new com.sforce.ws.bind.TypeInfo(
            "urn:partner.soap.sforce.com", "instanceId", "urn:partner.soap.sforce.com", "ID", 1, 1, true);
    ...
    private static final com.sforce.ws.bind.TypeInfo instanceStatus__typeInfo = new com.sforce.ws.bind.TypeInfo(
            "urn:partner.soap.sforce.com", "instanceStatus", "http://www.w3.org/2001/XMLSchema", "string", 1, 1, true);
    ...
    private static final com.sforce.ws.bind.TypeInfo newWorkitemIds__typeInfo = new com.sforce.ws.bind.TypeInfo(
            "urn:partner.soap.sforce.com", "newWorkitemIds", "urn:partner.soap.sforce.com", "ID", 0, -1, true);
