...
public class DescribeLayoutRow implements com.sforce.ws.bind.XMLizable {
    ...
    /**
     * * element : layoutItems of type {urn:partner.soap.sforce.com}DescribeLayoutItem * java type:
    ...
    private static final com.sforce.ws.bind.TypeInfo layoutItems__typeInfo = new com.sforce.ws.bind.TypeInfo(
            "urn:partner.soap.sforce.com", "layoutItems", "urn:partner.soap.sforce.com", "DescribeLayoutItem", 1, -1, true);
    ...
    private static final com.sforce.ws.bind.TypeInfo numItems__typeInfo = new com.sforce.ws.bind.TypeInfo(
            "urn:partner.soap.sforce.com", "numItems", "http://www.w3.org/2001/XMLSchema", "int", 1, 1, true);
    ...
    protected void loadFields(com.sforce.ws.parser.XmlInputStream __in, com.sforce.ws.bind.TypeMapper __typeMapper)
        ...
        if (__typeMapper.verifyElement(__in, layoutItems__typeInfo)) {
            setLayoutItems((com.sforce.soap.partner.DescribeLayoutItem[]) __typeMapper.readObject(__in, layoutItems__typeInfo,
