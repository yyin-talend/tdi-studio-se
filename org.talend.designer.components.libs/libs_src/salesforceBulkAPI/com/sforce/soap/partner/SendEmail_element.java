...
public class SendEmail_element implements com.sforce.ws.bind.XMLizable {
    ...
    private static final com.sforce.ws.bind.TypeInfo messages__typeInfo = new com.sforce.ws.bind.TypeInfo(
            "urn:partner.soap.sforce.com", "messages", "urn:partner.soap.sforce.com", "Email", 0, 10, true);
    ...
    protected void loadFields(com.sforce.ws.parser.XmlInputStream __in, com.sforce.ws.bind.TypeMapper __typeMapper)
        ...
        if (__typeMapper.isElement(__in, messages__typeInfo)) {
            setMessages((com.sforce.soap.partner.Email[]) __typeMapper.readObject(__in, messages__typeInfo,
