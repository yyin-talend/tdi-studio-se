...
public class InvalidateSessions_element implements com.sforce.ws.bind.XMLizable {
    ...
    private static final com.sforce.ws.bind.TypeInfo sessionIds__typeInfo = new com.sforce.ws.bind.TypeInfo(
            "urn:partner.soap.sforce.com", "sessionIds", "http://www.w3.org/2001/XMLSchema", "string", 0, -1, true);
