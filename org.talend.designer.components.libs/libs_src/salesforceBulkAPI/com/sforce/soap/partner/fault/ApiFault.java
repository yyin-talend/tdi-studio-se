...
public class ApiFault extends com.sforce.ws.SoapFaultException implements com.sforce.ws.bind.XMLizable {
    ...
    /**
     * * element : exceptionCode of type {urn:fault.partner.soap.sforce.com}ExceptionCode * java type:
     * com.sforce.soap.partner.fault.ExceptionCode
     */
    private static final com.sforce.ws.bind.TypeInfo exceptionCode__typeInfo = new com.sforce.ws.bind.TypeInfo(
            "urn:fault.partner.soap.sforce.com", "exceptionCode", "urn:fault.partner.soap.sforce.com", "ExceptionCode", 1, 1,
            true);
    ...
    private static final com.sforce.ws.bind.TypeInfo exceptionMessage__typeInfo = new com.sforce.ws.bind.TypeInfo(
            "urn:fault.partner.soap.sforce.com", "exceptionMessage", "http://www.w3.org/2001/XMLSchema", "string", 1, 1, true);
    ...
    protected void loadFields(com.sforce.ws.parser.XmlInputStream __in, com.sforce.ws.bind.TypeMapper __typeMapper)
        ...
        if (__typeMapper.verifyElement(__in, exceptionCode__typeInfo)) {
            setExceptionCode((com.sforce.soap.partner.fault.ExceptionCode) __typeMapper.readObject(__in, exceptionCode__typeInfo,
                    com.sforce.soap.partner.fault.ExceptionCode.class));
        }
        __in.peekTag();
        if (__typeMapper.verifyElement(__in, exceptionMessage__typeInfo)) {
            setExceptionMessage((java.lang.String) __typeMapper.readString(__in, exceptionMessage__typeInfo,
