...
public class Merge_element implements com.sforce.ws.bind.XMLizable {
    ...
    /**
     * * element : request of type {urn:partner.soap.sforce.com}MergeRequest * java type:
     * com.sforce.soap.partner.MergeRequest[]
     */
    private static final com.sforce.ws.bind.TypeInfo request__typeInfo = new com.sforce.ws.bind.TypeInfo(
            "urn:partner.soap.sforce.com", "request", "urn:partner.soap.sforce.com", "MergeRequest", 0, -1, true);
    ...
    protected void loadFields(com.sforce.ws.parser.XmlInputStream __in, com.sforce.ws.bind.TypeMapper __typeMapper)
        ...
        if (__typeMapper.isElement(__in, request__typeInfo)) {
            setRequest((com.sforce.soap.partner.MergeRequest[]) __typeMapper.readObject(__in, request__typeInfo,
