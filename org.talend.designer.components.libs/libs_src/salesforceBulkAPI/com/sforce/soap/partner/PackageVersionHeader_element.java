...
public class PackageVersionHeader_element extends com.sforce.ws.bind.SoapHeaderObject implements com.sforce.ws.bind.XMLizable {
    ...
    /**
     * * element : packageVersions of type {urn:partner.soap.sforce.com}PackageVersion * java type:
    ...
    private static final com.sforce.ws.bind.TypeInfo packageVersions__typeInfo = new com.sforce.ws.bind.TypeInfo(
            "urn:partner.soap.sforce.com", "packageVersions", "urn:partner.soap.sforce.com", "PackageVersion", 0, -1, true);
    ...
    protected void loadFields(com.sforce.ws.parser.XmlInputStream __in, com.sforce.ws.bind.TypeMapper __typeMapper)
        ...
        if (__typeMapper.isElement(__in, packageVersions__typeInfo)) {
            setPackageVersions((com.sforce.soap.partner.PackageVersion[]) __typeMapper.readObject(__in,
                    packageVersions__typeInfo, com.sforce.soap.partner.PackageVersion[].class));
        }
    }
