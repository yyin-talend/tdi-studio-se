...
public class DeleteResponse_element implements com.sforce.ws.bind.XMLizable {
    ...
    /**
     * * element : result of type {urn:partner.soap.sforce.com}DeleteResult * java type:
    ...
    private static final com.sforce.ws.bind.TypeInfo result__typeInfo = new com.sforce.ws.bind.TypeInfo(
            "urn:partner.soap.sforce.com", "result", "urn:partner.soap.sforce.com", "DeleteResult", 0, -1, true);
    ...
    protected void loadFields(com.sforce.ws.parser.XmlInputStream __in, com.sforce.ws.bind.TypeMapper __typeMapper)
        ...
        if (__typeMapper.isElement(__in, result__typeInfo)) {
            setResult((com.sforce.soap.partner.DeleteResult[]) __typeMapper.readObject(__in, result__typeInfo,
