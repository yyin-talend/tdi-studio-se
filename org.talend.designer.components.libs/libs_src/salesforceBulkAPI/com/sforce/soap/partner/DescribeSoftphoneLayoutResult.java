...
public class DescribeSoftphoneLayoutResult implements com.sforce.ws.bind.XMLizable {
    ...
    /**
     * * element : callTypes of type {urn:partner.soap.sforce.com}DescribeSoftphoneLayoutCallType * java type:
    ...
    private static final com.sforce.ws.bind.TypeInfo callTypes__typeInfo = new com.sforce.ws.bind.TypeInfo(
            "urn:partner.soap.sforce.com", "callTypes", "urn:partner.soap.sforce.com", "DescribeSoftphoneLayoutCallType", 1, -1,
            true);
    ...
    protected void loadFields(com.sforce.ws.parser.XmlInputStream __in, com.sforce.ws.bind.TypeMapper __typeMapper)
        ...
        if (__typeMapper.verifyElement(__in, callTypes__typeInfo)) {
            setCallTypes((com.sforce.soap.partner.DescribeSoftphoneLayoutCallType[]) __typeMapper.readObject(__in,
                    callTypes__typeInfo, com.sforce.soap.partner.DescribeSoftphoneLayoutCallType[].class));
        }
        __in.peekTag();
