...
public class DescribeLayoutSection implements com.sforce.ws.bind.XMLizable {
    ...
    private static final com.sforce.ws.bind.TypeInfo columns__typeInfo = new com.sforce.ws.bind.TypeInfo(
            "urn:partner.soap.sforce.com", "columns", "http://www.w3.org/2001/XMLSchema", "int", 1, 1, true);
    ...
    private static final com.sforce.ws.bind.TypeInfo heading__typeInfo = new com.sforce.ws.bind.TypeInfo(
            "urn:partner.soap.sforce.com", "heading", "http://www.w3.org/2001/XMLSchema", "string", 1, 1, true);
    ...
    /**
     * * element : layoutRows of type {urn:partner.soap.sforce.com}DescribeLayoutRow * java type:
    ...
    private static final com.sforce.ws.bind.TypeInfo layoutRows__typeInfo = new com.sforce.ws.bind.TypeInfo(
            "urn:partner.soap.sforce.com", "layoutRows", "urn:partner.soap.sforce.com", "DescribeLayoutRow", 1, -1, true);
    ...
    private static final com.sforce.ws.bind.TypeInfo rows__typeInfo = new com.sforce.ws.bind.TypeInfo(
            "urn:partner.soap.sforce.com", "rows", "http://www.w3.org/2001/XMLSchema", "int", 1, 1, true);
    ...
    private static final com.sforce.ws.bind.TypeInfo useCollapsibleSection__typeInfo = new com.sforce.ws.bind.TypeInfo(
            "urn:partner.soap.sforce.com", "useCollapsibleSection", "http://www.w3.org/2001/XMLSchema", "boolean", 1, 1, true);
    ...
    private static final com.sforce.ws.bind.TypeInfo useHeading__typeInfo = new com.sforce.ws.bind.TypeInfo(
            "urn:partner.soap.sforce.com", "useHeading", "http://www.w3.org/2001/XMLSchema", "boolean", 1, 1, true);
    ...
    protected void loadFields(com.sforce.ws.parser.XmlInputStream __in, com.sforce.ws.bind.TypeMapper __typeMapper)
        ...
        if (__typeMapper.verifyElement(__in, layoutRows__typeInfo)) {
            setLayoutRows((com.sforce.soap.partner.DescribeLayoutRow[]) __typeMapper.readObject(__in, layoutRows__typeInfo,
