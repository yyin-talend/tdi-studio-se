...
public class CallOptions_element extends com.sforce.ws.bind.SoapHeaderObject implements com.sforce.ws.bind.XMLizable {
    ...
    private static final com.sforce.ws.bind.TypeInfo client__typeInfo = new com.sforce.ws.bind.TypeInfo(
            "urn:partner.soap.sforce.com", "client", "http://www.w3.org/2001/XMLSchema", "string", 1, 1, true);
    ...
    private static final com.sforce.ws.bind.TypeInfo defaultNamespace__typeInfo = new com.sforce.ws.bind.TypeInfo(
            "urn:partner.soap.sforce.com", "defaultNamespace", "http://www.w3.org/2001/XMLSchema", "string", 1, 1, true);
    ...
    protected void loadFields(com.sforce.ws.parser.XmlInputStream __in, com.sforce.ws.bind.TypeMapper __typeMapper)
        ...
        if (__typeMapper.verifyElement(__in, defaultNamespace__typeInfo)) {
            setDefaultNamespace((java.lang.String) __typeMapper.readString(__in, defaultNamespace__typeInfo,
