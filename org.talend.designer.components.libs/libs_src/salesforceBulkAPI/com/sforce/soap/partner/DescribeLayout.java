...
public class DescribeLayout implements com.sforce.ws.bind.XMLizable {
    ...
    /**
     * * element : buttonLayoutSection of type {urn:partner.soap.sforce.com}DescribeLayoutButtonSection * java type:
     * com.sforce.soap.partner.DescribeLayoutButtonSection
     */
    private static final com.sforce.ws.bind.TypeInfo buttonLayoutSection__typeInfo = new com.sforce.ws.bind.TypeInfo(
            "urn:partner.soap.sforce.com", "buttonLayoutSection", "urn:partner.soap.sforce.com", "DescribeLayoutButtonSection",
            0, 1, true);
    ...
    /**
     * * element : detailLayoutSections of type {urn:partner.soap.sforce.com}DescribeLayoutSection * java type:
     * com.sforce.soap.partner.DescribeLayoutSection[]
     */
    private static final com.sforce.ws.bind.TypeInfo detailLayoutSections__typeInfo = new com.sforce.ws.bind.TypeInfo(
            "urn:partner.soap.sforce.com", "detailLayoutSections", "urn:partner.soap.sforce.com", "DescribeLayoutSection", 0, -1,
            true);
    ...
    /**
     * * element : editLayoutSections of type {urn:partner.soap.sforce.com}DescribeLayoutSection * java type:
     * com.sforce.soap.partner.DescribeLayoutSection[]
     */
    private static final com.sforce.ws.bind.TypeInfo editLayoutSections__typeInfo = new com.sforce.ws.bind.TypeInfo(
            "urn:partner.soap.sforce.com", "editLayoutSections", "urn:partner.soap.sforce.com", "DescribeLayoutSection", 0, -1,
            true);
    ...
    /**
     * * element : relatedLists of type {urn:partner.soap.sforce.com}RelatedList * java type:
     * com.sforce.soap.partner.RelatedList[]
     */
    private static final com.sforce.ws.bind.TypeInfo relatedLists__typeInfo = new com.sforce.ws.bind.TypeInfo(
            "urn:partner.soap.sforce.com", "relatedLists", "urn:partner.soap.sforce.com", "RelatedList", 0, -1, true);
    ...
    protected void loadFields(com.sforce.ws.parser.XmlInputStream __in, com.sforce.ws.bind.TypeMapper __typeMapper)
        ...
        if (__typeMapper.isElement(__in, buttonLayoutSection__typeInfo)) {
            setButtonLayoutSection((com.sforce.soap.partner.DescribeLayoutButtonSection) __typeMapper.readObject(__in,
                    buttonLayoutSection__typeInfo, com.sforce.soap.partner.DescribeLayoutButtonSection.class));
        }
        __in.peekTag();
        if (__typeMapper.isElement(__in, detailLayoutSections__typeInfo)) {
            setDetailLayoutSections((com.sforce.soap.partner.DescribeLayoutSection[]) __typeMapper.readObject(__in,
                    detailLayoutSections__typeInfo, com.sforce.soap.partner.DescribeLayoutSection[].class));
        }
        __in.peekTag();
        if (__typeMapper.isElement(__in, editLayoutSections__typeInfo)) {
            setEditLayoutSections((com.sforce.soap.partner.DescribeLayoutSection[]) __typeMapper.readObject(__in,
                    editLayoutSections__typeInfo, com.sforce.soap.partner.DescribeLayoutSection[].class));
        }
        __in.peekTag();
        ...
        if (__typeMapper.isElement(__in, relatedLists__typeInfo)) {
            setRelatedLists((com.sforce.soap.partner.RelatedList[]) __typeMapper.readObject(__in, relatedLists__typeInfo,
