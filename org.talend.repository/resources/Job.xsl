		...
		<html>
			...
			<body>
				...
				<table border="0" cellspacing="0" rowspacing="0" width="90%" class="FONTSTYLE">
					<tr valign="top">
						...
						<td width="26%" rowspan="2" align="middle">
							<a href="#{project/@link}">
								<img src="{project/@logo}" border="0" align="absbottom"/>
							</a>
						</td>
				...
				<DIV class="FONTSTYLE">
					<B>
						<A href="#JobPreviewPicture">Job Preview Picture</A>
					</B>
				</DIV>
				<DIV class="FONTSTYLE">
					<B>
				...
				<DIV class="FONTSTYLE">
					<B>
						<A href="#ComponentsDescription">Components Description</A>
					</B>
				</DIV>
				<br/>
				<br/>
				...
				<!--HR-->
				<H2 class="FONTSTYLE">
					<A id="ProjectDescription" name="#ProjectDescription">Project Description</A>
				</H2>
				<br/>
				<TABLE border="1" width="90%" class="FONTSTYLE" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111">
					...
					<TR>
						...
						<TD class="FONTSTYLE" align="left">&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;<xsl:value-of select="/project/@name"/>
						</TD>
					</TR>
					<TR>
						<TD class="FONTSTYLE" align="middle">Language</TD>
						<TD class="FONTSTYLE" align="left">&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;<xsl:value-of select="/project/@language"/>
						</TD>
					</TR>
					<TR>
						<TD class="FONTSTYLE" align="middle">Description</TD>
						<TD class="FONTSTYLE" align="left">&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;<xsl:value-of select="/project/@description"/>
						</TD>
					</TR>
				</TABLE>
				<br/>
				...
				<H2 class="FONTSTYLE">
					<A id="JobDescription" name="#JobDescription">Job Description</A>
				</H2>
				<br/>
				<TABLE class="cols" border="1" width="90%" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" frame="box">
					...
					<TR>
						<TD class="FONTSTYLE" align="middle">Name</TD>
						<TD class="FONTSTYLE" align="left">&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;<xsl:value-of select="$job/@name"/>
						</TD>
					</TR>
					<TR>
						<TD class="FONTSTYLE" align="middle">Author</TD>
						<TD class="FONTSTYLE" align="left">&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;<xsl:value-of select="$job/@author"/>
						</TD>
					</TR>
					<TR>
						<TD class="FONTSTYLE" align="middle">Version</TD>
						<TD class="FONTSTYLE" align="left">&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;<xsl:value-of select="$job/@version"/>
						</TD>
					</TR>
					<TR>
						<TD class="FONTSTYLE" align="middle">Purpose</TD>
						<TD class="FONTSTYLE" align="left">&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;<xsl:value-of select="$job/@purpose"/>
						</TD>
					</TR>
					<TR>
						<TD class="FONTSTYLE" align="middle">Status</TD>
						<TD class="FONTSTYLE" align="left">&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;<xsl:value-of select="$job/@status"/>
						</TD>
					</TR>
					<TR>
						<TD class="FONTSTYLE" align="middle">Description</TD>
						<TD class="FONTSTYLE" align="left">&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;<xsl:value-of select="$job/@description"/>
						</TD>
					</TR>
					<TR>
						<TD class="FONTSTYLE" align="middle">Creation</TD>
						<TD class="FONTSTYLE" align="left">&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;<xsl:value-of select="$job/@creation"/>
						</TD>
					</TR>
					<TR>
						<TD class="FONTSTYLE" align="middle">Modification</TD>
						<TD class="FONTSTYLE" align="left">&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;<xsl:value-of select="$job/@modification"/>
						</TD>
					</TR>
				</TABLE>
				<br/>
				...
				<xsl:if test="string-length($jobPreviewPicture)!=0">
					<H2 class="FONTSTYLE">
						<A id="JobPreviewPicture" name="#JobPreviewPicture">Job Preview Picture</A>
					</H2>
					<br/>
					<div class="FONTSTYLE" align="center">
						<img src="{$jobPreviewPicture}" usemap="#jobmap" alt="No image available" class="bordercolor"/>
					</div>
				</xsl:if>
				<br/>
				<br/>
				...
				<!--HR-->
				<H2 class="FONTSTYLE">
					<A id="ComponentList" name="#ComponentList">Component List</A>
				</H2>
				<TABLE border="1" width="90%" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" frame="box">
					...
					<map id="jobmap" name="jobmap">
						<xsl:for-each select="$job/componentList/componentItem">
							<area shape="rect" coords="{@leftTopX},{@leftTopY},{@rightBottomX},{@rightBottomY}" href="#{@link}" alt="{@name}"/>
						</xsl:for-each>
					</map>
					<xsl:for-each select="$job/componentList/componentItem">
						<TR>
				...
				<!--HR-->
				<H2 class="FONTSTYLE">
					<A id="ComponentsDescription" name="#ComponentsDescription">Components Description</A>
				</H2>
				<xsl:for-each select="$job/internalNodeComponents/component">
					<A name="{@uniqueName}"/>
					<TABLE border="0" width="90%" class="FONTSTYLE" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111">
						<br/>
						<br/>
						<TR bgcolor="#E6E6E6">
							<B class="FONTSTYLE">Component:&#160;&#160;<xsl:value-of select="componentType"/>
							</B>
						</TR>
					</TABLE>
					<BR/>
					<TABLE border="1" width="90%" class="FONTSTYLE" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111">
						<TR>
							<td class="cols" align="center" rowspan="2" width="10%">
								<img src="{@icon}"/>&#160;&#160;&#160;&#160;&#160;</td>
	      ...
	      OUTPUT(S)
					...
					<xsl:if test="string-length($previewPicture)!=0">
						<br/>
						<div class="FONTSTYLE">
							<img src="{$previewPicture}" usemap="#jobmap" alt="No image available" class="bordercolor"/>
						</div>
					</xsl:if>
					<br/>
					...
					<TABLE width="90%" class="FONTSTYLE" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" frame="box">
						...
						<xsl:for-each select="parameters/column">
							<TR>
								...
								<TD class="FONTSTYLE" align="left">&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;<xsl:value-of select="text()"/>
								</TD>
							</TR>
						</xsl:for-each>
					</TABLE>
					...
					<xsl:for-each select="schemas/schema">
						<b class="FONTSTYLE">Schema for <xsl:value-of select="@name"/>:</b>
						<br/>
				...
				<xsl:for-each select="$job/externalNodeComponents/component">
					<A name="{@uniqueName}"/>
					<TABLE border="0" width="90%" class="FONTSTYLE" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111">
						<br/>
						<br/>
