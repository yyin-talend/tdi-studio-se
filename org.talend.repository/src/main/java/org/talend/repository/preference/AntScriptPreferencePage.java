 ...
 */
public class AntScriptPreferencePage extends FieldEditorPreferencePage implements IWorkbenchPreferencePage {

    public AntScriptPreferencePage() {
        super(FLAT);
    ...
    protected Control createContents(Composite p) {
        ...
        scriptTxt.setText(getPreferenceStore().getString(IRepositoryPrefConstants.ANT_SCRIPT_TEMPLATE));

        scriptTxt.addModifyListener(new ModifyListener() {

            public void modifyText(ModifyEvent e) {
                getPreferenceStore().setValue(IRepositoryPrefConstants.ANT_SCRIPT_TEMPLATE,
