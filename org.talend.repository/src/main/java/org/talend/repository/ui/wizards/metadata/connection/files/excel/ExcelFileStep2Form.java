 ...
 */
public class ExcelFileStep2Form extends AbstractExcelFileStepForm {
     ...
     * @param Composite
     */
    public ExcelFileStep2Form(Composite parent, ConnectionItem connectionItem, MetadataTable metadataTable, String[] existingNames) {
