...
public class RegexpFileStep3Form extends AbstractRegexpFileStepForm {
	 ...
	 * @param Composite
	 */
	public RegexpFileStep3Form(Composite parent, ConnectionItem connectionItem,
	...
	private ProcessDescription getProcessDescription(
			RegexpFileConnection originalValueConnection) {
	...
	private RegexpFileConnection getOriginalValueConnection() {
		if (getConnection().isContextMode() && getContextModeManager() != null) {
			return (RegexpFileConnection) FileConnectionContextUtils
