 ...
 */
public class ShowInstalledExtensionsJob extends Job {
    ...
    public ShowInstalledExtensionsJob() {
        super(Messages.getString("ShowInstalledExtensionsJob.ShowInstalledExtensions.Title")); //$NON-NLS-1$
    }
    ...
    protected IStatus run(IProgressMonitor monitor) {
        monitor.beginTask(Messages.getString("ShowInstalledExtensionsJob.ShowInstalledExtensions.Message"),
    ...
    public List<ComponentExtension> getfInstalledExtensions() {
        return this.fInstalledExtensions;
    }
