...
public class ExchangeWebService {
     ...
     * @return
     */
    public static JSONArray searchCategoryExtensionJSONArray(String typeExtension) {
        ...
        try {
            ...
            resultArry = p.getJSONArray("category");
     ...
     * @return
     */
    public static JSONArray searchVersionRevisionJSONArray(String typeExtension) {
        JSONArray resultArry = new JSONArray();
        JSONObject tokenMessage = new JSONObject();
        try {
            tokenMessage.put("typeExtension", typeExtension);
            ...
            resultArry = p.getJSONArray("version");
