...
public class ProcessComposite extends Composite {
	...
	private void initGraphicComponents(Composite parent) {
		...
		debugBtn.setImage(RunProcessPlugin.imageDescriptorFromPlugin(
				RunProcessPlugin.PLUGIN_ID, "icons/process_debug.gif") //$NON-NLS-1$
				.createImage());
		...
		clearTracePerfBtn.setImage(RunProcessPlugin
				.imageDescriptorFromPlugin(RunProcessPlugin.PLUGIN_ID,
