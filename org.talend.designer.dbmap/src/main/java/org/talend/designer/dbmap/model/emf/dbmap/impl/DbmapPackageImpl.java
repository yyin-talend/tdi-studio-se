...
public class DbmapPackageImpl extends EPackageImpl implements DbmapPackage {
    ...
    public static DbmapPackage init() {
        ...
        DbmapPackageImpl theDbmapPackage = (DbmapPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof DbmapPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new DbmapPackageImpl());
