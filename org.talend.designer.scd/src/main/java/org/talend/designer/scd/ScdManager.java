...
public class ScdManager {
        ...
        if (metadataList != null) {
            for (IMetadataTable table : metadataList) {
                ...
                for (int i = columns.size() - 1; i >= 0; i--) {
                    ...
                    if (unusedFields.contains(col.getLabel()) || col.getComment().equals(GENERATE_COLUMN)) {
    ...
    public void createOutputSchema(List<String> unusedFields) {
        ...
        // on TYPE 3 columns, every "previous value" must create an output column with the same attribute as the
        ...
        // removeVersionFieldsFromOutput(outputColumns, schema, new String[] { versionData.getStartName(),
        // versionData.getEndName(),
        // versionData.getVersionName(), versionData.getActiveName() });
        // for versionning columns {start, end} are datetime data type, version is an integer, active is a
        // boolean
