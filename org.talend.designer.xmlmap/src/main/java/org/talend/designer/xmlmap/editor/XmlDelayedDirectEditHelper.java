...
public class XmlDelayedDirectEditHelper implements Runnable {
    ...
    private static XmlDelayedDirectEditHelper activeHelper;
     ...
     */
    public XmlDelayedDirectEditHelper(EditPartViewer viewer, Request request, EditPart receiver) {
        this.req = request;
        this.viewer = viewer;
        this.part = receiver;
