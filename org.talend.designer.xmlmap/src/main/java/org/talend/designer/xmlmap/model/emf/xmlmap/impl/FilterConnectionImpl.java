...
public class FilterConnectionImpl extends EObjectImpl implements FilterConnection {
        ...
        if (source != null && source.eIsProxy()) {
            ...
            if (source != oldSource) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, XmlmapPackage.FILTER_CONNECTION__SOURCE, oldSource,
                            source));
            }
        }
        return source;
    ...
    public AbstractInOutTree getTarget() {
        if (target != null && target.eIsProxy()) {
            ...
            if (target != oldTarget) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, XmlmapPackage.FILTER_CONNECTION__TARGET, oldTarget,
                            target));
            }
        }
        return target;
