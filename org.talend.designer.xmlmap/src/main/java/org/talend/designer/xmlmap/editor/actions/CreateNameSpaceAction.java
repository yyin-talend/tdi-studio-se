...
public class CreateNameSpaceAction extends SelectionAction {
    ...
    public void run() {
        ...
        while (!isValidPrefix(prefix) || !StringUtil.validateLabelForNameSpace(prefix)
                || !StringUtil.validateLabelForFixedValue(defaultValue)) {
    ...
    private boolean isValidPrefix(String prefix) {
        ...
        String xpath = XmlMapUtil.getXPath(parent.getXpath(), prefix, NodeType.NAME_SPACE);
