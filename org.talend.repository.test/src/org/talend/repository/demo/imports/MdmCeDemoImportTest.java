...
public class MdmCeDemoImportTest extends DemosImportTest {
    ...
    public void importMdmDemo() throws Exception {
        ...
        // List<ImportItem> projectRecords = importManager.populateImportingItems(mdmResCeManager, true, new
        // NullProgressMonitor());
        // Assert.assertTrue(projectRecords.size() > 0);
        // importManager.importItemRecords(new NullProgressMonitor(), mdmResCeManager, projectRecords, true,
