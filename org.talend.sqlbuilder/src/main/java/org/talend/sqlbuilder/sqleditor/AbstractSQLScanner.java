...
/**
 * Detailled comment for this class. <br/> $Id: AbstractSQLScanner.java,v 1.2
 * 2006/10/31 09:54:18 peiqin.hou Exp $
 * 
 */
...
public abstract class AbstractSQLScanner extends BufferedRuleBasedScanner {
	 ...
	 */
	public AbstractSQLScanner(final IColorManager manager,
	...
	private void adaptToColorChange(final Token token,
	...
	private void adaptToStyleChange(final Token token,
			final PropertyChangeEvent event) {
		boolean bold = false;
		final Object value = event.getNewValue();
