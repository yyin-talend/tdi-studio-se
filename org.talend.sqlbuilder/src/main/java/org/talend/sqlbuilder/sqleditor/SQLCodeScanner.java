...
public class SQLCodeScanner extends AbstractSQLScanner {
	...
	static String[] fgTokenProperties = { IConstants.SQL_TABLE,
			IConstants.SQL_COLUMS, IConstants.SQL_KEYWORD,
	 ...
	 */
	public SQLCodeScanner(IColorManager manager, IPreferenceStore store,
	...
	protected synchronized List createRules() {
		...
		rules.add(new WhitespaceRule(
				new org.talend.sqlbuilder.sqleditor.SQLWhitespaceDetector()));
		...
		UnsignedWordRule wordRule = new UnsignedWordRule(new SQLWordDetector(),
