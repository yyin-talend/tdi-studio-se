...
public class StatsAndLogsConstants {
    ...
    public static final String[] MYSQL_VERSION_DRIVER = new String[] {
            "mysql-connector-java-5.1.22-bin.jar", "mysql-connector-java-3.1.14-bin.jar" };//$NON-NLS-1$ //$NON-NLS-N$
    ...
    public static final String[] DB_VERSION_DRIVER = new String[] {
            "ojdbc6-11g.jar", "ojdbc14-10g.jar", "ojdbc14-9i.jar", "ojdbc12-8i.jar", "mysql-connector-java-5.1.22-bin.jar", "mysql-connector-java-3.1.14-bin.jar", "ACCESS_2003", "ACCESS_2007" };//$NON-NLS-N$  //$NON-NLS-N$ //$NON-NLS-N$  //$NON-NLS-N$ //$NON-NLS-N$  //$NON-NLS-N$ //$NON-NLS-N$  //$NON-NLS-N$  
