...
public class ProjectSettingManager extends Utils {
    ...
    private static void createExtraOnDBParameters(Element elem) {
        ...
        if (LanguageManager.getCurrentLanguage().equals(ECodeLanguage.JAVA)) {
            ...
            dbCon = dbTypeName + " == 'MSSQL'" + " or " + dbTypeName + " == 'MYSQL'" + " or " + dbTypeName //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
                    + " == 'INFORMIX'"; //$NON-NLS-1$
        ...
        final String schemaCondition = JobSettingsConstants
                .addBrackets(dbTypeName
                        + " =='OCLE' or " + dbTypeName + " =='OCLE_OCI' or " + dbTypeName + " =='POSTGRESQL' or " + dbTypeName + " =='MSSQL'"); //$NON-NLS-1$//$NON-NLS-2$//$NON-NLS-3$//$NON-NLS-4$
