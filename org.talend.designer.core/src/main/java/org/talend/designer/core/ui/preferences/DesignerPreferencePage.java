...
public class DesignerPreferencePage extends FieldEditorPreferencePage implements IWorkbenchPreferencePage {
    ...
    public void createFieldEditors() {
        ...
        BooleanFieldEditor displayMethodSize = new BooleanFieldEditor(TalendDesignerPrefConstants.DISPLAY_METHOD_SIZE,
                "Compute byte length of source codes generated by components", getFieldEditorParent());
        addField(displayMethodSize);

        createSubjobFieldEditors(getFieldEditorParent());
    }
    ...
    private void createSubjobFieldEditors(Composite parent) {
        ...
        addField(new ColorFieldEditor(ColorUtils.SUBJOB_TITLE_COLOR_NAME, Messages
                .getString("DesignerPreferencePage.SubjobTitleColorLabel"), subjobGroup)); //$NON-NLS-1$

        addField(new ColorFieldEditor(ColorUtils.SUBJOB_COLOR_NAME,
