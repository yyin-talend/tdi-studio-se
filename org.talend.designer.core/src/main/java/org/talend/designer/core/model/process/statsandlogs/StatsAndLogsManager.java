...
public class StatsAndLogsManager {
    ...
    private static void statsAndLogsParametersDBPart(IProcess process) {
        ...
        param
                .setShowIf("(DB_TYPE=='OCLE' or DB_TYPE=='POSTGRESQL' or DB_TYPE=='OCLE_OCI' or DB_TYPE=='MSSQL') and (ON_DATABASE_FLAG == 'true') and (ON_STATCATCHER_FLAG == 'true' or ON_LOGCATCHER_FLAG == 'true' or ON_METERCATCHER_FLAG == 'true')"); //$NON-NLS-1$
        paramList.add(param);
