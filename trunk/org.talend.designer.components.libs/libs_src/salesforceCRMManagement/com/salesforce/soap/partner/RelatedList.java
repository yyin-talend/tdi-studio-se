        ...
        if (localColumns != null) {
            for (int i = 0; i < localColumns.length; i++) {
                if (localColumns[i] != null) {
                    localColumns[i].serialize(new javax.xml.namespace.QName("urn:partner.soap.sforce.com", "columns"), factory,
                            xmlWriter);
                } else {
        ...
        if (localSortTracker) {
            if (localSort != null) {
                for (int i = 0; i < localSort.length; i++) {
                    if (localSort[i] != null) {
                        localSort[i].serialize(new javax.xml.namespace.QName("urn:partner.soap.sforce.com", "sort"), factory,
                                xmlWriter);
                    } else {
