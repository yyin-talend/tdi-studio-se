...
public class Process implements org.apache.axis2.databinding.ADBBean {
    ...
    protected com.salesforce.soap.partner.ProcessRequest[] localActions;
     ...
     * 
     * @return com.salesforce.soap.partner.ProcessRequest[]
     */
    public com.salesforce.soap.partner.ProcessRequest[] getActions() {
        return localActions;
    }
     ...
     */
    protected void validateActions(com.salesforce.soap.partner.ProcessRequest[] param) {
     ...
     * @param param Actions
     */
    public void setActions(com.salesforce.soap.partner.ProcessRequest[] param) {
     ...
     * 
     * @param param com.salesforce.soap.partner.ProcessRequest
     */
    public void addActions(com.salesforce.soap.partner.ProcessRequest param) {
        if (localActions == null) {
            localActions = new com.salesforce.soap.partner.ProcessRequest[] {};
        }
        ...
        list.add(param);
        this.localActions = (com.salesforce.soap.partner.ProcessRequest[]) list
                .toArray(new com.salesforce.soap.partner.ProcessRequest[list.size()]);
    ...
    public void serialize(final javax.xml.namespace.QName parentQName, final org.apache.axiom.om.OMFactory factory,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix + ":process",
                        xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "process", xmlWriter);
            }
        ...
        public static Process parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"process".equals(type)) {
                            ...
                            return (Process) com.salesforce.soap.partner.sobject.ExtensionMapper.getTypeObject(nsUri, type,
                                    reader);
                        }
                ...
                if (reader.isStartElement()
                    ...
                    list1.add(com.salesforce.soap.partner.ProcessRequest.Factory.parse(reader));
                    ...
                    object.setActions((com.salesforce.soap.partner.ProcessRequest[]) org.apache.axis2.databinding.utils.ConverterUtil
                            .convertToArray(com.salesforce.soap.partner.ProcessRequest.class, list1));
