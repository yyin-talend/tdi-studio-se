...
public class UpdateLog4jJarUtilsTest {
    ...
    public void testAddLog4jToJarList() {
        ...
        assertTrue(modules4log4j2.contains("log4j-core-2.15.0.jar"));
        assertTrue(modules4log4j2.contains("log4j-api-2.15.0.jar"));
        assertTrue(modules4log4j2.contains("log4j-jcl-2.15.0.jar"));
        assertTrue(modules4log4j2.contains("log4j-jul-2.15.0.jar"));
        assertTrue(modules4log4j2.contains("log4j-slf4j-impl-2.15.0.jar"));

        assertFalse(modules4log4j2.contains("jcl-over-slf4j-1.7.25.jar"));
        assertFalse(modules4log4j2.contains("log4j-to-slf4j-2.15.0.jar"));
        ...
        assertFalse(modules4log4j1.contains("log4j-core-2.15.0.jar"));
        assertFalse(modules4log4j1.contains("log4j-api-2.15.0.jar"));
        assertFalse(modules4log4j1.contains("log4j-jcl-2.15.0.jar"));
        assertFalse(modules4log4j1.contains("log4j-jul-2.15.0.jar"));
        assertFalse(modules4log4j1.contains("log4j-slf4j-impl-2.15.0.jar"));

        assertTrue(modules4log4j1.contains("jcl-over-slf4j-1.7.25.jar"));
        assertTrue(modules4log4j1.contains("jul-to-slf4j-1.7.25.jar"));
        assertTrue(modules4log4j1.contains("log4j-to-slf4j-2.15.0.jar"));
    ...
    public void testAddLog4jToModuleList() {
        ...
        assertTrue(modules4log4j2.contains("mvn:org.apache.logging.log4j/log4j-core/2.15.0/jar"));
        assertTrue(modules4log4j2.contains("mvn:org.apache.logging.log4j/log4j-api/2.15.0/jar"));
        assertTrue(modules4log4j2.contains("mvn:org.apache.logging.log4j/log4j-jcl/2.15.0/jar"));
        assertTrue(modules4log4j2.contains("mvn:org.apache.logging.log4j/log4j-jul/2.15.0/jar"));
        assertTrue(modules4log4j2.contains("mvn:org.apache.logging.log4j/log4j-slf4j-impl/2.15.0/jar"));

        assertFalse(modules4log4j2.contains("mvn:org.slf4j/jcl-over-slf4j/1.7.25/jar"));
        assertFalse(modules4log4j2.contains("mvn:org.apache.logging.log4j/log4j-to-slf4j/2.15.0/jar"));
        ...
        assertFalse(modules4log4j1.contains("mvn:org.apache.logging.log4j/log4j-core/2.15.0/jar"));
        assertFalse(modules4log4j1.contains("mvn:org.apache.logging.log4j/log4j-api/2.15.0/jar"));
        assertFalse(modules4log4j1.contains("mvn:org.apache.logging.log4j/log4j-jcl/2.15.0/jar"));
        assertFalse(modules4log4j1.contains("mvn:org.apache.logging.log4j/log4j-jul/2.15.0/jar"));
        assertFalse(modules4log4j1.contains("mvn:org.apache.logging.log4j/log4j-slf4j-impl/2.15.0/jar"));
        ...
        assertTrue(modules4log4j1.contains("mvn:org.apache.logging.log4j/log4j-to-slf4j/2.15.0/jar"));
    ...
    private List<String> getAllLog4jModulesName() {
        ...
        // log2
        jarList.add("log4j-core-2.15.0.jar");//$NON-NLS-1$
        jarList.add("log4j-api-2.15.0.jar");//$NON-NLS-1$
        jarList.add("log4j-jcl-2.15.0.jar");//$NON-NLS-1$
        jarList.add("log4j-jul-2.15.0.jar");//$NON-NLS-1$
        jarList.add("log4j-slf4j-impl-2.15.0.jar");//$NON-NLS-1$
        // log1
        jarList.add("jcl-over-slf4j-1.7.25.jar");//$NON-NLS-1$
        jarList.add("jul-to-slf4j-1.7.25.jar");//$NON-NLS-1$
        jarList.add("log4j-to-slf4j-2.15.0.jar");//$NON-NLS-1$
    ...
    private List<ModuleNeeded> getAllLog4jModules() {
        ...
        ModuleNeeded log4jJcl = new ModuleNeeded("org.apache.logging.log4j", "log4j-jcl-2.15.0.jar", null, true); //$NON-NLS-1$ //$NON-NLS-2$
        log4jJcl.setMavenUri("mvn:org.apache.logging.log4j/log4j-jcl/2.15.0");//$NON-NLS-1$
        jarList.add(log4jJcl);
        ModuleNeeded log4jJul = new ModuleNeeded("org.apache.logging.log4j", "log4j-jul-2.15.0.jar", null, true); //$NON-NLS-1$ //$NON-NLS-2$
        log4jJul.setMavenUri("mvn:org.apache.logging.log4j/log4j-jul/2.15.0");//$NON-NLS-1$
        jarList.add(log4jJul);
        ModuleNeeded log4jSlf4jImpl = new ModuleNeeded("org.apache.logging.log4j", "log4j-slf4j-impl-2.15.0.jar", null, true); //$NON-NLS-1$ //$NON-NLS-2$
        log4jSlf4jImpl.setMavenUri("mvn:org.apache.logging.log4j/log4j-slf4j-impl/2.15.0");//$NON-NLS-1$
        ...
        ModuleNeeded log4jToSlf4j = new ModuleNeeded("org.apache.logging.log4j", "log4j-to-slf4j-2.15.0.jar", null, true); //$NON-NLS-1$ //$NON-NLS-2$
        log4jToSlf4j.setMavenUri("mvn:org.apache.logging.log4j/log4j-to-slf4j/2.15.0");//$NON-NLS-1$
