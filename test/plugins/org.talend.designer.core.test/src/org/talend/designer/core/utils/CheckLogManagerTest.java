...
public class CheckLogManagerTest {
    ...
    public void testAddLog4jToModuleList() {
        ...
        try {
            ...
            if (!selectLog4j2) {
                ...
                assertTrue(modules4log4j.contains("log4j-jcl-2.13.2.jar"));
                // case3:if original job need log4j1 jar, add back log4j-1.2-api for log4j2
                assertTrue(modules4log4j.contains("log4j-1.2-api-2.13.2.jar"));
            }
        } finally {
    ...
    public void testAddLog4jToModuleListForBDJob() {
        ...
        assertFalse(modules4log4j.contains("log4j-1.2-api-2.13.2.jar"));
    }
    ...
    public void testSortClassPath4Log4j() {
        ...
        ModuleNeeded highPriorityModuleNeeded1 = new ModuleNeeded("", "high-priority-module1-2.13.2.jar", null, true);
