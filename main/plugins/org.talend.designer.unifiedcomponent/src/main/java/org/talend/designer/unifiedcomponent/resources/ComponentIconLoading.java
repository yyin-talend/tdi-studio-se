...
public class ComponentIconLoading {
    ...
    private ComponentImage iImage_32;
     ...
     * @param iImage_32
     */
    public ComponentIconLoading(Map<String, ImageDescriptor> componentsImageRegistry, ComponentImage iImage_32) {
        super();
    ...
    public ImageDescriptor getImage32() {
        ImageDescriptor image32 = registry.get(iImage_32.getLocation() + iImage_32.name() + "_icon32");
        if (image32 == null || image32.getImageData() == null) {
            image32 = ImageProvider.getImageDesc(iImage_32);
        }
        registry.put(iImage_32.getLocation() + iImage_32.name() + "_icon32", image32);
        return image32;
    }

    public ImageDescriptor getImage24() {
        ImageDescriptor image24 = registry.get(iImage_32.getLocation() + iImage_32.name() + "_icon24");
        ...
        registry.put(iImage_32.getLocation() + iImage_32.name() + "_icon24", image24);

        return image24;
    }

    public ImageDescriptor getImage16() {
        ImageDescriptor image16 = registry.get(iImage_32.getLocation() + iImage_32.name() + "_icon16");
        ...
        registry.put(iImage_32.getLocation() + iImage_32.name() + "_icon16", image16);
