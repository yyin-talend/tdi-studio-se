 ...
 * @generated
 */
public class ActionBusinessItemViewFactory extends AbstractShapeViewFactory {

    /**
     * @generated NOT
     */
    private static final Color DEFAULT_COLOR = new Color(null, new RGB(227, 226, 134));
    ...
    protected void decorateView(View containerView, View view, IAdaptable semanticAdapter, String semanticHint, int index,
        ...
        if (semanticHint == null) {
            semanticHint = BusinessVisualIDRegistry
                    .getType(org.talend.designer.business.model.business.diagram.edit.parts.ActionBusinessItemEditPart.VISUAL_ID);
        ...
        getViewService().createNode(semanticAdapter, view,
                BusinessVisualIDRegistry.getType(ActionBusinessItemNameEditPart.VISUAL_ID), ViewUtil.APPEND, true,
                getPreferencesHint());
    }
