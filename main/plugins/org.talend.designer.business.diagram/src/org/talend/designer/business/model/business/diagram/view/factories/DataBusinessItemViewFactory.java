 ...
 * @generated
 */
public class DataBusinessItemViewFactory extends AbstractShapeViewFactory {

    /**
     * @generated NOT
     */
    private static final Color DEFAULT_COLOR = new Color(null, new RGB(184, 152, 193));
    ...
    protected void decorateView(View containerView, View view, IAdaptable semanticAdapter, String semanticHint, int index,
        ...
        if (semanticHint == null) {
            semanticHint = BusinessVisualIDRegistry
                    .getType(org.talend.designer.business.model.business.diagram.edit.parts.DataBusinessItemEditPart.VISUAL_ID);
        ...
        getViewService().createNode(semanticAdapter, view,
                BusinessVisualIDRegistry.getType(DataBusinessItemNameEditPart.VISUAL_ID), ViewUtil.APPEND, true,
                getPreferencesHint());
    }
