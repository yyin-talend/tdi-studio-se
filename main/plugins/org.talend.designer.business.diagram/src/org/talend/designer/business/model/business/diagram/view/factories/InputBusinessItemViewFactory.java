 ...
 * @generated
 */
public class InputBusinessItemViewFactory extends AbstractShapeViewFactory {

    /**
     * @generated NOT
     */
    private static final Color DEFAULT_COLOR = new Color(null, new RGB(226, 179, 231));
    ...
    protected void decorateView(View containerView, View view, IAdaptable semanticAdapter, String semanticHint, int index,
        ...
        if (semanticHint == null) {
            semanticHint = BusinessVisualIDRegistry
                    .getType(org.talend.designer.business.model.business.diagram.edit.parts.InputBusinessItemEditPart.VISUAL_ID);
        ...
        getViewService().createNode(semanticAdapter, view,
                BusinessVisualIDRegistry.getType(InputBusinessItemNameEditPart.VISUAL_ID), ViewUtil.APPEND, true,
                getPreferencesHint());
    }
