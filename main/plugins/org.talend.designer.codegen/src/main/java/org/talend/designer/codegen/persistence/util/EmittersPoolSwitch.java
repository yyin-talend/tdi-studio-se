 ...
 * @generated
 */
public class EmittersPoolSwitch {
    ...
    protected Object doSwitch(int classifierID, EObject theEObject) {
        ...
        case EmittersPoolPackage.POOL_TYPE: {
            PoolType poolType = (PoolType) theEObject;
            Object result = casePoolType(poolType);
            if (result == null)
                result = defaultCase(theEObject);
            return result;
        }
    ...
    /**
     * Returns the result of interpretting the object as an instance of '<em>Pool Type</em>'. <!-- begin-user-doc
     * --> This implementation returns null; returning a non-null result will terminate the switch. <!-- end-user-doc
     * -->
     * 
     * @param object the target of the switch.
     * @return the result of interpretting the object as an instance of '<em>Pool Type</em>'.
     * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
     * @generated
     */
