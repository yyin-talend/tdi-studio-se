 ...
 */
public class ChangeDBName4Hive extends AbstractJobMigrationTask {

    @Override
    public ExecutionResult execute(Item item) {
        final ProcessType processType = getProcessType(item);
        String[] compNames = { "tHiveConnection", "tHiveRow", "tHiveInput", "tELTHiveMap" }; //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
    ...
    public Date getOrder() {
        GregorianCalendar gc = new GregorianCalendar(2013, 9, 24, 10, 0, 0);
        return gc.getTime();
    }
}
