    ...
    private void readAndReplaceInRouteXmlTemplate(Item processItem, String inputFile, String targetFile, String jobName,
            ...
            if (process != null) {
                ...
                while (iterator.hasNext()) {
                    ...
                    if ("cCXF".equals(next.getComponentName())) {
                        if (!hasSL) {
                            hasSL = computeCheckElementValue("ENABLE_SL", next.getElementParameter());
                        }
                        if (!hasSAM) {
                            ...
                            if (!"MESSAGE".equals(format)) {
                                hasSAM = computeCheckElementValue("ENABLE_SAM", next.getElementParameter());
                            }
                        }
                    }
        ...
        try {
            ...
            while (line != null) {
                ...
                if (hasSL) {
                    line = line.replace("@ESBSLFeatureProperty@", "<property name=\"locatorFeature\" ref=\"locatorFeature\"/>");
                ...
                if (hasSAM) {
                    line = line.replace("@ESBSAMFeatureProperty@", "<property name=\"eventFeature\" ref=\"eventFeature\"/>");
