...
public class RenameTCOMPCouchbaseMigrationTask extends AbstractJobMigrationTask {
    ...
    public Date getOrder() {
        GregorianCalendar gc = new GregorianCalendar(2019, 5, 30, 12, 0, 0);
        return gc.getTime();
    }

    final String[] source = { "tCouchbaseInput", "tCouchbaseOutput" };

    final String[] target = { "tCouchbaseDCPInput", "tCouchbaseDCPOutput" };
