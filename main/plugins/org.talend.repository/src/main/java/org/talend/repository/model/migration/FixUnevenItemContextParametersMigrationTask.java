...
public class FixUnevenItemContextParametersMigrationTask extends AbstractItemMigrationTask {

    @Override
    public Date getOrder() {
        GregorianCalendar gc = new GregorianCalendar(2016, 3, 7, 11, 24, 33);
        return gc.getTime();
    }
