...
public interface DbmapFactory extends EFactory {
    ...
    /**
     * Returns a new object of class '<em>DB Map Data</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
    ...
    /**
     * Returns a new object of class '<em>DB Mapper Table Entry</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
    ...
    /**
     * Returns a new object of class '<em>Abstace DB In Out Table</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
    ...
    /**
     * Returns a new object of class '<em>Var Table</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
    ...
    /**
     * Returns a new object of class '<em>Input Table</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
    ...
    /**
     * Returns a new object of class '<em>Output Table</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
    ...
    /**
     * Returns a new object of class '<em>Filter Entry</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
