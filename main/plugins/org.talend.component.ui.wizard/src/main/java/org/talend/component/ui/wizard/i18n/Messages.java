...
//
// ============================================================================
package org.talend.component.ui.wizard.i18n;
...
public class Messages extends MessagesCore {
    ...
    public static String getString(String key) {
        return getString(key, IGenericConstants.PLUGIN_ID, resourceBundle);
    }
    ...
    public static String getString(String key, Object... args) {
        return getString(key, IGenericConstants.PLUGIN_ID, resourceBundle, args);
    }
}
