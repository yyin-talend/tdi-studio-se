...
public class GenericRepositoryContextHandler extends AbstractRepositoryContextHandler {
    ...
    private ComponentProperties getComponentProperties(GenericConnection connection) {
        ...
        if (connection instanceof GenericConnection) {
            ...
            for (IConnParamName param : paramSet) {
                if (param instanceof GenericConnParamName) {
                    ...
                    genericVariableName = originalVariableName + paramName;
    ...
    private String getCorrectVariableName(ContextItem contextItem, String originalVariableName, GenericConnParamName genericParam) {
    ...
    private void matchContextForAttribues(ComponentProperties componentProperties, IConnParamName param,
    ...
    private void revertPropertiesValues(ComponentProperties componentProperties, ContextType contextType) {
        ...
        for (SchemaElement schemaElement : properties) {
            if (schemaElement instanceof ComponentProperties) {
                ...
                String value = String.valueOf(componentProperties.getValue(schemaElement));
                if (value != null) {
                    String originalValue = TalendQuoteUtils.removeQuotes(ContextParameterUtils.getOriginalValue(contextType,
                            value));
                    componentProperties.setValue(schemaElement, originalValue);
                }
            }
        }
    }
