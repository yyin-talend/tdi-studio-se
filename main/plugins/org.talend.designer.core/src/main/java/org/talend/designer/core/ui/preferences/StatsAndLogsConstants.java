...
//            "IBM_DB2", "SYBASE", "SQLITE", "FIREBIRD" };
    ...
    public static final String[] AS400_VERSION_DISPLAY = new String[] { "V7R3 to V7R5", "V7R1 to V7R3", "V6R1 to V7R2"}; //$NON-NLS-1$ //$NON-NLS-2$

    public static final String[] AS400_VERSION_CODE = new String[] { "AS400_V7R3_V7R5", "AS400_V7R1_V7R3", "AS400_V6R1_V7R2"}; //$NON-NLS-1$ //$NON-NLS-2$

    public static final String[] AS400_VERSION_DRIVER = new String[] { "jt400-11.0.jar", "jt400-9.8.jar", "jt400_V6R1.jar"}; //$NON-NLS-1$ //$NON-NLS-2$
