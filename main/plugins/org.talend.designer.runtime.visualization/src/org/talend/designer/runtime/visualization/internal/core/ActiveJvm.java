...
import org.talend.designer.runtime.visualization.ISWTResourceMonitor;
...
import org.talend.designer.runtime.visualization.internal.core.cpu.CpuProfiler;
import org.talend.designer.runtime.visualization.internal.core.cpu.ICpuProfiler;
...
public class ActiveJvm extends AbstractJvm implements IActiveJvm {
    ...
    public ActiveJvm(int port, String userName, String password, IHost host, int updatePeriod) throws JvmCoreException {
        ...
        try {
            ...
            throw new JvmCoreException(IStatus.ERROR, NLS.bind(Messages.getJmxServiceUrlForPortFailedMsg, port), e);
        }
        initialize(url);
    ...
    public ActiveJvm(String url, String userName, String password, int updatePeriod) throws JvmCoreException {
        ...
        try {
            ...
            throw new JvmCoreException(IStatus.ERROR, NLS.bind(Messages.getJmxServiceUrlForUrlFailedMsg, url), e);
        }
     ...
     * 
     * @param errorStateMessage The error state message
     */
