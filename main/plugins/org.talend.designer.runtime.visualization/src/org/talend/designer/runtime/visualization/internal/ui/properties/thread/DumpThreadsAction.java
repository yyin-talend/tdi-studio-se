...
public class DumpThreadsAction extends Action {
    ...
    public DumpThreadsAction(AbstractJvmPropertySection section) {
        ...
        setImageDescriptor(Activator.getImageDescriptor(ISharedImages.TAKE_THREAD_DUMP_IMG_PATH));
        setDisabledImageDescriptor(Activator.getImageDescriptor(ISharedImages.DISABLED_TAKE_THREAD_DUMP_IMG_PATH));
