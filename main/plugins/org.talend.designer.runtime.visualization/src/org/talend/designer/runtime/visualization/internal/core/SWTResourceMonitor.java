...
import org.talend.designer.runtime.visualization.ISWTResourceElement;
...
public class SWTResourceMonitor implements ISWTResourceMonitor {
    ...
    private static StackTraceElement[] getStackTrace(CompositeData[] stackTrace) {
        ...
        for (CompositeData compositeData : stackTrace) {
            ...
            if ((className instanceof String) && (fileName instanceof String) && (lineNumber instanceof Integer)
                    && (metohdName instanceof String) && (nativeMethod instanceof Boolean)) {
                list.add(new StackTraceElement((String) className, (String) metohdName, (String) fileName,
