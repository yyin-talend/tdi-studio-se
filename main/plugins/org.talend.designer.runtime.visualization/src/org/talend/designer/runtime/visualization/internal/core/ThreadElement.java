...
public class ThreadElement implements IThreadElement {
     ...
     * @param isDeadlocked True if the thread is in deadlock
     * @param cpuUsage The CPU usage in percentage
     */
    ...
    public ThreadElement(String threadName, State threadState, long blockedTime, long blockedCount, long waitedTime,
            long waitedCount, String lockName, String lockOwnerName, boolean isSuspended, boolean isDeadlocked, double cpuUsage) {
     ...
     * 
     * @param deadlocked true if thread is deadlocked
     */
