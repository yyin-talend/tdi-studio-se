...
import org.talend.designer.runtime.visualization.internal.ui.properties.timeline.ConfigureChartDialog;
 ...
 */
abstract public class ShowInTimelineAction extends Action implements ISelectionChangedListener {
    ...
    public void run() {
        ...
        ShowInTimelineDialog dialog = new ShowInTimelineDialog(Display.getDefault().getActiveShell(), selections.get(0)
    ...
    private class ShowInTimelineDialog extends ConfigureChartDialog {
        ...
        protected void configureShell(Shell newShell) {
            ...
            PlatformUI.getWorkbench().getHelpSystem().setHelp(newShell, IHelpContextIds.SHOW_IN_TIMELINE_DIALOG);
        }
    }
}
