...
public class MonitoredMXBeanAttribute implements IMonitoredMXBeanAttribute {
    ...
    /**
     * Compresses the data diving into several durations and keeping only the min / max value in each duration.
     */
     ...
     * @param valuesArray The array of values
     * @param indexA The index of {@link #dates} and {@link #values} to add
     * @param indexB The index of {@link #values} and {@link #values} to add
     */
