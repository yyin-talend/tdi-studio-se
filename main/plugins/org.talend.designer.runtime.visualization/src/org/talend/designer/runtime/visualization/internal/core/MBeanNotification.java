...
public class MBeanNotification implements IMBeanNotification {
     ...
     * The constructor.
     * 
     * @param activeJvm The active JVM
     */
     ...
     */
    public void dispose() {
        for (Entry<ObjectName, NotificationListener> entry : listeners.entrySet()) {
            try {
    ...
    private static class DecoratedNotification extends Notification {
        ...
        public DecoratedNotification(Notification notification) {
            super(notification.getType(), notification.getSource(), notification.getSequenceNumber(),
        ...
        public String toString() {
            ...
            buffer.append(new SimpleDateFormat(DATE_FORMAT).format(new Date(getTimeStamp()))).append('\n');
