...
public class SaveChartSetAsDialog extends Dialog {
     ...
     * @param predefinedChartSets The predefined chart sets
     */
    ...
    protected void configureShell(Shell newShell) {
        ...
        PlatformUI.getWorkbench().getHelpSystem().setHelp(newShell, IHelpContextIds.SAVE_CHART_SET_AS_DIALOG);
    }
            ...
            public void modifyText(ModifyEvent e) {
                try {
                    ...
                    if (chartSets.contains(chartSet)) {
                        chartSetViewer.setSelection(new StructuredSelection(chartSet));
                    } else {
