 ...
 *******************************************************************************/
package org.talend.designer.runtime.visualization.internal.ui.properties.cpu;
...
import org.talend.designer.runtime.visualization.internal.core.cpu.ICpuModelChangeListener;
import org.talend.designer.runtime.visualization.internal.ui.properties.cpu.actions.ConfigureCpuProfilerAction;
...
abstract public class AbstractTabPage extends PageBook {
     ...
     * The constructor.
     * 
     * @param cpuSection The CPU section
    ...
    public void dispose() {
        super.dispose();
        if (jvm != null) {
            jvm.getCpuProfiler().getCpuModel().removeModelChangeListener(cpuModelChangeListener);
        }
    }
     ...
     * Update the page.
     * 
     * @param isPackageSpecified The state indicating if the packages are specified
     */
     ...
     * 
     * @param desctiption The content description
     */
    ...
    protected void setInput(IActiveJvm newJvm) {
        if (!newJvm.equals(jvm)) {
            ...
            jvm = newJvm;
            newJvm.getCpuProfiler().getCpuModel().addModelChangeListener(cpuModelChangeListener);
        }
    }
    ...
    private void createContentDescriptionLabel() {
        ...
        contentDescriptionLabel.setLayoutData(new GridData(GridData.FILL_HORIZONTAL));
    }
}
