...
/**
 * The model that contains CPU profiling result data. The data is given with either an input stream or a file using
...
public class CpuModel implements ICpuModel {
     ...
     * 
     * @param event The CPU model change event
     */
     ...
     */
    private void refreshCallersCallees(List<String> callerNames, List<String> calleeNames, List<CallTreeNode> frameRootNodes,
            String method) {
