...
public interface IMonitoredMXBeanGroup {
     ...
     */
    IMonitoredMXBeanAttribute getAttribute(ObjectName objectName, String attributeName);
     ...
     */
    void addAttribute(String objectName, String attributeName, int[] rgb) throws JvmCoreException;
