...
import org.talend.designer.runtime.visualization.internal.ui.properties.cpu.CpuSection;
...
public class ConfigureCpuProfilerAction extends Action {
    ...
    void openDialog() {
        ...
        final ConfigurationDialog dialog = new ConfigurationDialog(cpuSection.getPart().getSite().getShell(), jvm
                .getCpuProfiler().getProfilerType(), jvm.getCpuProfiler().getSamplingPeriod(), jvm.getCpuProfiler().getState(
                ProfilerType.BCI), packages);
