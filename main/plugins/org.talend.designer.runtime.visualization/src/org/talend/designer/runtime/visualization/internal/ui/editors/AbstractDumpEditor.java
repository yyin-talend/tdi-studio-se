...
abstract public class AbstractDumpEditor extends MultiPageEditorPart {
    ...
    private Image getInfoImage() {
        if (infoImage == null || infoImage.isDisposed()) {
            infoImage = Activator.getImageDescriptor(ISharedImages.INFO_IMG_PATH).createImage();
        }
        return infoImage;
    }
    ...
    private class ResourceChangeListener implements IResourceChangeListener {
        ...
        /**
         * Search the resource corresponding to editor input in given resource delta and its children.
         * 
        ...
        private boolean searchFile(IResourceDelta delta) {
            ...
            if (input instanceof IFileEditorInput) {
                ...
                if (delta.getKind() == IResourceDelta.REMOVED && delta.getFullPath().toOSString().equals(filePath)) {
                    return true;
                }
            }
