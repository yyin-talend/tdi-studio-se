...
/**
 * The label provider for SWT resources viewer extending LabelProvider to change the filter behavior.
 */
    ...
    public String getText(Object obj) {
        if (obj instanceof ISWTResourceElement) {
            ...
            if (Activator.getDefault().getPreferenceStore().getBoolean(IConstants.WIDE_SCOPE_SWT_RESOURCE_FILTER)) {
                for (StackTraceElement element : ((ISWTResourceElement) obj).getStackTraceElements()) {
