 ...
 *******************************************************************************/
package org.talend.designer.runtime.visualization.MBean;
...
public interface IMBeanNotification {
    ...
    /**
     * Gets the state indicating if the notification is subscribed for the given object name.
     * 
     * @param objectName The object name
    ...
    /**
     * Gets the state indicating if the notification is supported for the given object name.
     * 
     * @param objectName The object name
