...
import org.talend.designer.runtime.visualization.internal.core.ProfileInfo;
import org.talend.designer.runtime.visualization.internal.core.cpu.CpuModelEvent.CpuModelState;
...
public class CpuDumpSaxEventHandler extends DefaultHandler {
    ...
    public void endDocument() throws SAXException {
        cpuModel.notifyModelChanged(new CpuModelEvent(CpuModelState.CpuModelChanged));
    }
    ...
    public void startElement(String uri, String localName, String name, Attributes attributes) throws SAXException {
        ...
        if ("thread".equals(name)) { //$NON-NLS-1$
            ...
            currentCallTreeThreadNode = cpuModel.getCallTreeThread(threadName);
            ...
            currentHotSpotThreadNode = cpuModel.getHotSpotThread(threadName);
    ...
    public void endElement(String uri, String localName, String name) throws SAXException {
        ...
        if ("frame".equals(name)) { //$NON-NLS-1$
            ...
            if (parrentNode instanceof CallTreeNode) {
                ...
                long selfTime = parentFrameNode.getSelfTime() - currentFrameNode.getTotalTime();
     ...
     * 
     * @param attributes The frame attribute
     */
    private void parseFrame(Attributes attributes) {
        ...
        if (currentRootFrameNode == null) {
            currentRootFrameNode = (CallTreeNode) currentCallTreeThreadNode.getChild(methodName);
            if (currentRootFrameNode == null) {
                currentRootFrameNode = new CallTreeNode(cpuModel, methodName, time, count, currentCallTreeThreadNode);
            ...
            if (childFrameNode == null) {
                childFrameNode = new CallTreeNode(cpuModel, methodName, time, count, currentFrameNode, currentCallTreeThreadNode);
    ...
    private void storeMethods(CallTreeNode frame) {
        ...
        MethodNode method = (MethodNode) currentHotSpotThreadNode.getChild(methodName);
        ...
        if (method == null) {
            method = new MethodNode(cpuModel, methodName, currentHotSpotThreadNode);
