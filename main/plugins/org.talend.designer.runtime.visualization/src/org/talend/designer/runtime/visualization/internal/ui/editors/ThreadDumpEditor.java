...
import org.talend.designer.runtime.visualization.core.dump.ThreadDumpParser;
import org.talend.designer.runtime.visualization.internal.ui.IHelpContextIds;
import org.talend.designer.runtime.visualization.internal.ui.properties.thread.IThreadInput;
import org.talend.designer.runtime.visualization.internal.ui.properties.thread.ThreadSashForm;
...
public class ThreadDumpEditor extends AbstractDumpEditor {
    ...
    private Image getThreadImage() {
        if (threadImage == null || threadImage.isDisposed()) {
            threadImage = Activator.getImageDescriptor(ISharedImages.THREAD_IMG_PATH).createImage();
        }
        return threadImage;
    }
        ...
        Job job = new Job(Messages.parseThreadDumpFileJobLabel) {
            ...
            protected IStatus run(IProgressMonitor monitor) {
                ...
                try {
                    ...
                    return new Status(IStatus.ERROR, Activator.PLUGIN_ID, "Could not load thread dump file.", e); //$NON-NLS-1$
