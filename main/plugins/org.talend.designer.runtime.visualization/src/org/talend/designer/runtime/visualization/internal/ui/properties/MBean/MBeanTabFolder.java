...
public class MBeanTabFolder extends PageBook {
     ...
     * The constructor.
     * 
     * @param sashForm The sash form
     * @param propertySection The property section
     */
    public MBeanTabFolder(SashForm sashForm, AbstractJvmPropertySection propertySection) {
        ...
        message.setBackground(Display.getDefault().getSystemColor(SWT.COLOR_LIST_BACKGROUND));
