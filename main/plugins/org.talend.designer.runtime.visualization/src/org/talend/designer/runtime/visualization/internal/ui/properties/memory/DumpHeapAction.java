...
public class DumpHeapAction extends Action {
    ...
    public DumpHeapAction(AbstractJvmPropertySection section) {
        ...
        setImageDescriptor(Activator.getImageDescriptor(ISharedImages.TAKE_HEAP_DUMP_IMG_PATH));
        setDisabledImageDescriptor(Activator.getImageDescriptor(ISharedImages.DISABLED_TAKE_HEAP_DUMP_IMG_PATH));
