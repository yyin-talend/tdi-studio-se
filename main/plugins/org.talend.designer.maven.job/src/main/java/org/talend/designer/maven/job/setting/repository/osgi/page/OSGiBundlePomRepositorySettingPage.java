...
import org.talend.designer.maven.job.setting.project.page.osgi.OSGiBundlePomProjectSettingPage;
import org.talend.designer.maven.ui.setting.repository.RepositoryMavenSettingStore;

/**
 * DOC ggu class global comment. Detailled comment
 */
public class OSGiBundlePomRepositorySettingPage extends OSGiBundlePomProjectSettingPage {

    private IFile scriptFile;

    public OSGiBundlePomRepositorySettingPage(IFile scriptFile) {
        super();
