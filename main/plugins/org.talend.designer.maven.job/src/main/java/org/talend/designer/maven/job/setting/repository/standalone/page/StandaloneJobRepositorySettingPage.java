...
public class StandaloneJobRepositorySettingPage extends FolderMavenSettingPage {
    ...
    protected String createMessages(boolean created) {
        ...
        if (created) {
            ...
            messages.append(Messages.getString("StandaloneJobRepositorySettingPage_CreatingMavenSettingNote"));//$NON-NLS-1$
            messages.append(' ');
            String mvnProjectSettingLinkStr = "<a href=\"" + ID_MAVEN_AUTONOMOUS_JOB_PROJECT_SETTING + "\">Maven</a>";//$NON-NLS-1$ //$NON-NLS-2$
            messages.append(Messages.getString("StandaloneJobRepositorySettingPage_CreatingMavenSettingNoteMessage", //$NON-NLS-1$
