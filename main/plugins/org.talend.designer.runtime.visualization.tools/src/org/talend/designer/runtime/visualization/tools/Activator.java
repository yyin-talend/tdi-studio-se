 ...
 *******************************************************************************/
package org.talend.designer.runtime.visualization.tools;
...
public class Activator extends AbstractUIPlugin {
    ...
    /** The plug-in ID. */
    public static final String PLUGIN_ID = "org.talend.designer.runtime.visualization.tools"; //$NON-NLS-1$
     ...
     * 
     * @param severity The severity that can be info, warning or error
