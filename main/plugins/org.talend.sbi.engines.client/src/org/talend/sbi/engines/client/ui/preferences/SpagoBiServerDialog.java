...
public class SpagoBiServerDialog extends Dialog {
    ...
    public SpagoBiServerDialog(Shell parentShell, List existingServers) {
        // this(parentShell, existingServers, null, null, null, null, null, null, null);
        this(parentShell, existingServers, null, null, null, null, null, null);
        creation = true;
    }
    ...
    protected void validateInput() {
        ...
        if (creation && engineNameText.getText().equals("")) { //$NON-NLS-1$
            errorMessage = Messages.getString("SpagoBiServerDialog.errorMessage.engineNameLetters"); //$NON-NLS-1$
        } else if (creation && existingServers.contains(engineNameText.getText())) {
            errorMessage = Messages.getString("SpagoBiServerDialog.errorMessage.engineNameUsed"); //$NON-NLS-1$
