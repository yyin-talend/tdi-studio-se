 ...
 */
public class ReportentityImpl extends com.microsoft.schemas.crm._2006.webservices.impl.BusinessEntityImpl implements com.microsoft.schemas.crm._2007.webservices.Reportentity
{
    ...
    private static final javax.xml.namespace.QName ISFILTERABLE$6 = 
        new javax.xml.namespace.QName("http://schemas.microsoft.com/crm/2007/WebServices", "isfilterable");
    ...
    private static final javax.xml.namespace.QName OWNINGBUSINESSUNIT$14 = 
        new javax.xml.namespace.QName("http://schemas.microsoft.com/crm/2007/WebServices", "owningbusinessunit");
    private static final javax.xml.namespace.QName OWNINGUSER$16 = 
        new javax.xml.namespace.QName("http://schemas.microsoft.com/crm/2007/WebServices", "owninguser");
    private static final javax.xml.namespace.QName REPORTENTITYID$18 = 
        new javax.xml.namespace.QName("http://schemas.microsoft.com/crm/2007/WebServices", "reportentityid");
     ...
     */
    public com.microsoft.schemas.crm._2006.webservices.CrmBoolean getIsfilterable()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.microsoft.schemas.crm._2006.webservices.CrmBoolean target = null;
            target = (com.microsoft.schemas.crm._2006.webservices.CrmBoolean)get_store().find_element_user(ISFILTERABLE$6, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public boolean isSetIsfilterable()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(ISFILTERABLE$6) != 0;
        }
    }
     ...
     */
    public void setIsfilterable(com.microsoft.schemas.crm._2006.webservices.CrmBoolean isfilterable)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (com.microsoft.schemas.crm._2006.webservices.CrmBoolean)get_store().add_element_user(ISFILTERABLE$6);
            }
     ...
     */
    public com.microsoft.schemas.crm._2006.webservices.CrmBoolean addNewIsfilterable()
    {
        synchronized (monitor())
        {
            check_orphaned();
    ...
    public void unsetIsfilterable()
    {
        ...
        {
            check_orphaned();
            get_store().remove_element(ISFILTERABLE$6, 0);
        }
    }
    ...
    public com.microsoft.schemas.crm._2006.webservices.UniqueIdentifier getOwningbusinessunit()
    {
        synchronized (monitor())
        {
            ...
            target = (com.microsoft.schemas.crm._2006.webservices.UniqueIdentifier)get_store().find_element_user(OWNINGBUSINESSUNIT$14, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public boolean isSetOwningbusinessunit()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(OWNINGBUSINESSUNIT$14) != 0;
        }
    }
    ...
    public void setOwningbusinessunit(com.microsoft.schemas.crm._2006.webservices.UniqueIdentifier owningbusinessunit)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (com.microsoft.schemas.crm._2006.webservices.UniqueIdentifier)get_store().add_element_user(OWNINGBUSINESSUNIT$14);
            }
    ...
    public void unsetOwningbusinessunit()
    {
        ...
        {
            check_orphaned();
            get_store().remove_element(OWNINGBUSINESSUNIT$14, 0);
        }
    }
    ...
    public com.microsoft.schemas.crm._2006.webservices.UniqueIdentifier getOwninguser()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.microsoft.schemas.crm._2006.webservices.UniqueIdentifier target = null;
            target = (com.microsoft.schemas.crm._2006.webservices.UniqueIdentifier)get_store().find_element_user(OWNINGUSER$16, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public boolean isSetOwninguser()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(OWNINGUSER$16) != 0;
        }
    }
    ...
    public void setOwninguser(com.microsoft.schemas.crm._2006.webservices.UniqueIdentifier owninguser)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (com.microsoft.schemas.crm._2006.webservices.UniqueIdentifier)get_store().add_element_user(OWNINGUSER$16);
            }
    ...
    public void unsetOwninguser()
    {
        ...
        {
            check_orphaned();
            get_store().remove_element(OWNINGUSER$16, 0);
        }
    }
     ...
     */
    public com.microsoft.schemas.crm._2006.webservices.Key getReportentityid()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.microsoft.schemas.crm._2006.webservices.Key target = null;
            target = (com.microsoft.schemas.crm._2006.webservices.Key)get_store().find_element_user(REPORTENTITYID$18, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public boolean isSetReportentityid()
    {
        synchronized (monitor())
        {
            check_orphaned();
            return get_store().count_elements(REPORTENTITYID$18) != 0;
        }
    }
     ...
     */
    public void setReportentityid(com.microsoft.schemas.crm._2006.webservices.Key reportentityid)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (com.microsoft.schemas.crm._2006.webservices.Key)get_store().add_element_user(REPORTENTITYID$18);
            }
            target.set(reportentityid);
        }
    }
     ...
     */
    public com.microsoft.schemas.crm._2006.webservices.Key addNewReportentityid()
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public void unsetReportentityid()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(REPORTENTITYID$18, 0);
        }
    }
