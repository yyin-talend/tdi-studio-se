/*
 * XML Type:  uomschedule
 * Namespace: http://schemas.microsoft.com/crm/2007/WebServices
 * Java type: com.microsoft.schemas.crm._2007.webservices.Uomschedule
 *
 * Automatically generated - do not modify.
 */
package com.microsoft.schemas.crm._2007.webservices.impl;
/**
 * An XML uomschedule(@http://schemas.microsoft.com/crm/2007/WebServices).
 *
 * This is a complex type.
 */
public class UomscheduleImpl extends com.microsoft.schemas.crm._2006.webservices.impl.BusinessEntityImpl implements com.microsoft.schemas.crm._2007.webservices.Uomschedule
{
    
    public UomscheduleImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    
    private static final javax.xml.namespace.QName BASEUOMNAME$0 = 
        new javax.xml.namespace.QName("http://schemas.microsoft.com/crm/2007/WebServices", "baseuomname");
    ...
    private static final javax.xml.namespace.QName UOMSCHEDULEID$20 = 
        new javax.xml.namespace.QName("http://schemas.microsoft.com/crm/2007/WebServices", "uomscheduleid");
    
    
    /**
     * Gets the "baseuomname" element
     */
    public java.lang.String getBaseuomname()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.SimpleValue target = null;
            target = (org.apache.xmlbeans.SimpleValue)get_store().find_element_user(BASEUOMNAME$0, 0);
            if (target == null)
            {
                return null;
            }
    ...
    /**
     * Gets (as xml) the "baseuomname" element
     */
    public org.apache.xmlbeans.XmlString xgetBaseuomname()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.XmlString target = null;
            target = (org.apache.xmlbeans.XmlString)get_store().find_element_user(BASEUOMNAME$0, 0);
            return target;
        }
    }
    
    /**
     * True if has "baseuomname" element
     */
    public boolean isSetBaseuomname()
    {
        synchronized (monitor())
        {
            check_orphaned();
            return get_store().count_elements(BASEUOMNAME$0) != 0;
        }
    }
    
    /**
     * Sets the "baseuomname" element
     */
    public void setBaseuomname(java.lang.String baseuomname)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.SimpleValue)get_store().add_element_user(BASEUOMNAME$0);
            }
            target.setStringValue(baseuomname);
        }
    }
    
    /**
     * Sets (as xml) the "baseuomname" element
     */
    public void xsetBaseuomname(org.apache.xmlbeans.XmlString baseuomname)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.XmlString)get_store().add_element_user(BASEUOMNAME$0);
            }
            target.set(baseuomname);
        }
    }
    
    /**
     * Unsets the "baseuomname" element
     */
    public void unsetBaseuomname()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(BASEUOMNAME$0, 0);
        }
    }
     ...
     */
    public com.microsoft.schemas.crm._2006.webservices.Key getUomscheduleid()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.microsoft.schemas.crm._2006.webservices.Key target = null;
            target = (com.microsoft.schemas.crm._2006.webservices.Key)get_store().find_element_user(UOMSCHEDULEID$20, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public boolean isSetUomscheduleid()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(UOMSCHEDULEID$20) != 0;
        }
    }
     ...
     */
    public void setUomscheduleid(com.microsoft.schemas.crm._2006.webservices.Key uomscheduleid)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (com.microsoft.schemas.crm._2006.webservices.Key)get_store().add_element_user(UOMSCHEDULEID$20);
            }
     ...
     */
    public com.microsoft.schemas.crm._2006.webservices.Key addNewUomscheduleid()
    {
        synchronized (monitor())
        {
            check_orphaned();
    ...
    public void unsetUomscheduleid()
    {
        ...
        {
            check_orphaned();
            get_store().remove_element(UOMSCHEDULEID$20, 0);
        }
    }
}
