 ...
 */
public class EntitymapImpl extends com.microsoft.schemas.crm._2006.webservices.impl.BusinessEntityImpl implements com.microsoft.schemas.crm._2007.webservices.Entitymap
{
    
    public EntitymapImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    private static final javax.xml.namespace.QName ENTITYMAPID$4 = 
    ...
    private static final javax.xml.namespace.QName TARGETENTITYNAME$14 = 
     ...
     */
    public com.microsoft.schemas.crm._2006.webservices.Key getEntitymapid()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.microsoft.schemas.crm._2006.webservices.Key target = null;
            target = (com.microsoft.schemas.crm._2006.webservices.Key)get_store().find_element_user(ENTITYMAPID$4, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public boolean isSetEntitymapid()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(ENTITYMAPID$4) != 0;
        }
    }
     ...
     */
    public void setEntitymapid(com.microsoft.schemas.crm._2006.webservices.Key entitymapid)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (com.microsoft.schemas.crm._2006.webservices.Key)get_store().add_element_user(ENTITYMAPID$4);
            }
     ...
     */
    public com.microsoft.schemas.crm._2006.webservices.Key addNewEntitymapid()
    {
        synchronized (monitor())
        {
            check_orphaned();
    ...
    public void unsetEntitymapid()
    {
        ...
        {
            check_orphaned();
            get_store().remove_element(ENTITYMAPID$4, 0);
        }
    }
    ...
    public java.lang.String getTargetentityname()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.SimpleValue target = null;
            target = (org.apache.xmlbeans.SimpleValue)get_store().find_element_user(TARGETENTITYNAME$14, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public org.apache.xmlbeans.XmlString xgetTargetentityname()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.XmlString target = null;
            target = (org.apache.xmlbeans.XmlString)get_store().find_element_user(TARGETENTITYNAME$14, 0);
            return target;
        }
    }
    ...
    public boolean isSetTargetentityname()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(TARGETENTITYNAME$14) != 0;
        }
    }
    ...
    public void setTargetentityname(java.lang.String targetentityname)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.SimpleValue)get_store().add_element_user(TARGETENTITYNAME$14);
            }
    ...
    public void xsetTargetentityname(org.apache.xmlbeans.XmlString targetentityname)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.XmlString)get_store().add_element_user(TARGETENTITYNAME$14);
            }
    ...
    public void unsetTargetentityname()
    {
        ...
        {
            check_orphaned();
            get_store().remove_element(TARGETENTITYNAME$14, 0);
        }
    }
}
