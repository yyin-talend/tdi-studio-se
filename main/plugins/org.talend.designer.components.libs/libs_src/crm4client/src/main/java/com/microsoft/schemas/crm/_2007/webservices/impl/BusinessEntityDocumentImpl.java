 ...
 */
public class BusinessEntityDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.microsoft.schemas.crm._2007.webservices.BusinessEntityDocument
{
     ...
     */
    public boolean isNilBusinessEntity()
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public void setNilBusinessEntity()
    {
        synchronized (monitor())
        {
            check_orphaned();
