...
public class RootAttributeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.xmlsoap.schemas.soap.encoding.RootAttribute
{
     ...
     */
    public Root xgetRoot()
    {
        synchronized (monitor())
        {
            check_orphaned();
            Root target = null;
            target = (Root)get_store().find_attribute_user(ROOT$0);
            if (target == null)
            {
                target = (Root)get_default_attribute_value(ROOT$0);
            }
            return target;
        }
    }
     ...
     */
    public void xsetRoot(Root root)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (Root)get_store().add_attribute_user(ROOT$0);
            }
            target.set(root);
        }
    }
     ...
     */
    public static class RootImpl extends org.apache.xmlbeans.impl.values.JavaBooleanHolderEx implements Root
    {
