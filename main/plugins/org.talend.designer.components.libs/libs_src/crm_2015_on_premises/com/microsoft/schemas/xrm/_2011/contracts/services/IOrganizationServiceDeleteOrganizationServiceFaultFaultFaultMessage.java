...
public class IOrganizationServiceDeleteOrganizationServiceFaultFaultFaultMessage extends Exception {
    ...
    public IOrganizationServiceDeleteOrganizationServiceFaultFaultFaultMessage(String message, com.microsoft.schemas.xrm._2011.contracts.OrganizationServiceFault organizationServiceFault) {
        super(message);
        this.organizationServiceFault = organizationServiceFault;
    }

    public IOrganizationServiceDeleteOrganizationServiceFaultFaultFaultMessage(String message, com.microsoft.schemas.xrm._2011.contracts.OrganizationServiceFault organizationServiceFault, Throwable cause) {
        super(message, cause);
        this.organizationServiceFault = organizationServiceFault;
    }
