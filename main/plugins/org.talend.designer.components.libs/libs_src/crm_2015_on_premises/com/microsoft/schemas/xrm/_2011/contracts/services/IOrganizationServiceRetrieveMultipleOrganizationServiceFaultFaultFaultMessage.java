...
public class IOrganizationServiceRetrieveMultipleOrganizationServiceFaultFaultFaultMessage extends Exception {
    ...
    public IOrganizationServiceRetrieveMultipleOrganizationServiceFaultFaultFaultMessage(String message, Throwable cause) {
        super(message, cause);
    }

    public IOrganizationServiceRetrieveMultipleOrganizationServiceFaultFaultFaultMessage(String message, com.microsoft.schemas.xrm._2011.contracts.OrganizationServiceFault organizationServiceFault) {
        super(message);
        this.organizationServiceFault = organizationServiceFault;
    }

    public IOrganizationServiceRetrieveMultipleOrganizationServiceFaultFaultFaultMessage(String message, com.microsoft.schemas.xrm._2011.contracts.OrganizationServiceFault organizationServiceFault, Throwable cause) {
        super(message, cause);
        this.organizationServiceFault = organizationServiceFault;
    }
