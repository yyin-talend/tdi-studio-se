...
public class EmptyRecycleBinResult implements org.apache.axis2.databinding.ADBBean {

    /*
     * This type was generated from the piece of schema that had name = EmptyRecycleBinResult Namespace URI =
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix
                        + ":EmptyRecycleBinResult", xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "EmptyRecycleBinResult", xmlWriter);
            }
    ...
    public static class Factory {
        ...
        public static EmptyRecycleBinResult parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            EmptyRecycleBinResult object = new EmptyRecycleBinResult();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"EmptyRecycleBinResult".equals(type)) {
                            ...
                            return (EmptyRecycleBinResult) com.salesforce.soap.partner.sobject.ExtensionMapper.getTypeObject(
                                    nsUri, type, reader);
                        }
