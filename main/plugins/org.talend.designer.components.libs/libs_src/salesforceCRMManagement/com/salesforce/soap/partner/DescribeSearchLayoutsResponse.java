/**
 * DescribeSearchLayoutsResponse.java
 *
...
/**
 * DescribeSearchLayoutsResponse bean class
 */
@SuppressWarnings({ "unchecked", "unused" })
public class DescribeSearchLayoutsResponse implements org.apache.axis2.databinding.ADBBean {

    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("urn:partner.soap.sforce.com",
            "describeSearchLayoutsResponse", "ns1");

    /**
     * field for Result This was an Array!
     */

    protected com.salesforce.soap.partner.DescribeSearchLayoutResult[] localResult;
     ...
     * 
     * @return com.salesforce.soap.partner.DescribeSearchLayoutResult[]
     */
    public com.salesforce.soap.partner.DescribeSearchLayoutResult[] getResult() {
        return localResult;
    }
     ...
     */
    protected void validateResult(com.salesforce.soap.partner.DescribeSearchLayoutResult[] param) {
     ...
     * @param param Result
     */
    public void setResult(com.salesforce.soap.partner.DescribeSearchLayoutResult[] param) {
    ...
    public void addResult(com.salesforce.soap.partner.DescribeSearchLayoutResult param) {
        ...
        list.add(param);
        this.localResult = (com.salesforce.soap.partner.DescribeSearchLayoutResult[]) list
                .toArray(new com.salesforce.soap.partner.DescribeSearchLayoutResult[list.size()]);
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix
                        + ":describeSearchLayoutsResponse", xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "describeSearchLayoutsResponse",
                        xmlWriter);
            }
    ...
    public static class Factory {
         ...
         */
        public static DescribeSearchLayoutsResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            DescribeSearchLayoutsResponse object = new DescribeSearchLayoutsResponse();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"describeSearchLayoutsResponse".equals(type)) {
                            // find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (DescribeSearchLayoutsResponse) com.salesforce.soap.partner.sobject.ExtensionMapper
                ...
                if (reader.isStartElement()
                    ...
                    if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
                        ...
                        list1.add(com.salesforce.soap.partner.DescribeSearchLayoutResult.Factory.parse(reader));
                    }
                    ...
                    object.setResult((com.salesforce.soap.partner.DescribeSearchLayoutResult[]) org.apache.axis2.databinding.utils.ConverterUtil
                            .convertToArray(com.salesforce.soap.partner.DescribeSearchLayoutResult.class, list1));
