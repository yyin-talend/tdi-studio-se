...
/**
 * DescribeColor bean class
 */
@SuppressWarnings({ "unchecked", "unused" })
public class DescribeColor implements org.apache.axis2.databinding.ADBBean {
    /*
     * This type was generated from the piece of schema that had name = DescribeColor Namespace URI = urn:partner.soap.sforce.com Namespace
     * Prefix = ns1
     */
    ...
    protected java.lang.String localTheme;
     ...
     * @param param Theme
     */
    public void setTheme(java.lang.String param) {

        this.localTheme = param;
    ...
    public void serialize(final javax.xml.namespace.QName parentQName, javax.xml.stream.XMLStreamWriter xmlWriter,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix + ":DescribeColor",
                        xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "DescribeColor", xmlWriter);
            }
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
        ...
        elementList.add(new javax.xml.namespace.QName("urn:partner.soap.sforce.com", "color"));
        ...
        elementList.add(new javax.xml.namespace.QName("urn:partner.soap.sforce.com", "context"));
        ...
        elementList.add(new javax.xml.namespace.QName("urn:partner.soap.sforce.com", "theme"));

        if (localTheme != null) {
            elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localTheme));
        } else {
            throw new org.apache.axis2.databinding.ADBException("theme cannot be null!!");
        }
    ...
    public static class Factory {
         ...
         */
        public static DescribeColor parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            DescribeColor object = new DescribeColor();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"DescribeColor".equals(type)) {
                            // find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (DescribeColor) com.salesforce.soap.partner.sobject.ExtensionMapper.getTypeObject(nsUri, type,
                                    reader);
                        }
                ...
                if (reader.isStartElement()
                        && new javax.xml.namespace.QName("urn:partner.soap.sforce.com", "color").equals(reader.getName())) {
                ...
                if (reader.isStartElement()
                        && new javax.xml.namespace.QName("urn:partner.soap.sforce.com", "context").equals(reader.getName())) {
                ...
                if (reader.isStartElement()
                        && new javax.xml.namespace.QName("urn:partner.soap.sforce.com", "theme").equals(reader.getName())) {

                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "nil");
                    if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
                        throw new org.apache.axis2.databinding.ADBException("The element: " + "theme" + "  cannot be null");
                    }

                    java.lang.String content = reader.getElementText();

                    object.setTheme(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(content));
