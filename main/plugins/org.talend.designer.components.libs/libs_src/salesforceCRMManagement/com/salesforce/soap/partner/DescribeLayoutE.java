...
public class DescribeLayoutE implements org.apache.axis2.databinding.ADBBean {
    ...
    public boolean isRecordTypeIdsSpecified() {
        return localRecordTypeIdsTracker;
    }
     ...
     */
    public com.salesforce.soap.partner.ID[] getRecordTypeIds() {
     ...
     */
    protected void validateRecordTypeIds(com.salesforce.soap.partner.ID[] param) {
     ...
     */
    public void setRecordTypeIds(com.salesforce.soap.partner.ID[] param) {

        validateRecordTypeIds(param);

        localRecordTypeIdsTracker = param != null;
     ...
     */
    public void addRecordTypeIds(com.salesforce.soap.partner.ID param) {
        if (localRecordTypeIds == null) {
            localRecordTypeIds = new com.salesforce.soap.partner.ID[] {};
        }

        // update the setting tracker
        localRecordTypeIdsTracker = true;

        java.util.List list = org.apache.axis2.databinding.utils.ConverterUtil.toList(localRecordTypeIds);
        list.add(param);
        this.localRecordTypeIds = (com.salesforce.soap.partner.ID[]) list
            ...
            if (localRecordTypeIds != null) {
                for (int i = 0; i < localRecordTypeIds.length; i++) {
                    if (localRecordTypeIds[i] != null) {
                        localRecordTypeIds[i].serialize(new javax.xml.namespace.QName("urn:partner.soap.sforce.com",
                                "recordTypeIds"), xmlWriter);
                    } else {
        ...
        if (localRecordTypeIdsTracker) {
            if (localRecordTypeIds != null) {
                for (int i = 0; i < localRecordTypeIds.length; i++) {
                    ...
                    if (localRecordTypeIds[i] != null) {
                        elementList.add(new javax.xml.namespace.QName("urn:partner.soap.sforce.com", "recordTypeIds"));
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"describeLayout".equals(type)) {
                            ...
                            return (DescribeLayoutE) com.salesforce.soap.partner.sobject.ExtensionMapper.getTypeObject(nsUri,
                                    type, reader);
                        }
