...
public class SObject implements org.apache.axis2.databinding.ADBBean {

    /*
     * This type was generated from the piece of schema that had name = sObject Namespace URI =
     * urn:sobject.partner.soap.sforce.com Namespace Prefix = ns2
     */
    ...
    public void addFieldsToNull(java.lang.String param) {
        ...
        java.util.List list = org.apache.axis2.databinding.utils.ConverterUtil.toList(localFieldsToNull);
        list.add(param);
        this.localFieldsToNull = (java.lang.String[]) list.toArray(new java.lang.String[list.size()]);
    ...
    public void serialize(final javax.xml.namespace.QName parentQName, javax.xml.stream.XMLStreamWriter xmlWriter,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix + ":sObject",
                        xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "sObject", xmlWriter);
            }
            ...
            if (localFieldsToNull != null) {
                ...
                for (int i = 0; i < localFieldsToNull.length; i++) {
                    ...
                    if (localFieldsToNull[i] != null) {
                        ...
                        writeStartElement(null, namespace, "fieldsToNull", xmlWriter);
                ...
                // write null attribute
                writeStartElement(null, "urn:sobject.partner.soap.sforce.com", "fieldsToNull", xmlWriter);
        ...
        if (localId == null) {
            ...
            writeStartElement(null, "urn:sobject.partner.soap.sforce.com", "Id", xmlWriter);

            // write the nil attribute
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "nil", "1", xmlWriter);
            xmlWriter.writeEndElement();
        } else {
            localId.serialize(new javax.xml.namespace.QName("urn:sobject.partner.soap.sforce.com", "Id"), xmlWriter);
        }
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
        ...
        elementList.add(new javax.xml.namespace.QName("urn:sobject.partner.soap.sforce.com", "type"));
        ...
        if (localFieldsToNullTracker) {
            if (localFieldsToNull != null) {
                for (int i = 0; i < localFieldsToNull.length; i++) {
                    ...
                    if (localFieldsToNull[i] != null) {
                        elementList.add(new javax.xml.namespace.QName("urn:sobject.partner.soap.sforce.com", "fieldsToNull"));
        ...
        elementList.add(new javax.xml.namespace.QName("urn:sobject.partner.soap.sforce.com", "Id"));
        ...
        public static SObject parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"sObject".equals(type)) {
                            ...
                            return (SObject) com.salesforce.soap.partner.sobject.ExtensionMapper.getTypeObject(nsUri, type,
                                    reader);
                        }
                ...
                if (reader.isStartElement()
                        && new javax.xml.namespace.QName("urn:sobject.partner.soap.sforce.com", "type").equals(reader.getName())) {
                ...
                if (reader.isStartElement()
                        && new javax.xml.namespace.QName("urn:sobject.partner.soap.sforce.com", "fieldsToNull").equals(reader
                                .getName())) {
                    ...
                    while (!loopDone2) {
                        ...
                        if (reader.isEndElement()) {
                            ...
                            if (new javax.xml.namespace.QName("urn:sobject.partner.soap.sforce.com", "fieldsToNull")
                    ...
                    object.setFieldsToNull((java.lang.String[]) list2.toArray(new java.lang.String[list2.size()]));
                ...
                if (reader.isStartElement()
                        && new javax.xml.namespace.QName("urn:sobject.partner.soap.sforce.com", "Id").equals(reader.getName())) {
                ...
                if (reader.isStartElement()) {
                    ...
                    while (!loopDone4) {
                        ...
                        if (javax.xml.stream.XMLStreamConstants.START_ELEMENT == event) {
                            ...
                            org.apache.axis2.databinding.utils.NamedStaxOMBuilder builder4 = new org.apache.axis2.databinding.utils.NamedStaxOMBuilder(
                    ...
                    object.setExtraElement((org.apache.axiom.om.OMElement[]) org.apache.axis2.databinding.utils.ConverterUtil
                            .convertToArray(org.apache.axiom.om.OMElement.class, list4));
