...
public class QueryMore implements org.apache.axis2.databinding.ADBBean {
    ...
    public void serialize(final javax.xml.namespace.QName parentQName, javax.xml.stream.XMLStreamWriter xmlWriter,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix + ":queryMore",
                        xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "queryMore", xmlWriter);
            }
        ...
        localQueryLocator.serialize(new javax.xml.namespace.QName("urn:partner.soap.sforce.com", "queryLocator"), xmlWriter);
    ...
    public static class Factory {
        ...
        public static QueryMore parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            QueryMore object = new QueryMore();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"queryMore".equals(type)) {
                            ...
                            return (QueryMore) com.salesforce.soap.partner.sobject.ExtensionMapper.getTypeObject(nsUri, type,
                                    reader);
                        }
