...
/**
 * DescribeComponentInstanceProperty bean class
 */
@SuppressWarnings({ "unchecked", "unused" })
public class DescribeComponentInstanceProperty implements org.apache.axis2.databinding.ADBBean {
    /*
     * This type was generated from the piece of schema that had name = DescribeComponentInstanceProperty Namespace URI =
    ...
    protected com.salesforce.soap.partner.DescribeFlexiPageRegion localRegion;
     ...
     */
    public com.salesforce.soap.partner.DescribeFlexiPageRegion getRegion() {
        return localRegion;
    }
     ...
     * @param param Region
     */
    public void setRegion(com.salesforce.soap.partner.DescribeFlexiPageRegion param) {
    ...
    public void serialize(final javax.xml.namespace.QName parentQName, javax.xml.stream.XMLStreamWriter xmlWriter,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix
                        + ":DescribeComponentInstanceProperty", xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "DescribeComponentInstanceProperty",
                        xmlWriter);
            }
        ...
        if (localRegion == null) {
            ...
            writeStartElement(null, "urn:partner.soap.sforce.com", "region", xmlWriter);

            // write the nil attribute
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "nil", "1", xmlWriter);
            xmlWriter.writeEndElement();
        } else {
            localRegion.serialize(new javax.xml.namespace.QName("urn:partner.soap.sforce.com", "region"), xmlWriter);
        }
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
        ...
        elementList.add(new javax.xml.namespace.QName("urn:partner.soap.sforce.com", "region"));

        elementList.add(localRegion == null ? null : localRegion);
    ...
    public static class Factory {
         ...
         */
        public static DescribeComponentInstanceProperty parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            DescribeComponentInstanceProperty object = new DescribeComponentInstanceProperty();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"DescribeComponentInstanceProperty".equals(type)) {
                            // find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (DescribeComponentInstanceProperty) com.salesforce.soap.partner.sobject.ExtensionMapper
                ...
                if (reader.isStartElement()
                        && new javax.xml.namespace.QName("urn:partner.soap.sforce.com", "region").equals(reader.getName())) {
                    ...
                    if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
                        ...
                        object.setRegion(com.salesforce.soap.partner.DescribeFlexiPageRegion.Factory.parse(reader));
