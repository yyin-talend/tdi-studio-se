...
/**
 * DescribeSearchScopeOrderResult bean class
 */
@SuppressWarnings({ "unchecked", "unused" })
public class DescribeSearchScopeOrderResult implements org.apache.axis2.databinding.ADBBean {
    /*
     * This type was generated from the piece of schema that had name = DescribeSearchScopeOrderResult Namespace URI =
    ...
    public void serialize(final javax.xml.namespace.QName parentQName, javax.xml.stream.XMLStreamWriter xmlWriter,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix
                        + ":DescribeSearchScopeOrderResult", xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "DescribeSearchScopeOrderResult",
                        xmlWriter);
            }
        ...
        if (localKeyPrefix == null) {
            ...
            throw new org.apache.axis2.databinding.ADBException("keyPrefix cannot be null!!");
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
        ...
        if (localKeyPrefix != null) {
            elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localKeyPrefix));
        } else {
            throw new org.apache.axis2.databinding.ADBException("keyPrefix cannot be null!!");
        }
    ...
    public static class Factory {
         ...
         */
        public static DescribeSearchScopeOrderResult parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            DescribeSearchScopeOrderResult object = new DescribeSearchScopeOrderResult();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"DescribeSearchScopeOrderResult".equals(type)) {
                            // find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (DescribeSearchScopeOrderResult) com.salesforce.soap.partner.sobject.ExtensionMapper
                ...
                if (reader.isStartElement()
                    ...
                    if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
                        throw new org.apache.axis2.databinding.ADBException("The element: " + "keyPrefix" + "  cannot be null");
                    }
