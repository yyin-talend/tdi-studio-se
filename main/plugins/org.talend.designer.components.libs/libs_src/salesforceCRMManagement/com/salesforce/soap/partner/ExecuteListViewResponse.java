...
/**
 * ExecuteListViewResponse bean class
 */
@SuppressWarnings({ "unchecked", "unused" })
public class ExecuteListViewResponse implements org.apache.axis2.databinding.ADBBean {

    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("urn:partner.soap.sforce.com",
            "executeListViewResponse", "ns1");

    /**
     * field for Result
     */

    protected com.salesforce.soap.partner.ExecuteListViewResult localResult;
     ...
     * 
     * @return com.salesforce.soap.partner.ExecuteListViewResult
     */
    public com.salesforce.soap.partner.ExecuteListViewResult getResult() {
        return localResult;
    }
     ...
     * @param param Result
     */
    public void setResult(com.salesforce.soap.partner.ExecuteListViewResult param) {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix
                        + ":executeListViewResponse", xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "executeListViewResponse", xmlWriter);
            }
    ...
    public static class Factory {
         ...
         */
        public static ExecuteListViewResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            ExecuteListViewResponse object = new ExecuteListViewResponse();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"executeListViewResponse".equals(type)) {
                            // find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (ExecuteListViewResponse) com.salesforce.soap.partner.sobject.ExtensionMapper.getTypeObject(
                                    nsUri, type, reader);
                        }
                ...
                if (reader.isStartElement()
                    ...
                    object.setResult(com.salesforce.soap.partner.ExecuteListViewResult.Factory.parse(reader));
