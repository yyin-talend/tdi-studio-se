...
public class DescribeSObjects implements org.apache.axis2.databinding.ADBBean {

    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("urn:partner.soap.sforce.com",
            "describeSObjects", "ns1");

    /**
     * field for SObjectType This was an Array!
     */
    ...
    public void setSObjectType(java.lang.String[] param) {
        ...
        localSObjectTypeTracker = param != null;
    ...
    public void addSObjectType(java.lang.String param) {
        ...
        java.util.List list = org.apache.axis2.databinding.utils.ConverterUtil.toList(localSObjectType);
        list.add(param);
        this.localSObjectType = (java.lang.String[]) list.toArray(new java.lang.String[list.size()]);
    ...
    public void serialize(final javax.xml.namespace.QName parentQName, javax.xml.stream.XMLStreamWriter xmlWriter,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix + ":describeSObjects",
                        xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "describeSObjects", xmlWriter);
            }
                ...
                for (int i = 0; i < localSObjectType.length; i++) {
                    ...
                    if (localSObjectType[i] != null) {
                        ...
                        xmlWriter.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil
                                .convertToString(localSObjectType[i]));
            ...
            if (localSObjectType != null) {
                for (int i = 0; i < localSObjectType.length; i++) {
                    ...
                    if (localSObjectType[i] != null) {
                        ...
                        elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localSObjectType[i]));
                    } else {
    ...
    public static class Factory {
        ...
        public static DescribeSObjects parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            DescribeSObjects object = new DescribeSObjects();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"describeSObjects".equals(type)) {
                            ...
                            return (DescribeSObjects) com.salesforce.soap.partner.sobject.ExtensionMapper.getTypeObject(nsUri,
                                    type, reader);
                        }
                ...
                if (reader.isStartElement()
                    ...
                    while (!loopDone1) {
                        ...
                        if (reader.isEndElement()) {
                            ...
                            if (new javax.xml.namespace.QName("urn:partner.soap.sforce.com", "sObjectType").equals(reader
                                    .getName())) {
                                list1.add(reader.getElementText());
                    ...
                    object.setSObjectType((java.lang.String[]) list1.toArray(new java.lang.String[list1.size()]));
