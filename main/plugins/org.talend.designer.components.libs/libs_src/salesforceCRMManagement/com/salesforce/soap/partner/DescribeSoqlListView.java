...
/**
 * DescribeSoqlListView bean class
 */
@SuppressWarnings({ "unchecked", "unused" })
public class DescribeSoqlListView implements org.apache.axis2.databinding.ADBBean {
    /*
     * This type was generated from the piece of schema that had name = DescribeSoqlListView Namespace URI = urn:partner.soap.sforce.com
    ...
    /**
     * field for WhereCondition
     */

    protected com.salesforce.soap.partner.SoqlWhereCondition localWhereCondition;
     ...
     */
    protected boolean localWhereConditionTracker = false;

    public boolean isWhereConditionSpecified() {
        return localWhereConditionTracker;
    }

    /**
     * Auto generated getter method
     * 
     * @return com.salesforce.soap.partner.SoqlWhereCondition
     */
    public com.salesforce.soap.partner.SoqlWhereCondition getWhereCondition() {
        return localWhereCondition;
    }
     ...
     */
    public void setWhereCondition(com.salesforce.soap.partner.SoqlWhereCondition param) {
        localWhereConditionTracker = param != null;

        this.localWhereCondition = param;
    ...
    public void serialize(final javax.xml.namespace.QName parentQName, javax.xml.stream.XMLStreamWriter xmlWriter,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix
                        + ":DescribeSoqlListView", xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "DescribeSoqlListView", xmlWriter);
            }
        ...
        xmlWriter.writeEndElement();
        if (localWhereConditionTracker) {
            if (localWhereCondition == null) {
                throw new org.apache.axis2.databinding.ADBException("whereCondition cannot be null!!");
            }
            localWhereCondition.serialize(new javax.xml.namespace.QName("urn:partner.soap.sforce.com", "whereCondition"),
                    xmlWriter);
        }
        xmlWriter.writeEndElement();
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
        ...
        elementList.add(new javax.xml.namespace.QName("urn:partner.soap.sforce.com", "query"));
        ...
        elementList.add(new javax.xml.namespace.QName("urn:partner.soap.sforce.com", "scope"));

        elementList.add(localScope == null ? null : org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localScope));
        ...
        if (localWhereConditionTracker) {
            elementList.add(new javax.xml.namespace.QName("urn:partner.soap.sforce.com", "whereCondition"));

            if (localWhereCondition == null) {
                throw new org.apache.axis2.databinding.ADBException("whereCondition cannot be null!!");
            }
            elementList.add(localWhereCondition);
        }
    ...
    public static class Factory {
         ...
         */
        public static DescribeSoqlListView parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            DescribeSoqlListView object = new DescribeSoqlListView();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"DescribeSoqlListView".equals(type)) {
                            // find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (DescribeSoqlListView) com.salesforce.soap.partner.sobject.ExtensionMapper.getTypeObject(
                                    nsUri, type, reader);
                        }
                ...
                if (reader.isStartElement()
                    ...
                    // Process the array and step past its final element's end.
                    list3.add(com.salesforce.soap.partner.ListViewOrderBy.Factory.parse(reader));
                    ...
                    object.setOrderBy((com.salesforce.soap.partner.ListViewOrderBy[]) org.apache.axis2.databinding.utils.ConverterUtil
                            .convertToArray(com.salesforce.soap.partner.ListViewOrderBy.class, list3));
                ...
                if (reader.isStartElement()
                        && new javax.xml.namespace.QName("urn:partner.soap.sforce.com", "query").equals(reader.getName())) {
                ...
                if (reader.isStartElement()
                        && new javax.xml.namespace.QName("urn:partner.soap.sforce.com", "scope").equals(reader.getName())) {
                ...
                if (reader.isStartElement()
                        && new javax.xml.namespace.QName("urn:partner.soap.sforce.com", "whereCondition")
                                .equals(reader.getName())) {

                    object.setWhereCondition(com.salesforce.soap.partner.SoqlWhereCondition.Factory.parse(reader));
