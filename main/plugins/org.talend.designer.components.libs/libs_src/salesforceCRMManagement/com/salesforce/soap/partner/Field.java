...
public class Field implements org.apache.axis2.databinding.ADBBean {
	 ...
	 * Namespace URI = urn:partner.soap.sforce.com Namespace Prefix = ns1
	 */
	 ...
	 */
	protected void validatePicklistValues(
			com.salesforce.soap.partner.PicklistEntry[] param) {
	 ...
	 * 
	 * @param param
	 *            com.salesforce.soap.partner.PicklistEntry
	 */
	public void addPicklistValues(
			com.salesforce.soap.partner.PicklistEntry param) {
		...
		java.util.List list = org.apache.axis2.databinding.utils.ConverterUtil
				.toList(localPicklistValues);
		list.add(param);
		this.localPicklistValues = (com.salesforce.soap.partner.PicklistEntry[]) list
				.toArray(new com.salesforce.soap.partner.PicklistEntry[list
						.size()]);
	...
	public void addReferenceTo(java.lang.String param) {
		...
		java.util.List list = org.apache.axis2.databinding.utils.ConverterUtil
				.toList(localReferenceTo);
		list.add(param);
		this.localReferenceTo = (java.lang.String[]) list
	...
	public void serialize(final javax.xml.namespace.QName parentQName,
		...
		if (false) {
			...
			throw new org.apache.axis2.databinding.ADBException(
					"autoNumber cannot be null!!");

		} else {
			xmlWriter
					.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil
							.convertToString(localAutoNumber));
		}
		...
		if (localByteLength == java.lang.Integer.MIN_VALUE) {
			...
			throw new org.apache.axis2.databinding.ADBException(
					"byteLength cannot be null!!");

		} else {
			xmlWriter
					.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil
							.convertToString(localByteLength));
		}
		...
		if (false) {
			...
			throw new org.apache.axis2.databinding.ADBException(
					"calculated cannot be null!!");

		} else {
			xmlWriter
					.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil
							.convertToString(localCalculated));
		}
		...
		if (localCalculatedFormulaTracker) {
			...
			if (localCalculatedFormula == null) {
				...
				throw new org.apache.axis2.databinding.ADBException(
						"calculatedFormula cannot be null!!");
		...
		if (localCascadeDeleteTracker) {
			...
			if (false) {
				...
				throw new org.apache.axis2.databinding.ADBException(
						"cascadeDelete cannot be null!!");

			} else {
				xmlWriter
						.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil
								.convertToString(localCascadeDelete));
			}
		...
		if (false) {
			...
			throw new org.apache.axis2.databinding.ADBException(
					"caseSensitive cannot be null!!");

		} else {
			xmlWriter
					.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil
							.convertToString(localCaseSensitive));
		}
		...
		if (false) {
			...
			throw new org.apache.axis2.databinding.ADBException(
					"createable cannot be null!!");

		} else {
			xmlWriter
					.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil
							.convertToString(localCreateable));
		}
		...
		if (false) {
			...
			throw new org.apache.axis2.databinding.ADBException(
					"custom cannot be null!!");

		} else {
			xmlWriter
					.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil
							.convertToString(localCustom));
		}
		...
		if (localDefaultValueFormulaTracker) {
			...
			if (localDefaultValueFormula == null) {
				...
				throw new org.apache.axis2.databinding.ADBException(
						"defaultValueFormula cannot be null!!");
		...
		if (false) {
			...
			throw new org.apache.axis2.databinding.ADBException(
					"defaultedOnCreate cannot be null!!");

		} else {
			xmlWriter
					.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil
							.convertToString(localDefaultedOnCreate));
		}
		...
		if (localDependentPicklistTracker) {
			...
			if (false) {
				...
				throw new org.apache.axis2.databinding.ADBException(
						"dependentPicklist cannot be null!!");
		...
		if (false) {
			...
			throw new org.apache.axis2.databinding.ADBException(
					"deprecatedAndHidden cannot be null!!");

		} else {
			xmlWriter
					.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil
							.convertToString(localDeprecatedAndHidden));
		}
		...
		if (localDigits == java.lang.Integer.MIN_VALUE) {
			...
			xmlWriter
					.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil
							.convertToString(localDigits));
		}

		xmlWriter.writeEndElement();
		if (localDisplayLocationInDecimalTracker) {
			namespace = "urn:partner.soap.sforce.com";
			writeStartElement(null, namespace, "displayLocationInDecimal",
					xmlWriter);

			if (false) {

				throw new org.apache.axis2.databinding.ADBException(
						"displayLocationInDecimal cannot be null!!");
		...
		if (false) {
			...
			throw new org.apache.axis2.databinding.ADBException(
					"filterable cannot be null!!");

		} else {
			xmlWriter
					.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil
							.convertToString(localFilterable));
		}
		...
		if (false) {
			...
			throw new org.apache.axis2.databinding.ADBException(
					"groupable cannot be null!!");

		} else {
			xmlWriter
					.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil
							.convertToString(localGroupable));
		}
		...
		if (localHtmlFormattedTracker) {
			...
			if (false) {
				...
				throw new org.apache.axis2.databinding.ADBException(
						"htmlFormatted cannot be null!!");

			} else {
				xmlWriter
						.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil
								.convertToString(localHtmlFormatted));
			}
		...
		if (false) {
			...
			throw new org.apache.axis2.databinding.ADBException(
					"idLookup cannot be null!!");

		} else {
			xmlWriter
					.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil
							.convertToString(localIdLookup));
		}
		...
		if (false) {
			...
			xmlWriter
					.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil
							.convertToString(localNameField));
		}
		...
		if (localNamePointingTracker) {
			...
			if (false) {
				...
				throw new org.apache.axis2.databinding.ADBException(
						"namePointing cannot be null!!");

			} else {
				xmlWriter
						.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil
								.convertToString(localNamePointing));
			}
		...
		if (false) {
			...
			throw new org.apache.axis2.databinding.ADBException(
					"permissionable cannot be null!!");

		} else {
			xmlWriter
					.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil
							.convertToString(localPermissionable));
		}
			...
			if (localPicklistValues != null) {
				for (int i = 0; i < localPicklistValues.length; i++) {
					if (localPicklistValues[i] != null) {
						localPicklistValues[i].serialize(
								new javax.xml.namespace.QName(
										"urn:partner.soap.sforce.com",
										"picklistValues"), xmlWriter);
					} else {

						writeStartElement(null, "urn:partner.soap.sforce.com",
								"picklistValues", xmlWriter);
		...
		if (localPrecision == java.lang.Integer.MIN_VALUE) {
			...
			xmlWriter
					.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil
							.convertToString(localPrecision));
		}
			...
			if (localReferenceTo != null) {
				...
				for (int i = 0; i < localReferenceTo.length; i++) {
					...
					if (localReferenceTo[i] != null) {
						...
						writeStartElement(null, namespace, "referenceTo",
								xmlWriter);
		...
		if (localRelationshipNameTracker) {
			...
			if (localRelationshipName == null) {
				...
				throw new org.apache.axis2.databinding.ADBException(
						"relationshipName cannot be null!!");
		...
		if (localRelationshipOrderTracker) {
			...
			if (localRelationshipOrder == java.lang.Integer.MIN_VALUE) {
				...
				throw new org.apache.axis2.databinding.ADBException(
						"relationshipOrder cannot be null!!");
		...
		if (localRestrictedDeleteTracker) {
			...
			if (false) {
				...
				throw new org.apache.axis2.databinding.ADBException(
						"restrictedDelete cannot be null!!");

			} else {
				xmlWriter
						.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil
								.convertToString(localRestrictedDelete));
			}
		...
		if (false) {
			...
			throw new org.apache.axis2.databinding.ADBException(
					"restrictedPicklist cannot be null!!");

		} else {
			xmlWriter
					.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil
							.convertToString(localRestrictedPicklist));
		}
		...
		if (localSoapType == null) {
			throw new org.apache.axis2.databinding.ADBException(
					"soapType cannot be null!!");
		}
		localSoapType.serialize(new javax.xml.namespace.QName(
				"urn:partner.soap.sforce.com", "soapType"), xmlWriter);
		if (localSortableTracker) {
			...
			if (false) {
				...
				throw new org.apache.axis2.databinding.ADBException(
						"sortable cannot be null!!");

			} else {
				xmlWriter
						.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil
								.convertToString(localSortable));
			}
		...
		localType.serialize(new javax.xml.namespace.QName(
				"urn:partner.soap.sforce.com", "type"), xmlWriter);
		...
		if (false) {
			...
			throw new org.apache.axis2.databinding.ADBException(
					"updateable cannot be null!!");

		} else {
			xmlWriter
					.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil
							.convertToString(localUpdateable));
		}

		xmlWriter.writeEndElement();
		if (localWriteRequiresMasterReadTracker) {
			namespace = "urn:partner.soap.sforce.com";
			writeStartElement(null, namespace, "writeRequiresMasterRead",
					xmlWriter);

			if (false) {

				throw new org.apache.axis2.databinding.ADBException(
						"writeRequiresMasterRead cannot be null!!");
	...
	public javax.xml.stream.XMLStreamReader getPullParser(
		...
		elementList.add(new javax.xml.namespace.QName(
				"urn:partner.soap.sforce.com", "autoNumber"));

		elementList.add(org.apache.axis2.databinding.utils.ConverterUtil
				.convertToString(localAutoNumber));

		elementList.add(new javax.xml.namespace.QName(
				"urn:partner.soap.sforce.com", "byteLength"));

		elementList.add(org.apache.axis2.databinding.utils.ConverterUtil
				.convertToString(localByteLength));

		elementList.add(new javax.xml.namespace.QName(
				"urn:partner.soap.sforce.com", "calculated"));

		elementList.add(org.apache.axis2.databinding.utils.ConverterUtil
				.convertToString(localCalculated));
		if (localCalculatedFormulaTracker) {
			elementList.add(new javax.xml.namespace.QName(
					"urn:partner.soap.sforce.com", "calculatedFormula"));

			if (localCalculatedFormula != null) {
				elementList
						.add(org.apache.axis2.databinding.utils.ConverterUtil
								.convertToString(localCalculatedFormula));
			} else {
				throw new org.apache.axis2.databinding.ADBException(
						"calculatedFormula cannot be null!!");
			}
		...
		elementList.add(new javax.xml.namespace.QName(
				"urn:partner.soap.sforce.com", "caseSensitive"));

		elementList.add(org.apache.axis2.databinding.utils.ConverterUtil
				.convertToString(localCaseSensitive));
		if (localControllerNameTracker) {
			elementList.add(new javax.xml.namespace.QName(
					"urn:partner.soap.sforce.com", "controllerName"));

			if (localControllerName != null) {
				elementList
						.add(org.apache.axis2.databinding.utils.ConverterUtil
								.convertToString(localControllerName));
			} else {
				throw new org.apache.axis2.databinding.ADBException(
						"controllerName cannot be null!!");
			}
		...
		elementList.add(new javax.xml.namespace.QName(
				"urn:partner.soap.sforce.com", "createable"));

		elementList.add(org.apache.axis2.databinding.utils.ConverterUtil
				.convertToString(localCreateable));

		elementList.add(new javax.xml.namespace.QName(
				"urn:partner.soap.sforce.com", "custom"));

		elementList.add(org.apache.axis2.databinding.utils.ConverterUtil
				.convertToString(localCustom));
		if (localDefaultValueFormulaTracker) {
			elementList.add(new javax.xml.namespace.QName(
					"urn:partner.soap.sforce.com", "defaultValueFormula"));

			if (localDefaultValueFormula != null) {
				elementList
						.add(org.apache.axis2.databinding.utils.ConverterUtil
								.convertToString(localDefaultValueFormula));
			} else {
				throw new org.apache.axis2.databinding.ADBException(
						"defaultValueFormula cannot be null!!");
			}
		...
		elementList.add(new javax.xml.namespace.QName(
				"urn:partner.soap.sforce.com", "defaultedOnCreate"));

		elementList.add(org.apache.axis2.databinding.utils.ConverterUtil
				.convertToString(localDefaultedOnCreate));
		if (localDependentPicklistTracker) {
			elementList.add(new javax.xml.namespace.QName(
					"urn:partner.soap.sforce.com", "dependentPicklist"));
		...
		elementList.add(new javax.xml.namespace.QName(
				"urn:partner.soap.sforce.com", "digits"));

		elementList.add(org.apache.axis2.databinding.utils.ConverterUtil
				.convertToString(localDigits));
		if (localDisplayLocationInDecimalTracker) {
			elementList.add(new javax.xml.namespace.QName(
					"urn:partner.soap.sforce.com", "displayLocationInDecimal"));
		...
		if (localExternalIdTracker) {
			elementList.add(new javax.xml.namespace.QName(
					"urn:partner.soap.sforce.com", "externalId"));

			elementList.add(org.apache.axis2.databinding.utils.ConverterUtil
					.convertToString(localExternalId));
		}
		elementList.add(new javax.xml.namespace.QName(
				"urn:partner.soap.sforce.com", "filterable"));

		elementList.add(org.apache.axis2.databinding.utils.ConverterUtil
				.convertToString(localFilterable));

		elementList.add(new javax.xml.namespace.QName(
				"urn:partner.soap.sforce.com", "groupable"));

		elementList.add(org.apache.axis2.databinding.utils.ConverterUtil
				.convertToString(localGroupable));
		if (localHtmlFormattedTracker) {
			elementList.add(new javax.xml.namespace.QName(
					"urn:partner.soap.sforce.com", "htmlFormatted"));

			elementList.add(org.apache.axis2.databinding.utils.ConverterUtil
					.convertToString(localHtmlFormatted));
		}
		elementList.add(new javax.xml.namespace.QName(
				"urn:partner.soap.sforce.com", "idLookup"));

		elementList.add(org.apache.axis2.databinding.utils.ConverterUtil
				.convertToString(localIdLookup));
		if (localInlineHelpTextTracker) {
			elementList.add(new javax.xml.namespace.QName(
					"urn:partner.soap.sforce.com", "inlineHelpText"));

			if (localInlineHelpText != null) {
				elementList
						.add(org.apache.axis2.databinding.utils.ConverterUtil
								.convertToString(localInlineHelpText));
			} else {
				throw new org.apache.axis2.databinding.ADBException(
						"inlineHelpText cannot be null!!");
			}
		...
		elementList.add(new javax.xml.namespace.QName(
				"urn:partner.soap.sforce.com", "label"));

		if (localLabel != null) {
			elementList.add(org.apache.axis2.databinding.utils.ConverterUtil
					.convertToString(localLabel));
		} else {
			throw new org.apache.axis2.databinding.ADBException(
					"label cannot be null!!");
		}
		...
		elementList.add(new javax.xml.namespace.QName(
				"urn:partner.soap.sforce.com", "length"));

		elementList.add(org.apache.axis2.databinding.utils.ConverterUtil
				.convertToString(localLength));

		elementList.add(new javax.xml.namespace.QName(
				"urn:partner.soap.sforce.com", "name"));
		...
		elementList.add(new javax.xml.namespace.QName(
				"urn:partner.soap.sforce.com", "nameField"));

		elementList.add(org.apache.axis2.databinding.utils.ConverterUtil
				.convertToString(localNameField));
		if (localNamePointingTracker) {
			elementList.add(new javax.xml.namespace.QName(
					"urn:partner.soap.sforce.com", "namePointing"));

			elementList.add(org.apache.axis2.databinding.utils.ConverterUtil
					.convertToString(localNamePointing));
		}
		elementList.add(new javax.xml.namespace.QName(
				"urn:partner.soap.sforce.com", "nillable"));

		elementList.add(org.apache.axis2.databinding.utils.ConverterUtil
				.convertToString(localNillable));

		elementList.add(new javax.xml.namespace.QName(
				"urn:partner.soap.sforce.com", "permissionable"));
		...
		if (localPicklistValuesTracker) {
			if (localPicklistValues != null) {
				...
				elementList.add(new javax.xml.namespace.QName(
						"urn:partner.soap.sforce.com", "picklistValues"));
		...
		if (localReferenceToTracker) {
			if (localReferenceTo != null) {
				for (int i = 0; i < localReferenceTo.length; i++) {
					...
					if (localReferenceTo[i] != null) {
						elementList.add(new javax.xml.namespace.QName(
								"urn:partner.soap.sforce.com", "referenceTo"));
						elementList
								.add(org.apache.axis2.databinding.utils.ConverterUtil
										.convertToString(localReferenceTo[i]));
					} else {
		...
		if (localRelationshipNameTracker) {
			...
			if (localRelationshipName != null) {
				elementList
						.add(org.apache.axis2.databinding.utils.ConverterUtil
								.convertToString(localRelationshipName));
			} else {
				throw new org.apache.axis2.databinding.ADBException(
						"relationshipName cannot be null!!");
			}
		...
		if (localRelationshipOrderTracker) {
			elementList.add(new javax.xml.namespace.QName(
					"urn:partner.soap.sforce.com", "relationshipOrder"));
		...
		elementList.add(new javax.xml.namespace.QName(
				"urn:partner.soap.sforce.com", "restrictedPicklist"));

		elementList.add(org.apache.axis2.databinding.utils.ConverterUtil
				.convertToString(localRestrictedPicklist));

		elementList.add(new javax.xml.namespace.QName(
				"urn:partner.soap.sforce.com", "scale"));
		...
		if (localSortableTracker) {
			elementList.add(new javax.xml.namespace.QName(
					"urn:partner.soap.sforce.com", "sortable"));
		...
		elementList.add(new javax.xml.namespace.QName(
				"urn:partner.soap.sforce.com", "unique"));

		elementList.add(org.apache.axis2.databinding.utils.ConverterUtil
				.convertToString(localUnique));

		elementList.add(new javax.xml.namespace.QName(
				"urn:partner.soap.sforce.com", "updateable"));

		elementList.add(org.apache.axis2.databinding.utils.ConverterUtil
				.convertToString(localUpdateable));
		if (localWriteRequiresMasterReadTracker) {
			elementList.add(new javax.xml.namespace.QName(
					"urn:partner.soap.sforce.com", "writeRequiresMasterRead"));
		...
		public static Field parse(javax.xml.stream.XMLStreamReader reader)
			...
			try {
						...
						if (!"Field".equals(type)) {
							...
							java.lang.String nsUri = reader
									.getNamespaceContext().getNamespaceURI(
											nsPrefix);
							return (Field) com.salesforce.soap.partner.sobject.ExtensionMapper
				...
				while (!reader.isEndElement()
						|| !new javax.xml.namespace.QName(
								"urn:partner.soap.sforce.com", "fields")
					...
					if (reader.isStartElement()
						...
						object.setType(com.salesforce.soap.partner.FieldType.Factory
								.parse(reader));
						...
						object.setPrecision(org.apache.axis2.databinding.utils.ConverterUtil
						...
						object.setNillable(org.apache.axis2.databinding.utils.ConverterUtil
						...
						reader.next();
							...
							&& new javax.xml.namespace.QName(
									"urn:partner.soap.sforce.com",
									"defaultValueFormula").equals(reader
									.getName())) {

						java.lang.String content = reader.getElementText();

						object.setDefaultValueFormula(org.apache.axis2.databinding.utils.ConverterUtil
								.convertToString(content));
				...
				// && new
				// javax.xml.namespace.QName("urn:partner.soap.sforce.com",
				// "calculatedFormula").equals(reader
				// .getName())) {
				//
				// nillableValue =
				// reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",
				...
				// && new
				// javax.xml.namespace.QName("urn:partner.soap.sforce.com",
				// "defaultedOnCreate").equals(reader
				// .getName())) {
				//
				// nillableValue =
				// reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",
				...
				// && new
				// javax.xml.namespace.QName("urn:partner.soap.sforce.com",
				// "dependentPicklist").equals(reader
				// .getName())) {
				//
				// nillableValue =
				// reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",
				...
				// && new
				// javax.xml.namespace.QName("urn:partner.soap.sforce.com",
				// "deprecatedAndHidden").equals(reader
				// .getName())) {
				//
				// nillableValue =
				// reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",
				...
				// && new
				// javax.xml.namespace.QName("urn:partner.soap.sforce.com",
				// "idLookup").equals(reader.getName()))
				// {
				//
				// nillableValue =
				// reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",
				...
				// reader.next();
				// } else {
				// list27.add(com.salesforce.soap.partner.PicklistEntry.Factory.parse(reader));
				// }
				...
				// org.apache.axis2.databinding.utils.ConverterUtil
				// .convertToArray(com.salesforce.soap.partner.PicklistEntry.class,
				// list27));
				//
				// } // End of if for expected property start element
				//
				...
				// reader.next();
				// } else {
				// list29.add(reader.getElementText());
				// }
				// // loop until we find a start element that is not part of
				// this array
				...
				// // call the converter utility to convert and set the array
				//
				// object.setReferenceTo((java.lang.String[]) list29.toArray(new
				// java.lang.String[list29.size()]));
				//
				// } // End of if for expected property start element
				//
				// else {
				...
				// && new
				// javax.xml.namespace.QName("urn:partner.soap.sforce.com",
				// "relationshipName").equals(reader
				// .getName())) {
				//
				// nillableValue =
				// reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",
				...
				// && new
				// javax.xml.namespace.QName("urn:partner.soap.sforce.com",
				// "relationshipOrder").equals(reader
				// .getName())) {
				//
				// nillableValue =
				// reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",
				...
				// && new
				// javax.xml.namespace.QName("urn:partner.soap.sforce.com",
				// "restrictedPicklist").equals(reader
				// .getName())) {
				//
				// nillableValue =
				// reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",
				...
				// && new
				// javax.xml.namespace.QName("urn:partner.soap.sforce.com",
				// "soapType").equals(reader.getName()))
				// {
				//
				...
				// && new
				// javax.xml.namespace.QName("urn:partner.soap.sforce.com",
				// "sortable").equals(reader.getName()))
				// {
				//
				// nillableValue =
				// reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",
