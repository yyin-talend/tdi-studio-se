...
/**
 * DescribeCompactLayoutsResponse bean class
 */
@SuppressWarnings({ "unchecked", "unused" })
public class DescribeCompactLayoutsResponse implements org.apache.axis2.databinding.ADBBean {

    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("urn:partner.soap.sforce.com",
            "describeCompactLayoutsResponse", "ns1");

    /**
     * field for Result
     */

    protected com.salesforce.soap.partner.DescribeCompactLayoutsResult localResult;

    /**
     * Auto generated getter method
     * 
     * @return com.salesforce.soap.partner.DescribeCompactLayoutsResult
     */
    public com.salesforce.soap.partner.DescribeCompactLayoutsResult getResult() {
        return localResult;
    }
     ...
     * @param param Result
     */
    public void setResult(com.salesforce.soap.partner.DescribeCompactLayoutsResult param) {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix
                        + ":describeCompactLayoutsResponse", xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "describeCompactLayoutsResponse",
                        xmlWriter);
            }
    ...
    public static class Factory {
         ...
         */
        public static DescribeCompactLayoutsResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            DescribeCompactLayoutsResponse object = new DescribeCompactLayoutsResponse();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"describeCompactLayoutsResponse".equals(type)) {
                            // find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (DescribeCompactLayoutsResponse) com.salesforce.soap.partner.sobject.ExtensionMapper
                ...
                if (reader.isStartElement()
                    ...
                    if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
                        ...
                        object.setResult(com.salesforce.soap.partner.DescribeCompactLayoutsResult.Factory.parse(reader));
