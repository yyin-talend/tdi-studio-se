...
public class SearchResult implements org.apache.axis2.databinding.ADBBean {
    ...
    public boolean isSearchRecordsSpecified() {
        return localSearchRecordsTracker;
    }

    /**
     * Auto generated getter method
     * 
     * @return com.salesforce.soap.partner.SearchRecord[]
     */
    public com.salesforce.soap.partner.SearchRecord[] getSearchRecords() {
     ...
     */
    protected void validateSearchRecords(com.salesforce.soap.partner.SearchRecord[] param) {
     ...
     */
    public void setSearchRecords(com.salesforce.soap.partner.SearchRecord[] param) {

        validateSearchRecords(param);

        localSearchRecordsTracker = param != null;
     ...
     * 
     * @param param com.salesforce.soap.partner.SearchRecord
     */
    public void addSearchRecords(com.salesforce.soap.partner.SearchRecord param) {
        if (localSearchRecords == null) {
            localSearchRecords = new com.salesforce.soap.partner.SearchRecord[] {};
        }

        // update the setting tracker
        localSearchRecordsTracker = true;

        java.util.List list = org.apache.axis2.databinding.utils.ConverterUtil.toList(localSearchRecords);
        list.add(param);
        this.localSearchRecords = (com.salesforce.soap.partner.SearchRecord[]) list
                .toArray(new com.salesforce.soap.partner.SearchRecord[list.size()]);
    ...
    public void serialize(final javax.xml.namespace.QName parentQName, javax.xml.stream.XMLStreamWriter xmlWriter,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix + ":SearchResult",
                        xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "SearchResult", xmlWriter);
            }
            ...
            if (localSearchRecords != null) {
                for (int i = 0; i < localSearchRecords.length; i++) {
                    if (localSearchRecords[i] != null) {
                        localSearchRecords[i].serialize(new javax.xml.namespace.QName("urn:partner.soap.sforce.com",
                                "searchRecords"), xmlWriter);
                    } else {
        ...
        if (localSearchRecordsTracker) {
            if (localSearchRecords != null) {
                for (int i = 0; i < localSearchRecords.length; i++) {
                    ...
                    if (localSearchRecords[i] != null) {
                        elementList.add(new javax.xml.namespace.QName("urn:partner.soap.sforce.com", "searchRecords"));
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"SearchResult".equals(type)) {
                            ...
                            return (SearchResult) com.salesforce.soap.partner.sobject.ExtensionMapper.getTypeObject(nsUri, type,
                                    reader);
                        }
