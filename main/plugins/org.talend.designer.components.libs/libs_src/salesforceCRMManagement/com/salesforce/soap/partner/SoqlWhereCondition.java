...
/**
 * SoqlWhereCondition bean class
 */
@SuppressWarnings({ "unchecked", "unused" })
public class SoqlWhereCondition implements org.apache.axis2.databinding.ADBBean {
    /*
     * This type was generated from the piece of schema that had name = SoqlWhereCondition Namespace URI = urn:partner.soap.sforce.com
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix
                        + ":SoqlWhereCondition", xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "SoqlWhereCondition", xmlWriter);
            }
    ...
    public static class Factory {
         ...
         */
        public static SoqlWhereCondition parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            SoqlWhereCondition object = new SoqlWhereCondition();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"SoqlWhereCondition".equals(type)) {
                            // find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (SoqlWhereCondition) com.salesforce.soap.partner.sobject.ExtensionMapper.getTypeObject(nsUri,
                                    type, reader);
                        }
