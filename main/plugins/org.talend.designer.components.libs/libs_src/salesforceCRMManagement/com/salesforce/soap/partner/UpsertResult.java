...
public class UpsertResult implements org.apache.axis2.databinding.ADBBean {

    /*
     * This type was generated from the piece of schema that had name = UpsertResult Namespace URI =
    ...
    public void serialize(final javax.xml.namespace.QName parentQName, javax.xml.stream.XMLStreamWriter xmlWriter,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix + ":UpsertResult",
                        xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "UpsertResult", xmlWriter);
            }
    ...
    public static class Factory {
        ...
        public static UpsertResult parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            UpsertResult object = new UpsertResult();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"UpsertResult".equals(type)) {
                            ...
                            return (UpsertResult) com.salesforce.soap.partner.sobject.ExtensionMapper.getTypeObject(nsUri, type,
                                    reader);
                        }
                ...
                if (reader.isStartElement()
                    ...
                    list2.add(com.salesforce.soap.partner.Error.Factory.parse(reader));
                    ...
                    object.setErrors((com.salesforce.soap.partner.Error[]) org.apache.axis2.databinding.utils.ConverterUtil
                            .convertToArray(com.salesforce.soap.partner.Error.class, list2));
