...
public class GetDeletedResult implements org.apache.axis2.databinding.ADBBean {
    ...
    /**
     * field for DeletedRecords This was an Array!
     */
    ...
    public boolean isDeletedRecordsSpecified() {
        return localDeletedRecordsTracker;
    }

    /**
     * Auto generated getter method
     * 
     * @return com.salesforce.soap.partner.DeletedRecord[]
     */
    public com.salesforce.soap.partner.DeletedRecord[] getDeletedRecords() {
     ...
     */
    protected void validateDeletedRecords(com.salesforce.soap.partner.DeletedRecord[] param) {
     ...
     */
    public void setDeletedRecords(com.salesforce.soap.partner.DeletedRecord[] param) {

        validateDeletedRecords(param);

        localDeletedRecordsTracker = param != null;
     ...
     * 
     * @param param com.salesforce.soap.partner.DeletedRecord
     */
    public void addDeletedRecords(com.salesforce.soap.partner.DeletedRecord param) {
        if (localDeletedRecords == null) {
            localDeletedRecords = new com.salesforce.soap.partner.DeletedRecord[] {};
        }

        // update the setting tracker
        localDeletedRecordsTracker = true;

        java.util.List list = org.apache.axis2.databinding.utils.ConverterUtil.toList(localDeletedRecords);
        list.add(param);
        this.localDeletedRecords = (com.salesforce.soap.partner.DeletedRecord[]) list
                .toArray(new com.salesforce.soap.partner.DeletedRecord[list.size()]);
    ...
    public void serialize(final javax.xml.namespace.QName parentQName, javax.xml.stream.XMLStreamWriter xmlWriter,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix + ":GetDeletedResult",
                        xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "GetDeletedResult", xmlWriter);
            }
            ...
            if (localDeletedRecords != null) {
                for (int i = 0; i < localDeletedRecords.length; i++) {
                    if (localDeletedRecords[i] != null) {
                        localDeletedRecords[i].serialize(new javax.xml.namespace.QName("urn:partner.soap.sforce.com",
                                "deletedRecords"), xmlWriter);
                    } else {
        ...
        writeStartElement(null, namespace, "earliestDateAvailable", xmlWriter);
        ...
        if (localEarliestDateAvailable == null) {
            ...
            xmlWriter.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil
                    .convertToString(localEarliestDateAvailable));
        ...
        namespace = "urn:partner.soap.sforce.com";
        writeStartElement(null, namespace, "latestDateCovered", xmlWriter);
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
        ...
        if (localDeletedRecordsTracker) {
            if (localDeletedRecords != null) {
                for (int i = 0; i < localDeletedRecords.length; i++) {
                    ...
                    if (localDeletedRecords[i] != null) {
                        elementList.add(new javax.xml.namespace.QName("urn:partner.soap.sforce.com", "deletedRecords"));
        ...
        elementList.add(new javax.xml.namespace.QName("urn:partner.soap.sforce.com", "earliestDateAvailable"));
        ...
        elementList.add(new javax.xml.namespace.QName("urn:partner.soap.sforce.com", "latestDateCovered"));
        ...
        public static GetDeletedResult parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"GetDeletedResult".equals(type)) {
                            ...
                            return (GetDeletedResult) com.salesforce.soap.partner.sobject.ExtensionMapper.getTypeObject(nsUri,
                                    type, reader);
                        }
                ...
                if (reader.isStartElement()
                        && new javax.xml.namespace.QName("urn:partner.soap.sforce.com", "deletedRecords")
                                .equals(reader.getName())) {

                    // Process the array and step past its final element's end.
                    list1.add(com.salesforce.soap.partner.DeletedRecord.Factory.parse(reader));
                    ...
                    while (!loopDone1) {
                        ...
                        if (reader.isEndElement()) {
                            ...
                            if (new javax.xml.namespace.QName("urn:partner.soap.sforce.com", "deletedRecords").equals(reader
                                    .getName())) {
                                list1.add(com.salesforce.soap.partner.DeletedRecord.Factory.parse(reader));
                ...
                if (reader.isStartElement()
                        && new javax.xml.namespace.QName("urn:partner.soap.sforce.com", "earliestDateAvailable").equals(reader
                                .getName())) {

                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "nil");
                    if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
                        throw new org.apache.axis2.databinding.ADBException("The element: " + "earliestDateAvailable"
                                + "  cannot be null");
                    }
                ...
                if (reader.isStartElement()
                        && new javax.xml.namespace.QName("urn:partner.soap.sforce.com", "latestDateCovered").equals(reader
                                .getName())) {

                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "nil");
                    if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
                        throw new org.apache.axis2.databinding.ADBException("The element: " + "latestDateCovered"
                                + "  cannot be null");
                    }
