...
public class SearchRecord implements org.apache.axis2.databinding.ADBBean {
    ...
    protected com.salesforce.soap.partner.sobject.SObject localRecord;
     ...
     */
    public com.salesforce.soap.partner.sobject.SObject getRecord() {
        return localRecord;
    }
     ...
     * @param param Record
     */
    public void setRecord(com.salesforce.soap.partner.sobject.SObject param) {
    ...
    public void serialize(final javax.xml.namespace.QName parentQName, javax.xml.stream.XMLStreamWriter xmlWriter,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix + ":SearchRecord",
                        xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "SearchRecord", xmlWriter);
            }
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
        ...
        elementList.add(new javax.xml.namespace.QName("urn:partner.soap.sforce.com", "record"));
        ...
        public static SearchRecord parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"SearchRecord".equals(type)) {
                            ...
                            return (SearchRecord) com.salesforce.soap.partner.sobject.ExtensionMapper.getTypeObject(nsUri, type,
                                    reader);
                        }
                ...
                if (reader.isStartElement()
                        && new javax.xml.namespace.QName("urn:partner.soap.sforce.com", "record").equals(reader.getName())) {

                    object.setRecord(com.salesforce.soap.partner.sobject.SObject.Factory.parse(reader));
