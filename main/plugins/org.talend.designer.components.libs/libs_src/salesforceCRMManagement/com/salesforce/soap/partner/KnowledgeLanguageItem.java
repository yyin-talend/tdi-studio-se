...
/**
 * KnowledgeLanguageItem bean class
 */
@SuppressWarnings({ "unchecked", "unused" })
public class KnowledgeLanguageItem implements org.apache.axis2.databinding.ADBBean {
    /*
     * This type was generated from the piece of schema that had name = KnowledgeLanguageItem Namespace URI = urn:partner.soap.sforce.com
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix
                        + ":KnowledgeLanguageItem", xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "KnowledgeLanguageItem", xmlWriter);
            }
    ...
    public static class Factory {
         ...
         */
        public static KnowledgeLanguageItem parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            KnowledgeLanguageItem object = new KnowledgeLanguageItem();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"KnowledgeLanguageItem".equals(type)) {
                            // find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (KnowledgeLanguageItem) com.salesforce.soap.partner.sobject.ExtensionMapper.getTypeObject(
                                    nsUri, type, reader);
                        }
