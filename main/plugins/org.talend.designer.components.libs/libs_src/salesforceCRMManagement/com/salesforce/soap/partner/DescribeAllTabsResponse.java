...
/**
 * DescribeAllTabsResponse bean class
 */
@SuppressWarnings({ "unchecked", "unused" })
public class DescribeAllTabsResponse implements org.apache.axis2.databinding.ADBBean {

    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("urn:partner.soap.sforce.com",
            "describeAllTabsResponse", "ns1");

    /**
     * field for Result This was an Array!
     */

    protected com.salesforce.soap.partner.DescribeTab[] localResult;
     ...
     */
    public com.salesforce.soap.partner.DescribeTab[] getResult() {
        return localResult;
    }
     ...
     */
    protected void validateResult(com.salesforce.soap.partner.DescribeTab[] param) {
     ...
     * @param param Result
     */
    public void setResult(com.salesforce.soap.partner.DescribeTab[] param) {
     ...
     */
    public void addResult(com.salesforce.soap.partner.DescribeTab param) {
        if (localResult == null) {
            localResult = new com.salesforce.soap.partner.DescribeTab[] {};
        }
        ...
        list.add(param);
        this.localResult = (com.salesforce.soap.partner.DescribeTab[]) list
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix
                        + ":describeAllTabsResponse", xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "describeAllTabsResponse", xmlWriter);
            }
    ...
    public static class Factory {
         ...
         */
        public static DescribeAllTabsResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            DescribeAllTabsResponse object = new DescribeAllTabsResponse();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"describeAllTabsResponse".equals(type)) {
                            // find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (DescribeAllTabsResponse) com.salesforce.soap.partner.sobject.ExtensionMapper.getTypeObject(
                                    nsUri, type, reader);
                        }
                ...
                if (reader.isStartElement()
                    ...
                    if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
                        ...
                        list1.add(com.salesforce.soap.partner.DescribeTab.Factory.parse(reader));
                    }
                    ...
                    object.setResult((com.salesforce.soap.partner.DescribeTab[]) org.apache.axis2.databinding.utils.ConverterUtil
                            .convertToArray(com.salesforce.soap.partner.DescribeTab.class, list1));
