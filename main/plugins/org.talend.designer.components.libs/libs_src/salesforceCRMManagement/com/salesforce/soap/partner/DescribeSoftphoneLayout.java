...
public class DescribeSoftphoneLayout implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix
                        + ":describeSoftphoneLayout", xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "describeSoftphoneLayout", xmlWriter);
            }
    ...
    public static class Factory {
        ...
        public static DescribeSoftphoneLayout parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            DescribeSoftphoneLayout object = new DescribeSoftphoneLayout();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"describeSoftphoneLayout".equals(type)) {
                            ...
                            return (DescribeSoftphoneLayout) com.salesforce.soap.partner.sobject.ExtensionMapper.getTypeObject(
                                    nsUri, type, reader);
                        }
