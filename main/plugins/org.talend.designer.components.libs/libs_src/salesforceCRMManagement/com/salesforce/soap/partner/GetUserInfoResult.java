    ...
    public void serialize(final javax.xml.namespace.QName parentQName, final org.apache.axiom.om.OMFactory factory,
        ...
        if (!namespace.equals("")) {
            ...
            if (prefix == null) {
                ...
                xmlWriter.writeStartElement(prefix, "orgAttachmentFileSizeLimit", namespace);
                xmlWriter.writeNamespace(prefix, namespace);
                xmlWriter.setPrefix(prefix, namespace);

            } else {
                xmlWriter.writeStartElement(namespace, "orgAttachmentFileSizeLimit");
            }

        } else {
            xmlWriter.writeStartElement("orgAttachmentFileSizeLimit");
        }
        ...
        localOrganizationId.serialize(new javax.xml.namespace.QName("urn:partner.soap.sforce.com", "organizationId"), factory,
                xmlWriter);
        ...
        localProfileId.serialize(new javax.xml.namespace.QName("urn:partner.soap.sforce.com", "profileId"), factory, xmlWriter);
        ...
        if (localRoleId == null) {
            ...
            localRoleId.serialize(new javax.xml.namespace.QName("urn:partner.soap.sforce.com", "roleId"), factory, xmlWriter);
        }
        ...
        if (!namespace.equals("")) {
            ...
            if (prefix == null) {
                ...
                xmlWriter.writeStartElement(prefix, "sessionSecondsValid", namespace);
                xmlWriter.writeNamespace(prefix, namespace);
                xmlWriter.setPrefix(prefix, namespace);

            } else {
                xmlWriter.writeStartElement(namespace, "sessionSecondsValid");
            }

        } else {
            xmlWriter.writeStartElement("sessionSecondsValid");
        }
