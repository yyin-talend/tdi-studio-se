...
/**
 * ListViewOrderBy bean class
 */
@SuppressWarnings({ "unchecked", "unused" })
public class ListViewOrderBy implements org.apache.axis2.databinding.ADBBean {
    /*
     * This type was generated from the piece of schema that had name = ListViewOrderBy Namespace URI = urn:partner.soap.sforce.com
    ...
    /**
     * field for NullsPosition
     */

    protected com.salesforce.soap.partner.OrderByNullsPosition localNullsPosition;

    /**
     * Auto generated getter method
     * 
     * @return com.salesforce.soap.partner.OrderByNullsPosition
     */
    public com.salesforce.soap.partner.OrderByNullsPosition getNullsPosition() {
        return localNullsPosition;
    }

    /**
     * Auto generated setter method
     * 
     * @param param NullsPosition
     */
    public void setNullsPosition(com.salesforce.soap.partner.OrderByNullsPosition param) {

        this.localNullsPosition = param;
    ...
    public void serialize(final javax.xml.namespace.QName parentQName, javax.xml.stream.XMLStreamWriter xmlWriter,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix + ":ListViewOrderBy",
                        xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "ListViewOrderBy", xmlWriter);
            }
        ...
        if (localNullsPosition == null) {

            writeStartElement(null, "urn:partner.soap.sforce.com", "nullsPosition", xmlWriter);
            ...
            localNullsPosition
                    .serialize(new javax.xml.namespace.QName("urn:partner.soap.sforce.com", "nullsPosition"), xmlWriter);
        }
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
        ...
        elementList.add(new javax.xml.namespace.QName("urn:partner.soap.sforce.com", "nullsPosition"));

        elementList.add(localNullsPosition == null ? null : localNullsPosition);
    ...
    public static class Factory {
         ...
         */
        public static ListViewOrderBy parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            ListViewOrderBy object = new ListViewOrderBy();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"ListViewOrderBy".equals(type)) {
                            // find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (ListViewOrderBy) com.salesforce.soap.partner.sobject.ExtensionMapper.getTypeObject(nsUri,
                                    type, reader);
                        }
                ...
                if (reader.isStartElement()
                        && new javax.xml.namespace.QName("urn:partner.soap.sforce.com", "nullsPosition").equals(reader.getName())) {

                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "nil");
                    if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
                        object.setNullsPosition(null);
                        reader.next();
                        ...
                        object.setNullsPosition(com.salesforce.soap.partner.OrderByNullsPosition.Factory.parse(reader));
