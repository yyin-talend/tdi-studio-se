...
/**
 * DescribeApprovalLayoutResponse bean class
 */
@SuppressWarnings({ "unchecked", "unused" })
public class DescribeApprovalLayoutResponse implements org.apache.axis2.databinding.ADBBean {

    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("urn:partner.soap.sforce.com",
            "describeApprovalLayoutResponse", "ns1");

    /**
     * field for Result
     */

    protected com.salesforce.soap.partner.DescribeApprovalLayoutResult localResult;

    /**
     * Auto generated getter method
     * 
     * @return com.salesforce.soap.partner.DescribeApprovalLayoutResult
     */
    public com.salesforce.soap.partner.DescribeApprovalLayoutResult getResult() {
        return localResult;
    }
     ...
     * @param param Result
     */
    public void setResult(com.salesforce.soap.partner.DescribeApprovalLayoutResult param) {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix
                        + ":describeApprovalLayoutResponse", xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "describeApprovalLayoutResponse",
                        xmlWriter);
            }
    ...
    public static class Factory {
         ...
         */
        public static DescribeApprovalLayoutResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            DescribeApprovalLayoutResponse object = new DescribeApprovalLayoutResponse();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"describeApprovalLayoutResponse".equals(type)) {
                            // find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (DescribeApprovalLayoutResponse) com.salesforce.soap.partner.sobject.ExtensionMapper
                ...
                if (reader.isStartElement()
                    ...
                    if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
                        ...
                        object.setResult(com.salesforce.soap.partner.DescribeApprovalLayoutResult.Factory.parse(reader));
