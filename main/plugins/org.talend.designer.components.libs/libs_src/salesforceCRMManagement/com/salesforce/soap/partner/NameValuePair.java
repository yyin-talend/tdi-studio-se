...
/**
 * NameValuePair bean class
 */
@SuppressWarnings({ "unchecked", "unused" })
public class NameValuePair implements org.apache.axis2.databinding.ADBBean {
    /*
     * This type was generated from the piece of schema that had name = NameValuePair Namespace URI = urn:partner.soap.sforce.com Namespace
     * Prefix = ns1
     */
    ...
    public void serialize(final javax.xml.namespace.QName parentQName, javax.xml.stream.XMLStreamWriter xmlWriter,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix + ":NameValuePair",
                        xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "NameValuePair", xmlWriter);
            }
    ...
    public static class Factory {
        ...
        public static NameValuePair parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            NameValuePair object = new NameValuePair();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"NameValuePair".equals(type)) {
                            ...
                            return (NameValuePair) com.salesforce.soap.partner.sobject.ExtensionMapper.getTypeObject(nsUri, type,
                                    reader);
                        }
