...
/**
 * DescribeLayoutFeedFilter bean class
 */
@SuppressWarnings({ "unchecked", "unused" })
public class DescribeLayoutFeedFilter implements org.apache.axis2.databinding.ADBBean {
    /*
     * This type was generated from the piece of schema that had name = DescribeLayoutFeedFilter Namespace URI = urn:partner.soap.sforce.com
    ...
    protected com.salesforce.soap.partner.FeedLayoutFilterType localType;

    /**
     * Auto generated getter method
     * 
     * @return com.salesforce.soap.partner.FeedLayoutFilterType
     */
    public com.salesforce.soap.partner.FeedLayoutFilterType getType() {
        return localType;
    }
     ...
     * @param param Type
     */
    public void setType(com.salesforce.soap.partner.FeedLayoutFilterType param) {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix
                        + ":DescribeLayoutFeedFilter", xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "DescribeLayoutFeedFilter", xmlWriter);
            }
    ...
    public static class Factory {
         ...
         */
        public static DescribeLayoutFeedFilter parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            DescribeLayoutFeedFilter object = new DescribeLayoutFeedFilter();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"DescribeLayoutFeedFilter".equals(type)) {
                            // find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (DescribeLayoutFeedFilter) com.salesforce.soap.partner.sobject.ExtensionMapper.getTypeObject(
                                    nsUri, type, reader);
                        }
                ...
                if (reader.isStartElement()
                    ...
                    object.setType(com.salesforce.soap.partner.FeedLayoutFilterType.Factory.parse(reader));
