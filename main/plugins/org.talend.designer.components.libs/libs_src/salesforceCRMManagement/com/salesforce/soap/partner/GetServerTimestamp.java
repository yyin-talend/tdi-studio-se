...
public class GetServerTimestamp implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix
                        + ":getServerTimestamp", xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "getServerTimestamp", xmlWriter);
            }
    ...
    public static class Factory {
        ...
        public static GetServerTimestamp parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            GetServerTimestamp object = new GetServerTimestamp();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"getServerTimestamp".equals(type)) {
                            ...
                            return (GetServerTimestamp) com.salesforce.soap.partner.sobject.ExtensionMapper.getTypeObject(nsUri,
                                    type, reader);
                        }
