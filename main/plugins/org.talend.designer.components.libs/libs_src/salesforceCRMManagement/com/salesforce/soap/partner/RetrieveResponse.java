...
public class RetrieveResponse implements org.apache.axis2.databinding.ADBBean {
    ...
    protected com.salesforce.soap.partner.sobject.SObject[] localResult;
     ...
     */
    public com.salesforce.soap.partner.sobject.SObject[] getResult() {
        return localResult;
    }
     ...
     */
    protected void validateResult(com.salesforce.soap.partner.sobject.SObject[] param) {
     ...
     * @param param Result
     */
    public void setResult(com.salesforce.soap.partner.sobject.SObject[] param) {
     ...
     */
    public void addResult(com.salesforce.soap.partner.sobject.SObject param) {
        if (localResult == null) {
            localResult = new com.salesforce.soap.partner.sobject.SObject[] {};
        }
        ...
        list.add(param);
        this.localResult = (com.salesforce.soap.partner.sobject.SObject[]) list
    ...
    public void serialize(final javax.xml.namespace.QName parentQName, final org.apache.axiom.om.OMFactory factory,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix + ":retrieveResponse",
                        xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "retrieveResponse", xmlWriter);
            }
    ...
    public static class Factory {
        ...
        public static RetrieveResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            RetrieveResponse object = new RetrieveResponse();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"retrieveResponse".equals(type)) {
                            ...
                            return (RetrieveResponse) com.salesforce.soap.partner.sobject.ExtensionMapper.getTypeObject(nsUri,
                                    type, reader);
                        }
                ...
                if (reader.isStartElement()
                    ...
                    if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
                        ...
                        list1.add(com.salesforce.soap.partner.sobject.SObject.Factory.parse(reader));
                    }
                    ...
                    object.setResult((com.salesforce.soap.partner.sobject.SObject[]) org.apache.axis2.databinding.utils.ConverterUtil
                            .convertToArray(com.salesforce.soap.partner.sobject.SObject.class, list1));
