...
/**
 * DescribeColumn bean class
 */
@SuppressWarnings({ "unchecked", "unused" })
public class DescribeColumn implements org.apache.axis2.databinding.ADBBean {
    /*
     * This type was generated from the piece of schema that had name = DescribeColumn Namespace URI = urn:partner.soap.sforce.com Namespace
     * Prefix = ns1
     */
    ...
    public void serialize(final javax.xml.namespace.QName parentQName, javax.xml.stream.XMLStreamWriter xmlWriter,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix + ":DescribeColumn",
                        xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "DescribeColumn", xmlWriter);
            }
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
        ...
        elementList.add(new javax.xml.namespace.QName("urn:partner.soap.sforce.com", "format"));

        elementList.add(localFormat == null ? null : org.apache.axis2.databinding.utils.ConverterUtil
    ...
    public static class Factory {
         ...
         */
        public static DescribeColumn parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            DescribeColumn object = new DescribeColumn();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"DescribeColumn".equals(type)) {
                            // find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (DescribeColumn) com.salesforce.soap.partner.sobject.ExtensionMapper.getTypeObject(nsUri,
                                    type, reader);
                        }
                ...
                if (reader.isStartElement()
                        && new javax.xml.namespace.QName("urn:partner.soap.sforce.com", "format").equals(reader.getName())) {
                    ...
                    if (!"true".equals(nillableValue) && !"1".equals(nillableValue)) {
                        ...
                        object.setFormat(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(content));
