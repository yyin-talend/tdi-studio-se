...
/**
 * DescribeAppMenuResponse bean class
 */
@SuppressWarnings({ "unchecked", "unused" })
public class DescribeAppMenuResponse implements org.apache.axis2.databinding.ADBBean {

    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("urn:partner.soap.sforce.com",
            "describeAppMenuResponse", "ns1");

    /**
     * field for Result
     */

    protected com.salesforce.soap.partner.DescribeAppMenuResult localResult;

    /**
     * Auto generated getter method
     * 
     * @return com.salesforce.soap.partner.DescribeAppMenuResult
     */
    public com.salesforce.soap.partner.DescribeAppMenuResult getResult() {
        return localResult;
    }
     ...
     * @param param Result
     */
    public void setResult(com.salesforce.soap.partner.DescribeAppMenuResult param) {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix
                        + ":describeAppMenuResponse", xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "describeAppMenuResponse", xmlWriter);
            }
    ...
    public static class Factory {
         ...
         */
        public static DescribeAppMenuResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            DescribeAppMenuResponse object = new DescribeAppMenuResponse();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"describeAppMenuResponse".equals(type)) {
                            // find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (DescribeAppMenuResponse) com.salesforce.soap.partner.sobject.ExtensionMapper.getTypeObject(
                                    nsUri, type, reader);
                        }
                ...
                if (reader.isStartElement()
                    ...
                    if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
                        ...
                        object.setResult(com.salesforce.soap.partner.DescribeAppMenuResult.Factory.parse(reader));
