...
public class ProcessResponse implements org.apache.axis2.databinding.ADBBean {
    ...
    protected com.salesforce.soap.partner.ProcessResult[] localResult;
     ...
     * 
     * @return com.salesforce.soap.partner.ProcessResult[]
     */
    public com.salesforce.soap.partner.ProcessResult[] getResult() {
        return localResult;
    }
     ...
     */
    protected void validateResult(com.salesforce.soap.partner.ProcessResult[] param) {
     ...
     * @param param Result
     */
    public void setResult(com.salesforce.soap.partner.ProcessResult[] param) {
     ...
     * 
     * @param param com.salesforce.soap.partner.ProcessResult
     */
    public void addResult(com.salesforce.soap.partner.ProcessResult param) {
        if (localResult == null) {
            localResult = new com.salesforce.soap.partner.ProcessResult[] {};
        }
        ...
        list.add(param);
        this.localResult = (com.salesforce.soap.partner.ProcessResult[]) list
                .toArray(new com.salesforce.soap.partner.ProcessResult[list.size()]);
    ...
    public void serialize(final javax.xml.namespace.QName parentQName, javax.xml.stream.XMLStreamWriter xmlWriter,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix + ":processResponse",
                        xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "processResponse", xmlWriter);
            }
        ...
        public static ProcessResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"processResponse".equals(type)) {
                            ...
                            return (ProcessResponse) com.salesforce.soap.partner.sobject.ExtensionMapper.getTypeObject(nsUri,
                                    type, reader);
                        }
                ...
                if (reader.isStartElement()
                    ...
                    list1.add(com.salesforce.soap.partner.ProcessResult.Factory.parse(reader));
                    ...
                    object.setResult((com.salesforce.soap.partner.ProcessResult[]) org.apache.axis2.databinding.utils.ConverterUtil
                            .convertToArray(com.salesforce.soap.partner.ProcessResult.class, list1));
