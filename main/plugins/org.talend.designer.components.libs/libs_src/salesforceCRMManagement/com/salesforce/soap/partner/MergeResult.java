...
public class MergeResult implements org.apache.axis2.databinding.ADBBean {

    /*
     * This type was generated from the piece of schema that had name = MergeResult Namespace URI =
    ...
    /**
     * field for MergedRecordIds This was an Array!
     */

    protected com.salesforce.soap.partner.ID[] localMergedRecordIds;
    ...
    public boolean isMergedRecordIdsSpecified() {
        return localMergedRecordIdsTracker;
    }
     ...
     * @return com.salesforce.soap.partner.ID[]
     */
    public com.salesforce.soap.partner.ID[] getMergedRecordIds() {
     ...
     */
    protected void validateMergedRecordIds(com.salesforce.soap.partner.ID[] param) {
     ...
     */
    public void setMergedRecordIds(com.salesforce.soap.partner.ID[] param) {

        validateMergedRecordIds(param);

        localMergedRecordIdsTracker = param != null;
     ...
     */
    public void addMergedRecordIds(com.salesforce.soap.partner.ID param) {
        if (localMergedRecordIds == null) {
            localMergedRecordIds = new com.salesforce.soap.partner.ID[] {};
        }

        // update the setting tracker
        localMergedRecordIdsTracker = true;

        java.util.List list = org.apache.axis2.databinding.utils.ConverterUtil.toList(localMergedRecordIds);
        list.add(param);
        this.localMergedRecordIds = (com.salesforce.soap.partner.ID[]) list.toArray(new com.salesforce.soap.partner.ID[list
                .size()]);
    ...
    /**
     * field for UpdatedRelatedIds This was an Array!
     */

    protected com.salesforce.soap.partner.ID[] localUpdatedRelatedIds;
    ...
    public boolean isUpdatedRelatedIdsSpecified() {
        return localUpdatedRelatedIdsTracker;
    }
     ...
     * @return com.salesforce.soap.partner.ID[]
     */
    public com.salesforce.soap.partner.ID[] getUpdatedRelatedIds() {
     ...
     */
    protected void validateUpdatedRelatedIds(com.salesforce.soap.partner.ID[] param) {
     ...
     */
    public void setUpdatedRelatedIds(com.salesforce.soap.partner.ID[] param) {

        validateUpdatedRelatedIds(param);

        localUpdatedRelatedIdsTracker = param != null;
     ...
     * @param param com.salesforce.soap.partner.ID
     */
    public void addUpdatedRelatedIds(com.salesforce.soap.partner.ID param) {
        if (localUpdatedRelatedIds == null) {
            localUpdatedRelatedIds = new com.salesforce.soap.partner.ID[] {};
        }

        // update the setting tracker
        localUpdatedRelatedIdsTracker = true;

        java.util.List list = org.apache.axis2.databinding.utils.ConverterUtil.toList(localUpdatedRelatedIds);
        list.add(param);
        this.localUpdatedRelatedIds = (com.salesforce.soap.partner.ID[]) list.toArray(new com.salesforce.soap.partner.ID[list
                .size()]);
    ...
    public void serialize(final javax.xml.namespace.QName parentQName, javax.xml.stream.XMLStreamWriter xmlWriter,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix + ":MergeResult",
                        xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "MergeResult", xmlWriter);
            }
            ...
            if (localMergedRecordIds != null) {
                for (int i = 0; i < localMergedRecordIds.length; i++) {
                    if (localMergedRecordIds[i] != null) {
                        localMergedRecordIds[i].serialize(new javax.xml.namespace.QName("urn:partner.soap.sforce.com",
                                "mergedRecordIds"), xmlWriter);
                    } else {
            ...
            if (localUpdatedRelatedIds != null) {
                for (int i = 0; i < localUpdatedRelatedIds.length; i++) {
                    if (localUpdatedRelatedIds[i] != null) {
                        localUpdatedRelatedIds[i].serialize(new javax.xml.namespace.QName("urn:partner.soap.sforce.com",
                                "updatedRelatedIds"), xmlWriter);
                    } else {
        ...
        if (localMergedRecordIdsTracker) {
            if (localMergedRecordIds != null) {
                for (int i = 0; i < localMergedRecordIds.length; i++) {
                    ...
                    if (localMergedRecordIds[i] != null) {
                        elementList.add(new javax.xml.namespace.QName("urn:partner.soap.sforce.com", "mergedRecordIds"));
        ...
        if (localUpdatedRelatedIdsTracker) {
            if (localUpdatedRelatedIds != null) {
                for (int i = 0; i < localUpdatedRelatedIds.length; i++) {
                    ...
                    if (localUpdatedRelatedIds[i] != null) {
                        elementList.add(new javax.xml.namespace.QName("urn:partner.soap.sforce.com", "updatedRelatedIds"));
        ...
        public static MergeResult parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"MergeResult".equals(type)) {
                            ...
                            return (MergeResult) com.salesforce.soap.partner.sobject.ExtensionMapper.getTypeObject(nsUri, type,
                                    reader);
                        }
                ...
                if (reader.isStartElement()
                    ...
                    list1.add(com.salesforce.soap.partner.Error.Factory.parse(reader));
                    ...
                    object.setErrors((com.salesforce.soap.partner.Error[]) org.apache.axis2.databinding.utils.ConverterUtil
                            .convertToArray(com.salesforce.soap.partner.Error.class, list1));
                ...
                if (reader.isStartElement()
                        && new javax.xml.namespace.QName("urn:partner.soap.sforce.com", "mergedRecordIds").equals(reader
                                .getName())) {
                    ...
                    while (!loopDone3) {
                        ...
                        if (reader.isEndElement()) {
                            ...
                            if (new javax.xml.namespace.QName("urn:partner.soap.sforce.com", "mergedRecordIds").equals(reader
                                    .getName())) {
                                list3.add(com.salesforce.soap.partner.ID.Factory.parse(reader));
                    ...
                    object.setMergedRecordIds((com.salesforce.soap.partner.ID[]) org.apache.axis2.databinding.utils.ConverterUtil
                ...
                if (reader.isStartElement()
                        && new javax.xml.namespace.QName("urn:partner.soap.sforce.com", "updatedRelatedIds").equals(reader
                                .getName())) {
                    ...
                    while (!loopDone5) {
                        ...
                        if (reader.isEndElement()) {
                            ...
                            if (new javax.xml.namespace.QName("urn:partner.soap.sforce.com", "updatedRelatedIds").equals(reader
                                    .getName())) {
                                list5.add(com.salesforce.soap.partner.ID.Factory.parse(reader));
                    ...
                    object.setUpdatedRelatedIds((com.salesforce.soap.partner.ID[]) org.apache.axis2.databinding.utils.ConverterUtil
