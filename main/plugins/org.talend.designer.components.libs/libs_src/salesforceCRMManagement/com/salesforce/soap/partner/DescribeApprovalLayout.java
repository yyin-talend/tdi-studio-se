...
/**
 * DescribeApprovalLayout bean class
 */
@SuppressWarnings({ "unchecked", "unused" })
public class DescribeApprovalLayout implements org.apache.axis2.databinding.ADBBean {
    /*
     * This type was generated from the piece of schema that had name = DescribeApprovalLayout Namespace URI = urn:partner.soap.sforce.com
    ...
    /**
     * field for LayoutItems This was an Array!
     */

    protected com.salesforce.soap.partner.DescribeLayoutItem[] localLayoutItems;
     ...
     */
    public com.salesforce.soap.partner.DescribeLayoutItem[] getLayoutItems() {
     ...
     */
    protected void validateLayoutItems(com.salesforce.soap.partner.DescribeLayoutItem[] param) {
     ...
     */
    public void setLayoutItems(com.salesforce.soap.partner.DescribeLayoutItem[] param) {
     ...
     */
    public void addLayoutItems(com.salesforce.soap.partner.DescribeLayoutItem param) {
        if (localLayoutItems == null) {
            localLayoutItems = new com.salesforce.soap.partner.DescribeLayoutItem[] {};
        }

        java.util.List list = org.apache.axis2.databinding.utils.ConverterUtil.toList(localLayoutItems);
        list.add(param);
        this.localLayoutItems = (com.salesforce.soap.partner.DescribeLayoutItem[]) list
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
        ...
        if (localLayoutItems != null) {
            for (int i = 0; i < localLayoutItems.length; i++) {
                ...
                if (localLayoutItems[i] != null) {
                    elementList.add(new javax.xml.namespace.QName("urn:partner.soap.sforce.com", "layoutItems"));
    ...
    public static class Factory {
         ...
         */
        public static DescribeApprovalLayout parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            DescribeApprovalLayout object = new DescribeApprovalLayout();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"DescribeApprovalLayout".equals(type)) {
                            ...
                            return (DescribeApprovalLayout) com.salesforce.soap.partner.sobject.ExtensionMapper.getTypeObject(
                                    nsUri, type, reader);
                        }
                ...
                if (reader.isStartElement()
                        && new javax.xml.namespace.QName("urn:partner.soap.sforce.com", "layoutItems").equals(reader.getName())) {

                    // Process the array and step past its final element's end.
                    list3.add(com.salesforce.soap.partner.DescribeLayoutItem.Factory.parse(reader));
                    ...
                    while (!loopDone3) {
                        ...
                        if (reader.isEndElement()) {
                            ...
                            if (new javax.xml.namespace.QName("urn:partner.soap.sforce.com", "layoutItems").equals(reader
                                    .getName())) {
                                list3.add(com.salesforce.soap.partner.DescribeLayoutItem.Factory.parse(reader));
                    ...
                    object.setLayoutItems((com.salesforce.soap.partner.DescribeLayoutItem[]) org.apache.axis2.databinding.utils.ConverterUtil
                            .convertToArray(com.salesforce.soap.partner.DescribeLayoutItem.class, list3));
