...
public class Upsert implements org.apache.axis2.databinding.ADBBean {
    ...
    protected com.salesforce.soap.partner.sobject.SObject[] localSObjects;
    ...
    public boolean isSObjectsSpecified() {
        return localSObjectsTracker;
    }
     ...
     */
    public com.salesforce.soap.partner.sobject.SObject[] getSObjects() {
     ...
     */
    protected void validateSObjects(com.salesforce.soap.partner.sobject.SObject[] param) {
     ...
     */
    public void setSObjects(com.salesforce.soap.partner.sobject.SObject[] param) {

        validateSObjects(param);

        localSObjectsTracker = param != null;
     ...
     */
    public void addSObjects(com.salesforce.soap.partner.sobject.SObject param) {
        if (localSObjects == null) {
            localSObjects = new com.salesforce.soap.partner.sobject.SObject[] {};
        }
        ...
        list.add(param);
        this.localSObjects = (com.salesforce.soap.partner.sobject.SObject[]) list
    ...
    public void serialize(final javax.xml.namespace.QName parentQName, javax.xml.stream.XMLStreamWriter xmlWriter,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix + ":upsert", xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "upsert", xmlWriter);
            }

        }

        namespace = "urn:partner.soap.sforce.com";
        writeStartElement(null, namespace, "externalIDFieldName", xmlWriter);
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
        ...
        elementList.add(new javax.xml.namespace.QName("urn:partner.soap.sforce.com", "externalIDFieldName"));
        ...
        public static Upsert parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"upsert".equals(type)) {
                            ...
                            return (Upsert) com.salesforce.soap.partner.sobject.ExtensionMapper
                ...
                if (reader.isStartElement()
                        && new javax.xml.namespace.QName("urn:partner.soap.sforce.com", "externalIDFieldName").equals(reader
                                .getName())) {

                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "nil");
                    if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
                        throw new org.apache.axis2.databinding.ADBException("The element: " + "externalIDFieldName"
                                + "  cannot be null");
                    }

                    java.lang.String content = reader.getElementText();

                    object.setExternalIDFieldName(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(content));
                ...
                if (reader.isStartElement()
                    ...
                    list2.add(com.salesforce.soap.partner.sobject.SObject.Factory.parse(reader));
                    ...
                    object.setSObjects((com.salesforce.soap.partner.sobject.SObject[]) org.apache.axis2.databinding.utils.ConverterUtil
                            .convertToArray(com.salesforce.soap.partner.sobject.SObject.class, list2));
