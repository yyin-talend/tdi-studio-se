...
/**
 * DescribeAvailableQuickActionResult bean class
 */
@SuppressWarnings({ "unchecked", "unused" })
public class DescribeAvailableQuickActionResult implements org.apache.axis2.databinding.ADBBean {
    /*
     * This type was generated from the piece of schema that had name = DescribeAvailableQuickActionResult Namespace URI =
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix
                        + ":DescribeAvailableQuickActionResult", xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "DescribeAvailableQuickActionResult",
                        xmlWriter);
            }
    ...
    public static class Factory {
         ...
         */
        public static DescribeAvailableQuickActionResult parse(javax.xml.stream.XMLStreamReader reader)
                throws java.lang.Exception {
            DescribeAvailableQuickActionResult object = new DescribeAvailableQuickActionResult();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"DescribeAvailableQuickActionResult".equals(type)) {
                            // find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (DescribeAvailableQuickActionResult) com.salesforce.soap.partner.sobject.ExtensionMapper
