...
public class ProcessResult implements org.apache.axis2.databinding.ADBBean {
    ...
    public void serialize(final javax.xml.namespace.QName parentQName, final org.apache.axiom.om.OMFactory factory,
        ...
        if (localEntityId == null) {
            ...
            localEntityId.serialize(new javax.xml.namespace.QName("urn:partner.soap.sforce.com", "entityId"), factory, xmlWriter);
        }
        ...
        if (localInstanceId == null) {
            ...
            localInstanceId.serialize(new javax.xml.namespace.QName("urn:partner.soap.sforce.com", "instanceId"), factory,
                    xmlWriter);
        }
                ...
                for (int i = 0; i < localNewWorkitemIds.length; i++) {
                    if (localNewWorkitemIds[i] != null) {
                        localNewWorkitemIds[i].serialize(new javax.xml.namespace.QName("urn:partner.soap.sforce.com",
                                "newWorkitemIds"), factory, xmlWriter);
                    } else {
