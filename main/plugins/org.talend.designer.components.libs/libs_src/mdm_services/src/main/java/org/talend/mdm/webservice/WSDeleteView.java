...
public class WSDeleteView  implements java.io.Serializable {
    ...
    /**
     * Gets the wsViewPK value for this WSDeleteView.
     * 
     * @return wsViewPK
     */
    ...
    /**
     * Sets the wsViewPK value for this WSDeleteView.
     * 
     * @param wsViewPK
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof WSDeleteView)) return false;
        WSDeleteView other = (WSDeleteView) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(WSDeleteView.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn-com-amalto-xtentis-webservice", "WSDeleteView"));
