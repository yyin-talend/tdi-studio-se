/**
 * WSVersioningGetUniverseVersions.java
 *
 ...
 */
public class WSVersioningGetUniverseVersions  implements java.io.Serializable {
    ...
    /**
     * Gets the versioningSystemName value for this WSVersioningGetUniverseVersions.
     * 
    ...
    /**
     * Sets the versioningSystemName value for this WSVersioningGetUniverseVersions.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof WSVersioningGetUniverseVersions)) return false;
        WSVersioningGetUniverseVersions other = (WSVersioningGetUniverseVersions) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(WSVersioningGetUniverseVersions.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn-com-amalto-xtentis-webservice", "WSVersioningGetUniverseVersions"));
