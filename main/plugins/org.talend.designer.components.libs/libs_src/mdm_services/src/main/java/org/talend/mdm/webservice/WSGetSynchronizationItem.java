...
public class WSGetSynchronizationItem  implements java.io.Serializable {
    ...
    /**
     * Gets the wsSynchronizationItemPK value for this WSGetSynchronizationItem.
     * 
    ...
    /**
     * Sets the wsSynchronizationItemPK value for this WSGetSynchronizationItem.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof WSGetSynchronizationItem)) return false;
        WSGetSynchronizationItem other = (WSGetSynchronizationItem) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(WSGetSynchronizationItem.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn-com-amalto-xtentis-webservice", "WSGetSynchronizationItem"));
