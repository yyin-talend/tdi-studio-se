/**
 * WSGetVersioningSystemConfiguration.java
 *
 ...
 */
public class WSGetVersioningSystemConfiguration  implements java.io.Serializable {
    ...
    /**
     * Gets the versioningSystemName value for this WSGetVersioningSystemConfiguration.
     * 
    ...
    /**
     * Sets the versioningSystemName value for this WSGetVersioningSystemConfiguration.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof WSGetVersioningSystemConfiguration)) return false;
        WSGetVersioningSystemConfiguration other = (WSGetVersioningSystemConfiguration) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(WSGetVersioningSystemConfiguration.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn-com-amalto-xtentis-webservice", "WSGetVersioningSystemConfiguration"));
