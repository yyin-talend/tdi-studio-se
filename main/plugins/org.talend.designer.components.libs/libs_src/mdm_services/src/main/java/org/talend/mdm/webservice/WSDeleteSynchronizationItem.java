/**
 * WSDeleteSynchronizationItem.java
 *
...
public class WSDeleteSynchronizationItem  implements java.io.Serializable {
    ...
    /**
     * Gets the wsSynchronizationItemPK value for this WSDeleteSynchronizationItem.
     * 
    ...
    /**
     * Sets the wsSynchronizationItemPK value for this WSDeleteSynchronizationItem.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof WSDeleteSynchronizationItem)) return false;
        WSDeleteSynchronizationItem other = (WSDeleteSynchronizationItem) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(WSDeleteSynchronizationItem.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn-com-amalto-xtentis-webservice", "WSDeleteSynchronizationItem"));
