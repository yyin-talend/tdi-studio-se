/**
 * WSExistsSynchronizationItem.java
 *
...
public class WSExistsSynchronizationItem  implements java.io.Serializable {
    ...
    /**
     * Gets the wsSynchronizationItemPK value for this WSExistsSynchronizationItem.
     * 
    ...
    /**
     * Sets the wsSynchronizationItemPK value for this WSExistsSynchronizationItem.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof WSExistsSynchronizationItem)) return false;
        WSExistsSynchronizationItem other = (WSExistsSynchronizationItem) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(WSExistsSynchronizationItem.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn-com-amalto-xtentis-webservice", "WSExistsSynchronizationItem"));
