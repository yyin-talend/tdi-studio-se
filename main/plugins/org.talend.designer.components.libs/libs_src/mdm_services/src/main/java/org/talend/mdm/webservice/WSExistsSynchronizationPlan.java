/**
 * WSExistsSynchronizationPlan.java
 *
...
public class WSExistsSynchronizationPlan  implements java.io.Serializable {
    ...
    /**
     * Gets the wsSynchronizationPlanPK value for this WSExistsSynchronizationPlan.
     * 
    ...
    /**
     * Sets the wsSynchronizationPlanPK value for this WSExistsSynchronizationPlan.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof WSExistsSynchronizationPlan)) return false;
        WSExistsSynchronizationPlan other = (WSExistsSynchronizationPlan) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(WSExistsSynchronizationPlan.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn-com-amalto-xtentis-webservice", "WSExistsSynchronizationPlan"));
