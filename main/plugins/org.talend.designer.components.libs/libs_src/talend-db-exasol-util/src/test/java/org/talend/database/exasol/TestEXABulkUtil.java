...
public class TestEXABulkUtil {
	...
	public void testImport() throws Exception {
		...
		u.addCSVColumn("ID", null, null);
		u.addCSVColumn("FIRSTNAME", null, null);
		u.addCSVColumn("LASTNAME", null, null);
		u.addCSVColumn("BIRTHDATE", null, "yyyy-MM-dd");
		u.addCSVColumn("CITY", null, null);
		u.addCSVColumn("GENDER", null, null);
		u.addCSVColumn("AGE", null, null);
