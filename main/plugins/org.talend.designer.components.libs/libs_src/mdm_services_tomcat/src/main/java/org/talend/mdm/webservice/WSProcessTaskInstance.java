...
public class WSProcessTaskInstance  implements java.io.Serializable {
    ...
    /**
     * Gets the id value for this WSProcessTaskInstance.
     * 
     * @return id
     */
    public long getId() {
    ...
    /**
     * Sets the id value for this WSProcessTaskInstance.
     * 
     * @param id
     */
    ...
    /**
     * Gets the state value for this WSProcessTaskInstance.
     * 
     * @return state
     */
    ...
    /**
     * Sets the state value for this WSProcessTaskInstance.
     * 
     * @param state
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.talend.com/mdm", "WSProcessTaskInstance"));
