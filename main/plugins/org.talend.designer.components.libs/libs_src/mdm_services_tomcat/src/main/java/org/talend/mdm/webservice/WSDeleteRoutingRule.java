...
public class WSDeleteRoutingRule  implements java.io.Serializable {
    ...
    /**
     * Gets the wsRoutingRulePK value for this WSDeleteRoutingRule.
     * 
    ...
    /**
     * Sets the wsRoutingRulePK value for this WSDeleteRoutingRule.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof WSDeleteRoutingRule)) return false;
        WSDeleteRoutingRule other = (WSDeleteRoutingRule) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(WSDeleteRoutingRule.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.talend.com/mdm", "WSDeleteRoutingRule"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.talend.com/mdm", "WSRoutingRulePK"));
