...
public class WSPutRole  implements java.io.Serializable {
    private org.talend.mdm.webservice.WSRole wsRole;

    public WSPutRole() {
    }

    public WSPutRole(
           org.talend.mdm.webservice.WSRole wsRole) {
           this.wsRole = wsRole;
    }
     ...
     * @return wsRole
     */
    public org.talend.mdm.webservice.WSRole getWsRole() {
        return wsRole;
    }
     ...
     * @param wsRole
     */
    public void setWsRole(org.talend.mdm.webservice.WSRole wsRole) {
        this.wsRole = wsRole;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.talend.com/mdm", "WSPutRole"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("wsRole");
        elemField.setXmlName(new javax.xml.namespace.QName("", "wsRole"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.talend.com/mdm", "WSRole"));
