...
public class WSPutRoutingRule  implements java.io.Serializable {
    private org.talend.mdm.webservice.WSRoutingRule wsRoutingRule;

    public WSPutRoutingRule() {
    }

    public WSPutRoutingRule(
           org.talend.mdm.webservice.WSRoutingRule wsRoutingRule) {
     ...
     */
    public org.talend.mdm.webservice.WSRoutingRule getWsRoutingRule() {
        return wsRoutingRule;
    }
     ...
     * @param wsRoutingRule
     */
    public void setWsRoutingRule(org.talend.mdm.webservice.WSRoutingRule wsRoutingRule) {
        this.wsRoutingRule = wsRoutingRule;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.talend.com/mdm", "WSPutRoutingRule"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("wsRoutingRule");
        elemField.setXmlName(new javax.xml.namespace.QName("", "wsRoutingRule"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.talend.com/mdm", "WSRoutingRule"));
