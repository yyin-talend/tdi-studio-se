...
public class ParamsImportToList  implements java.io.Serializable {
     ...
     */
    public void setImportListMode(com.marketo.www.mktows.ImportToListModeEnum importListMode) {
        this.importListMode = importListMode;
    }
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ParamsImportToList)) return false;
        ...
        _equals = true && 
            ...
            ((this.importFileHeader==null && other.getImportFileHeader()==null) || 
             (this.importFileHeader!=null &&
              this.importFileHeader.equals(other.getImportFileHeader()))) &&
            ((this.importFileRows==null && other.getImportFileRows()==null) || 
             (this.importFileRows!=null &&
              java.util.Arrays.equals(this.importFileRows, other.getImportFileRows()))) &&
            ((this.importListMode==null && other.getImportListMode()==null) || 
             (this.importListMode!=null &&
              this.importListMode.equals(other.getImportListMode()))) &&
    ...
    public synchronized int hashCode() {
        ...
        if (getImportFileRows() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getImportFileRows());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getImportFileRows(), i);
                if (obj != null &&
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ParamsImportToList.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.marketo.com/mktows/", "ParamsImportToList"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("", "importFileHeader"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("importFileRows");
        elemField.setXmlName(new javax.xml.namespace.QName("", "importFileRows"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setNillable(false);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("", "importListMode"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.marketo.com/mktows/", "ImportToListModeEnum"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
