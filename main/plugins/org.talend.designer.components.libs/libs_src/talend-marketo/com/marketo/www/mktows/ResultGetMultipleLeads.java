...
public class ResultGetMultipleLeads  implements java.io.Serializable {
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ResultGetMultipleLeads)) return false;
        ...
        _equals = true && 
            ...
            ((this.leadRecordList==null && other.getLeadRecordList()==null) || 
             (this.leadRecordList!=null &&
              java.util.Arrays.equals(this.leadRecordList, other.getLeadRecordList())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getLeadRecordList() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getLeadRecordList());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getLeadRecordList(), i);
                if (obj != null &&
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ResultGetMultipleLeads.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.marketo.com/mktows/", "ResultGetMultipleLeads"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("", "leadRecordList"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.marketo.com/mktows/", "LeadRecord"));
