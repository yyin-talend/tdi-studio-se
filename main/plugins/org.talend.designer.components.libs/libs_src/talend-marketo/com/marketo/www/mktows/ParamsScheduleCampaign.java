...
public class ParamsScheduleCampaign  implements java.io.Serializable {
    ...
    public ParamsScheduleCampaign(
           ...
           java.util.Calendar campaignRunAt,
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ParamsScheduleCampaign)) return false;
        ...
        _equals = true && 
            ...
            ((this.campaignRunAt==null && other.getCampaignRunAt()==null) || 
             (this.campaignRunAt!=null &&
              this.campaignRunAt.equals(other.getCampaignRunAt()))) &&
            ((this.programTokenList==null && other.getProgramTokenList()==null) || 
             (this.programTokenList!=null &&
              java.util.Arrays.equals(this.programTokenList, other.getProgramTokenList())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getProgramTokenList() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getProgramTokenList());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getProgramTokenList(), i);
                if (obj != null &&
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ParamsScheduleCampaign.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.marketo.com/mktows/", "ParamsScheduleCampaign"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("", "campaignRunAt"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("", "programTokenList"));
