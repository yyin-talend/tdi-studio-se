...
public class LeadKeyRef implements java.io.Serializable {
    ...
    public static final LeadKeyRef LEADOWNEREMAIL = new LeadKeyRef(_LEADOWNEREMAIL);
    public static final LeadKeyRef SFDCACCOUNTID = new LeadKeyRef(_SFDCACCOUNTID);
    public static final LeadKeyRef SFDCCONTACTID = new LeadKeyRef(_SFDCCONTACTID);
    public static final LeadKeyRef SFDCLEADID = new LeadKeyRef(_SFDCLEADID);
    public static final LeadKeyRef SFDCLEADOWNERID = new LeadKeyRef(_SFDCLEADOWNERID);
    ...
    public static LeadKeyRef fromValue(java.lang.String value)
        ...
        LeadKeyRef enumeration = (LeadKeyRef)
            _table_.get(value);
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(LeadKeyRef.class);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.marketo.com/mktows/", "LeadKeyRef"));
    }
    /**
