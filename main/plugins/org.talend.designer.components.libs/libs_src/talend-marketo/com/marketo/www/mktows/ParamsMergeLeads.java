...
public class ParamsMergeLeads  implements java.io.Serializable {
     ...
     */
    public void setWinningLeadKeyList(com.marketo.www.mktows.Attribute[] winningLeadKeyList) {
        this.winningLeadKeyList = winningLeadKeyList;
    }
     ...
     */
    public void setLosingLeadKeyLists(com.marketo.www.mktows.Attribute[][] losingLeadKeyLists) {
        this.losingLeadKeyLists = losingLeadKeyLists;
    }

    private java.lang.Object __equalsCalc = null;
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ParamsMergeLeads)) return false;
        ...
        boolean _equals;
        _equals = true && 
            ((this.winningLeadKeyList==null && other.getWinningLeadKeyList()==null) || 
             (this.winningLeadKeyList!=null &&
              java.util.Arrays.equals(this.winningLeadKeyList, other.getWinningLeadKeyList()))) &&
            ((this.losingLeadKeyLists==null && other.getLosingLeadKeyLists()==null) || 
             (this.losingLeadKeyLists!=null &&
              java.util.Arrays.equals(this.losingLeadKeyLists, other.getLosingLeadKeyLists())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getWinningLeadKeyList() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getWinningLeadKeyList());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getWinningLeadKeyList(), i);
                if (obj != null &&
        ...
        if (getLosingLeadKeyLists() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getLosingLeadKeyLists());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getLosingLeadKeyLists(), i);
                if (obj != null &&
                    !obj.getClass().isArray()) {
                    _hashCode += obj.hashCode();
                }
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ParamsMergeLeads.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.marketo.com/mktows/", "ParamsMergeLeads"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("winningLeadKeyList");
        elemField.setXmlName(new javax.xml.namespace.QName("", "winningLeadKeyList"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("", "losingLeadKeyLists"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.marketo.com/mktows/", "ArrayOfAttribute"));
        elemField.setNillable(false);
