...
public class ParamsSyncMObjects  implements java.io.Serializable {
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ParamsSyncMObjects)) return false;
        ...
        boolean _equals;
        _equals = true && 
            ((this.mObjectList==null && other.getMObjectList()==null) || 
             (this.mObjectList!=null &&
              java.util.Arrays.equals(this.mObjectList, other.getMObjectList()))) &&
    ...
    public synchronized int hashCode() {
        ...
        if (getMObjectList() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getMObjectList());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getMObjectList(), i);
                if (obj != null &&
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ParamsSyncMObjects.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.marketo.com/mktows/", "ParamsSyncMObjects"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("MObjectList");
        elemField.setXmlName(new javax.xml.namespace.QName("", "mObjectList"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.marketo.com/mktows/", "MObject"));
