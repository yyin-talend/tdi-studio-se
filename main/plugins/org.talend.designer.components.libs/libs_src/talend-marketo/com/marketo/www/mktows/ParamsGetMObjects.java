...
public class ParamsGetMObjects  implements java.io.Serializable {
     ...
     */
    public void setMObjCriteriaList(com.marketo.www.mktows.MObjCriteria[] mObjCriteriaList) {
        this.mObjCriteriaList = mObjCriteriaList;
    }
     ...
     */
    public void setMObjAssociationList(com.marketo.www.mktows.MObjAssociation[] mObjAssociationList) {
        this.mObjAssociationList = mObjAssociationList;
    }
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ParamsGetMObjects)) return false;
        ...
        _equals = true && 
            ...
            ((this.mObjCriteriaList==null && other.getMObjCriteriaList()==null) || 
             (this.mObjCriteriaList!=null &&
              java.util.Arrays.equals(this.mObjCriteriaList, other.getMObjCriteriaList()))) &&
    ...
    public synchronized int hashCode() {
        ...
        if (getMObjCriteriaList() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getMObjCriteriaList());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getMObjCriteriaList(), i);
                if (obj != null &&
        ...
        if (getMObjAssociationList() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getMObjAssociationList());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getMObjAssociationList(), i);
                if (obj != null &&
                    !obj.getClass().isArray()) {
                    _hashCode += obj.hashCode();
                }
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ParamsGetMObjects.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.marketo.com/mktows/", "ParamsGetMObjects"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("", "mObjCriteriaList"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.marketo.com/mktows/", "MObjCriteria"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setItemQName(new javax.xml.namespace.QName("", "mObjCriteria"));
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("MObjAssociationList");
        elemField.setXmlName(new javax.xml.namespace.QName("", "mObjAssociationList"));
