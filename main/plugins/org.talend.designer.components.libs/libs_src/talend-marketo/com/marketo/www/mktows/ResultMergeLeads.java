...
public class ResultMergeLeads  implements java.io.Serializable {
    ...
    public ResultMergeLeads(
           com.marketo.www.mktows.MergeStatus mergeStatus) {
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ResultMergeLeads)) return false;
        ...
        boolean _equals;
        _equals = true && 
            ((this.mergeStatus==null && other.getMergeStatus()==null) || 
             (this.mergeStatus!=null &&
              this.mergeStatus.equals(other.getMergeStatus())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ResultMergeLeads.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.marketo.com/mktows/", "ResultMergeLeads"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("mergeStatus");
        elemField.setXmlName(new javax.xml.namespace.QName("", "mergeStatus"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.marketo.com/mktows/", "MergeStatus"));
