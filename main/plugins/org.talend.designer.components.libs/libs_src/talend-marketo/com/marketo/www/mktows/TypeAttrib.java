...
public class TypeAttrib  implements java.io.Serializable {
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof TypeAttrib)) return false;
        ...
        boolean _equals;
        _equals = true && 
            ((this.attrType==null && other.getAttrType()==null) || 
             (this.attrType!=null &&
              this.attrType.equals(other.getAttrType()))) &&
            ((this.attrList==null && other.getAttrList()==null) || 
             (this.attrList!=null &&
              java.util.Arrays.equals(this.attrList, other.getAttrList())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getAttrList() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getAttrList());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getAttrList(), i);
                if (obj != null &&
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(TypeAttrib.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.marketo.com/mktows/", "TypeAttrib"));
