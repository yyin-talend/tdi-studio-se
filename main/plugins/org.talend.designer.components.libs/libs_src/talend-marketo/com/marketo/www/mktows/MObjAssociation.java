...
public class MObjAssociation  implements java.io.Serializable {
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof MObjAssociation)) return false;
        ...
        boolean _equals;
        _equals = true && 
            ((this.mObjType==null && other.getMObjType()==null) || 
             (this.mObjType!=null &&
              this.mObjType.equals(other.getMObjType()))) &&
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(MObjAssociation.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.marketo.com/mktows/", "MObjAssociation"));
