...
public class SyncStatus  implements java.io.Serializable {
    ...
    public SyncStatus(
           int leadId,
           com.marketo.www.mktows.LeadSyncStatus status,
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.marketo.com/mktows/", "SyncStatus"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.marketo.com/mktows/", "LeadSyncStatus"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
