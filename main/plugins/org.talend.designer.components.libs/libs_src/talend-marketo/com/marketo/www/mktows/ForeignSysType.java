...
public class ForeignSysType implements java.io.Serializable {
    ...
    public static ForeignSysType fromValue(java.lang.String value)
        ...
        ForeignSysType enumeration = (ForeignSysType)
            _table_.get(value);
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ForeignSysType.class);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.marketo.com/mktows/", "ForeignSysType"));
    }
    /**
