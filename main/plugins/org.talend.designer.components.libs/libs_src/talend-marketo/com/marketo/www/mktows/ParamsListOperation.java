...
public class ParamsListOperation  implements java.io.Serializable {
     ...
     * @param listOperation
     */
    public void setListOperation(com.marketo.www.mktows.ListOperationType listOperation) {
        this.listOperation = listOperation;
    }
        ...
        _equals = true && 
            ((this.listOperation==null && other.getListOperation()==null) || 
             (this.listOperation!=null &&
              this.listOperation.equals(other.getListOperation()))) &&
            ((this.listKey==null && other.getListKey()==null) || 
             (this.listKey!=null &&
              this.listKey.equals(other.getListKey()))) &&
            ((this.listMemberList==null && other.getListMemberList()==null) || 
             (this.listMemberList!=null &&
    ...
    public synchronized int hashCode() {
        ...
        if (getListMemberList() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getListMemberList());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getListMemberList(), i);
                if (obj != null &&
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ParamsListOperation.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.marketo.com/mktows/", "ParamsListOperation"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("listOperation");
        elemField.setXmlName(new javax.xml.namespace.QName("", "listOperation"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.marketo.com/mktows/", "ListOperationType"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("listKey");
        elemField.setXmlName(new javax.xml.namespace.QName("", "listKey"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.marketo.com/mktows/", "ListKey"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("listMemberList");
        elemField.setXmlName(new javax.xml.namespace.QName("", "listMemberList"));
