...
public class ResultGetCampaignsForSource  implements java.io.Serializable {
     ...
     */
    public void setCampaignRecordList(com.marketo.www.mktows.CampaignRecord[] campaignRecordList) {
        this.campaignRecordList = campaignRecordList;
    }

    private java.lang.Object __equalsCalc = null;
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ResultGetCampaignsForSource)) return false;
        ...
        _equals = true && 
            ...
            ((this.campaignRecordList==null && other.getCampaignRecordList()==null) || 
             (this.campaignRecordList!=null &&
              java.util.Arrays.equals(this.campaignRecordList, other.getCampaignRecordList())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getCampaignRecordList() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getCampaignRecordList());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getCampaignRecordList(), i);
                if (obj != null &&
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ResultGetCampaignsForSource.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.marketo.com/mktows/", "ResultGetCampaignsForSource"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("", "campaignRecordList"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.marketo.com/mktows/", "CampaignRecord"));
        elemField.setMinOccurs(0);
        elemField.setNillable(true);
        elemField.setItemQName(new javax.xml.namespace.QName("", "campaignRecord"));
        typeDesc.addFieldDesc(elemField);
    }
