...
public class LeadRecord  implements java.io.Serializable {
     ...
     */
    public void setForeignSysType(com.marketo.www.mktows.ForeignSysType foreignSysType) {
        this.foreignSysType = foreignSysType;
    }
     ...
     */
    public void setLeadAttributeList(com.marketo.www.mktows.Attribute[] leadAttributeList) {
        this.leadAttributeList = leadAttributeList;
    }

    private java.lang.Object __equalsCalc = null;
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof LeadRecord)) return false;
        ...
        _equals = true && 
            ...
            ((this.foreignSysPersonId==null && other.getForeignSysPersonId()==null) || 
             (this.foreignSysPersonId!=null &&
              this.foreignSysPersonId.equals(other.getForeignSysPersonId()))) &&
            ((this.foreignSysType==null && other.getForeignSysType()==null) || 
             (this.foreignSysType!=null &&
              this.foreignSysType.equals(other.getForeignSysType()))) &&
            ((this.leadAttributeList==null && other.getLeadAttributeList()==null) || 
             (this.leadAttributeList!=null &&
              java.util.Arrays.equals(this.leadAttributeList, other.getLeadAttributeList())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getLeadAttributeList() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getLeadAttributeList());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getLeadAttributeList(), i);
                if (obj != null &&
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(LeadRecord.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.marketo.com/mktows/", "LeadRecord"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("", "ForeignSysPersonId"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setMinOccurs(0);
        elemField.setNillable(true);
        typeDesc.addFieldDesc(elemField);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("", "ForeignSysType"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.marketo.com/mktows/", "ForeignSysType"));
        elemField.setMinOccurs(0);
        elemField.setNillable(true);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("leadAttributeList");
        elemField.setXmlName(new javax.xml.namespace.QName("", "leadAttributeList"));
