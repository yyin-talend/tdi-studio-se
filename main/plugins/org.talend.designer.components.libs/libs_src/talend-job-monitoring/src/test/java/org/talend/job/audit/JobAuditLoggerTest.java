...
public class JobAuditLoggerTest {
	...
	public static void main(String[] args) {
		...
		Context context = JobContextBuilder.create().jobName("fetch_from_s3_every_day").jobId("jobid_123")
				...
				.parameters("{header : 1, file : a}").connectionName("row1").connectionType("reject").time("20s")
				.speed("20 rows/s").rows(10).timestamp("2019-12-12 23:23:23.111+08:00").status("end").build();
