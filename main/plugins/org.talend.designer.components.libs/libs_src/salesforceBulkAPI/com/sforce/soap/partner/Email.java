...
public class Email implements com.sforce.ws.bind.XMLizable {
    ...
    /** * element : bccSender of type {http://www.w3.org/2001/XMLSchema}boolean * java type: java.lang.Boolean */
    private static final com.sforce.ws.bind.TypeInfo bccSender__typeInfo = new com.sforce.ws.bind.TypeInfo(
            "urn:partner.soap.sforce.com", "bccSender", "http://www.w3.org/2001/XMLSchema", "boolean", 1, 1, true);
    ...
    /**
     * * element : emailPriority of type {urn:partner.soap.sforce.com}EmailPriority * java type:
     * com.sforce.soap.partner.EmailPriority
     */
    private static final com.sforce.ws.bind.TypeInfo emailPriority__typeInfo = new com.sforce.ws.bind.TypeInfo(
            "urn:partner.soap.sforce.com", "emailPriority", "urn:partner.soap.sforce.com", "EmailPriority", 1, 1, true);
    ...
    /** * element : replyTo of type {http://www.w3.org/2001/XMLSchema}string * java type: java.lang.String */
    private static final com.sforce.ws.bind.TypeInfo replyTo__typeInfo = new com.sforce.ws.bind.TypeInfo(
            "urn:partner.soap.sforce.com", "replyTo", "http://www.w3.org/2001/XMLSchema", "string", 1, 1, true);
    ...
    /** * element : saveAsActivity of type {http://www.w3.org/2001/XMLSchema}boolean * java type: java.lang.Boolean */
    private static final com.sforce.ws.bind.TypeInfo saveAsActivity__typeInfo = new com.sforce.ws.bind.TypeInfo(
            "urn:partner.soap.sforce.com", "saveAsActivity", "http://www.w3.org/2001/XMLSchema", "boolean", 1, 1, true);
    ...
    /** * element : senderDisplayName of type {http://www.w3.org/2001/XMLSchema}string * java type: java.lang.String */
    private static final com.sforce.ws.bind.TypeInfo senderDisplayName__typeInfo = new com.sforce.ws.bind.TypeInfo(
            "urn:partner.soap.sforce.com", "senderDisplayName", "http://www.w3.org/2001/XMLSchema", "string", 1, 1, true);
    ...
    /** * element : subject of type {http://www.w3.org/2001/XMLSchema}string * java type: java.lang.String */
    private static final com.sforce.ws.bind.TypeInfo subject__typeInfo = new com.sforce.ws.bind.TypeInfo(
            "urn:partner.soap.sforce.com", "subject", "http://www.w3.org/2001/XMLSchema", "string", 1, 1, true);
    ...
    /** * element : useSignature of type {http://www.w3.org/2001/XMLSchema}boolean * java type: java.lang.Boolean */
    private static final com.sforce.ws.bind.TypeInfo useSignature__typeInfo = new com.sforce.ws.bind.TypeInfo(
            "urn:partner.soap.sforce.com", "useSignature", "http://www.w3.org/2001/XMLSchema", "boolean", 1, 1, true);
    ...
    protected void loadFields(com.sforce.ws.parser.XmlInputStream __in, com.sforce.ws.bind.TypeMapper __typeMapper)
        ...
        if (__typeMapper.verifyElement(__in, emailPriority__typeInfo)) {
            setEmailPriority((com.sforce.soap.partner.EmailPriority) __typeMapper.readObject(__in, emailPriority__typeInfo,
                    com.sforce.soap.partner.EmailPriority.class));
        }
        __in.peekTag();
        ...
        if (__typeMapper.verifyElement(__in, saveAsActivity__typeInfo)) {
            setSaveAsActivity((java.lang.Boolean) __typeMapper
                    .readObject(__in, saveAsActivity__typeInfo, java.lang.Boolean.class));
        }
        __in.peekTag();
        if (__typeMapper.verifyElement(__in, senderDisplayName__typeInfo)) {
            setSenderDisplayName((java.lang.String) __typeMapper.readString(__in, senderDisplayName__typeInfo,
