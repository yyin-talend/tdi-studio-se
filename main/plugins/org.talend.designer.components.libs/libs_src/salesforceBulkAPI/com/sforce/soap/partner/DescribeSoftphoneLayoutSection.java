...
public class DescribeSoftphoneLayoutSection implements com.sforce.ws.bind.XMLizable {
    ...
    private static final com.sforce.ws.bind.TypeInfo entityApiName__typeInfo = new com.sforce.ws.bind.TypeInfo(
            "urn:partner.soap.sforce.com", "entityApiName", "http://www.w3.org/2001/XMLSchema", "string", 1, 1, true);
    ...
    /**
     * * element : items of type {urn:partner.soap.sforce.com}DescribeSoftphoneLayoutItem * java type:
     * com.sforce.soap.partner.DescribeSoftphoneLayoutItem[]
     */
    private static final com.sforce.ws.bind.TypeInfo items__typeInfo = new com.sforce.ws.bind.TypeInfo(
            "urn:partner.soap.sforce.com", "items", "urn:partner.soap.sforce.com", "DescribeSoftphoneLayoutItem", 1, -1, true);
    ...
    protected void loadFields(com.sforce.ws.parser.XmlInputStream __in, com.sforce.ws.bind.TypeMapper __typeMapper)
        ...
        if (__typeMapper.verifyElement(__in, items__typeInfo)) {
            setItems((com.sforce.soap.partner.DescribeSoftphoneLayoutItem[]) __typeMapper.readObject(__in, items__typeInfo,
