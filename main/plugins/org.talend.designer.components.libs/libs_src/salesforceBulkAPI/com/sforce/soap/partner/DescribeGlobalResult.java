...
public class DescribeGlobalResult implements com.sforce.ws.bind.XMLizable {
    ...
    private static final com.sforce.ws.bind.TypeInfo encoding__typeInfo = new com.sforce.ws.bind.TypeInfo(
            "urn:partner.soap.sforce.com", "encoding", "http://www.w3.org/2001/XMLSchema", "string", 1, 1, true);
    ...
    private static final com.sforce.ws.bind.TypeInfo maxBatchSize__typeInfo = new com.sforce.ws.bind.TypeInfo(
            "urn:partner.soap.sforce.com", "maxBatchSize", "http://www.w3.org/2001/XMLSchema", "int", 1, 1, true);
    ...
    /**
     * * element : sobjects of type {urn:partner.soap.sforce.com}DescribeGlobalSObjectResult * java type:
     * com.sforce.soap.partner.DescribeGlobalSObjectResult[]
     */
    private static final com.sforce.ws.bind.TypeInfo sobjects__typeInfo = new com.sforce.ws.bind.TypeInfo(
            "urn:partner.soap.sforce.com", "sobjects", "urn:partner.soap.sforce.com", "DescribeGlobalSObjectResult", 0, -1, true);
    ...
    protected void loadFields(com.sforce.ws.parser.XmlInputStream __in, com.sforce.ws.bind.TypeMapper __typeMapper)
        ...
        if (__typeMapper.isElement(__in, sobjects__typeInfo)) {
            setSobjects((com.sforce.soap.partner.DescribeGlobalSObjectResult[]) __typeMapper.readObject(__in, sobjects__typeInfo,
                    com.sforce.soap.partner.DescribeGlobalSObjectResult[].class));
        }
    }
