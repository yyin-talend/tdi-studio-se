...
public class QueryResult implements com.sforce.ws.bind.XMLizable {
    ...
    private static final com.sforce.ws.bind.TypeInfo done__typeInfo = new com.sforce.ws.bind.TypeInfo(
            "urn:partner.soap.sforce.com", "done", "http://www.w3.org/2001/XMLSchema", "boolean", 1, 1, true);
    ...
    private static final com.sforce.ws.bind.TypeInfo queryLocator__typeInfo = new com.sforce.ws.bind.TypeInfo(
            "urn:partner.soap.sforce.com", "queryLocator", "urn:partner.soap.sforce.com", "QueryLocator", 1, 1, true);
    ...
    /**
     * * element : records of type {urn:sobject.partner.soap.sforce.com}sObject * java type:
     * com.sforce.soap.partner.sobject.SObject[]
     */
    private static final com.sforce.ws.bind.TypeInfo records__typeInfo = new com.sforce.ws.bind.TypeInfo(
            "urn:partner.soap.sforce.com", "records", "urn:sobject.partner.soap.sforce.com", "sObject", 0, -1, true);
    ...
    private static final com.sforce.ws.bind.TypeInfo size__typeInfo = new com.sforce.ws.bind.TypeInfo(
            "urn:partner.soap.sforce.com", "size", "http://www.w3.org/2001/XMLSchema", "int", 1, 1, true);
    ...
    protected void loadFields(com.sforce.ws.parser.XmlInputStream __in, com.sforce.ws.bind.TypeMapper __typeMapper)
        ...
        if (__typeMapper.isElement(__in, records__typeInfo)) {
            setRecords((com.sforce.soap.partner.sobject.SObject[]) __typeMapper.readObject(__in, records__typeInfo,
