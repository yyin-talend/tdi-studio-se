...
public class DescribeLayoutItem implements com.sforce.ws.bind.XMLizable {
    ...
    /** * element : editable of type {http://www.w3.org/2001/XMLSchema}boolean * java type: boolean */
    private static final com.sforce.ws.bind.TypeInfo editable__typeInfo = new com.sforce.ws.bind.TypeInfo(
            "urn:partner.soap.sforce.com", "editable", "http://www.w3.org/2001/XMLSchema", "boolean", 1, 1, true);
    ...
    /**
     * * element : layoutComponents of type {urn:partner.soap.sforce.com}DescribeLayoutComponent * java type:
    ...
    private static final com.sforce.ws.bind.TypeInfo layoutComponents__typeInfo = new com.sforce.ws.bind.TypeInfo(
            "urn:partner.soap.sforce.com", "layoutComponents", "urn:partner.soap.sforce.com", "DescribeLayoutComponent", 0, -1,
            true);
    ...
    private static final com.sforce.ws.bind.TypeInfo placeholder__typeInfo = new com.sforce.ws.bind.TypeInfo(
            "urn:partner.soap.sforce.com", "placeholder", "http://www.w3.org/2001/XMLSchema", "boolean", 1, 1, true);
    ...
    private static final com.sforce.ws.bind.TypeInfo required__typeInfo = new com.sforce.ws.bind.TypeInfo(
            "urn:partner.soap.sforce.com", "required", "http://www.w3.org/2001/XMLSchema", "boolean", 1, 1, true);
    ...
    protected void loadFields(com.sforce.ws.parser.XmlInputStream __in, com.sforce.ws.bind.TypeMapper __typeMapper)
        ...
        if (__typeMapper.isElement(__in, layoutComponents__typeInfo)) {
            setLayoutComponents((com.sforce.soap.partner.DescribeLayoutComponent[]) __typeMapper.readObject(__in,
                    layoutComponents__typeInfo, com.sforce.soap.partner.DescribeLayoutComponent[].class));
        }
        __in.peekTag();
