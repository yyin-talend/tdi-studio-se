...
public class RelatedList implements com.sforce.ws.bind.XMLizable {
    ...
    /**
     * * element : columns of type {urn:partner.soap.sforce.com}RelatedListColumn * java type:
    ...
    private static final com.sforce.ws.bind.TypeInfo columns__typeInfo = new com.sforce.ws.bind.TypeInfo(
            "urn:partner.soap.sforce.com", "columns", "urn:partner.soap.sforce.com", "RelatedListColumn", 1, -1, true);
    ...
    private static final com.sforce.ws.bind.TypeInfo limitRows__typeInfo = new com.sforce.ws.bind.TypeInfo(
            "urn:partner.soap.sforce.com", "limitRows", "http://www.w3.org/2001/XMLSchema", "int", 1, 1, true);
    ...
    /**
     * * element : sort of type {urn:partner.soap.sforce.com}RelatedListSort * java type:
     * com.sforce.soap.partner.RelatedListSort[]
     */
    private static final com.sforce.ws.bind.TypeInfo sort__typeInfo = new com.sforce.ws.bind.TypeInfo(
            "urn:partner.soap.sforce.com", "sort", "urn:partner.soap.sforce.com", "RelatedListSort", 0, -1, true);
    ...
    protected void loadFields(com.sforce.ws.parser.XmlInputStream __in, com.sforce.ws.bind.TypeMapper __typeMapper)
        ...
        if (__typeMapper.verifyElement(__in, columns__typeInfo)) {
            setColumns((com.sforce.soap.partner.RelatedListColumn[]) __typeMapper.readObject(__in, columns__typeInfo,
        ...
        if (__typeMapper.isElement(__in, sort__typeInfo)) {
            setSort((com.sforce.soap.partner.RelatedListSort[]) __typeMapper.readObject(__in, sort__typeInfo,
