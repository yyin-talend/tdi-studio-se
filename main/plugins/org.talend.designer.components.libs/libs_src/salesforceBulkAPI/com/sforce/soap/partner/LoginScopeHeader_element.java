...
public class LoginScopeHeader_element extends com.sforce.ws.bind.SoapHeaderObject implements com.sforce.ws.bind.XMLizable {
    ...
    private static final com.sforce.ws.bind.TypeInfo organizationId__typeInfo = new com.sforce.ws.bind.TypeInfo(
            "urn:partner.soap.sforce.com", "organizationId", "urn:partner.soap.sforce.com", "ID", 1, 1, true);
    ...
    /** * element : portalId of type {urn:partner.soap.sforce.com}ID * java type: java.lang.String */
    private static final com.sforce.ws.bind.TypeInfo portalId__typeInfo = new com.sforce.ws.bind.TypeInfo(
            "urn:partner.soap.sforce.com", "portalId", "urn:partner.soap.sforce.com", "ID", 0, 1, true);
