...
public class SearchResult implements com.sforce.ws.bind.XMLizable {
    ...
    /**
     * * element : searchRecords of type {urn:partner.soap.sforce.com}SearchRecord * java type:
    ...
    private static final com.sforce.ws.bind.TypeInfo searchRecords__typeInfo = new com.sforce.ws.bind.TypeInfo(
            "urn:partner.soap.sforce.com", "searchRecords", "urn:partner.soap.sforce.com", "SearchRecord", 0, -1, true);
    ...
    protected void loadFields(com.sforce.ws.parser.XmlInputStream __in, com.sforce.ws.bind.TypeMapper __typeMapper)
        ...
        if (__typeMapper.isElement(__in, searchRecords__typeInfo)) {
            setSearchRecords((com.sforce.soap.partner.SearchRecord[]) __typeMapper.readObject(__in, searchRecords__typeInfo,
