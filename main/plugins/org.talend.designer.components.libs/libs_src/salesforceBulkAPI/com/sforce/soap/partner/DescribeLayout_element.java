...
public class DescribeLayout_element implements com.sforce.ws.bind.XMLizable {
    ...
    private static final com.sforce.ws.bind.TypeInfo sObjectType__typeInfo = new com.sforce.ws.bind.TypeInfo(
            "urn:partner.soap.sforce.com", "sObjectType", "http://www.w3.org/2001/XMLSchema", "string", 1, 1, true);
    ...
    /** * element : recordTypeIds of type {urn:partner.soap.sforce.com}ID * java type: java.lang.String[] */
    private static final com.sforce.ws.bind.TypeInfo recordTypeIds__typeInfo = new com.sforce.ws.bind.TypeInfo(
            "urn:partner.soap.sforce.com", "recordTypeIds", "urn:partner.soap.sforce.com", "ID", 0, -1, true);
    ...
    protected void loadFields(com.sforce.ws.parser.XmlInputStream __in, com.sforce.ws.bind.TypeMapper __typeMapper)
        ...
        if (__typeMapper.isElement(__in, recordTypeIds__typeInfo)) {
            setRecordTypeIds((java.lang.String[]) __typeMapper
                    .readObject(__in, recordTypeIds__typeInfo, java.lang.String[].class));
        }
    }
