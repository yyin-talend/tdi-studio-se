...
public class Field implements com.sforce.ws.bind.XMLizable {
	...
	private static final com.sforce.ws.bind.TypeInfo byteLength__typeInfo = new com.sforce.ws.bind.TypeInfo(
			...
			"http://www.w3.org/2001/XMLSchema", "int", 1, 1, true);
	...
	/**
	 * * element : calculatedFormula of type
	...
	/**
	 * * element : controllerName of type
	 * {http://www.w3.org/2001/XMLSchema}string * java type: java.lang.String
	 */
	...
	/**
	 * * element : defaultValueFormula of type
	 * {http://www.w3.org/2001/XMLSchema}string * java type: java.lang.String
	 */
	...
	/**
	 * * element : defaultedOnCreate of type
	 * {http://www.w3.org/2001/XMLSchema}boolean * java type: boolean
	 */
	...
	/**
	 * * element : dependentPicklist of type
	 * {http://www.w3.org/2001/XMLSchema}boolean * java type: boolean
	 */
	...
	/**
	 * * element : digits of type {http://www.w3.org/2001/XMLSchema}int * java
	 * type: int
	 */
	...
	/**
	 * * element : inlineHelpText of type
	 * {http://www.w3.org/2001/XMLSchema}string * java type: java.lang.String
	 */
	...
	/**
	 * * element : label of type {http://www.w3.org/2001/XMLSchema}string * java
	...
	/**
	 * * element : length of type {http://www.w3.org/2001/XMLSchema}int * java
	 * type: int
	 */
	...
	/**
	 * * element : permissionable of type
	 * {http://www.w3.org/2001/XMLSchema}boolean * java type: boolean
	 */
	...
	/**
	 * * element : picklistValues of type
	 * {urn:partner.soap.sforce.com}PicklistEntry * java type:
	...
	private static final com.sforce.ws.bind.TypeInfo picklistValues__typeInfo = new com.sforce.ws.bind.TypeInfo(
			...
			"urn:partner.soap.sforce.com", "PicklistEntry", 0, -1, true);
	...
	/**
	 * * element : relationshipOrder of type
	...
	/**
	 * * element : restrictedPicklist of type
	 * {http://www.w3.org/2001/XMLSchema}boolean * java type: boolean
	 */
	...
	/**
	 * * element : scale of type {http://www.w3.org/2001/XMLSchema}int * java
	 * type: int
	 */
	...
	/**
	 * * element : soapType of type {urn:partner.soap.sforce.com}soapType * java
	 * type: com.sforce.soap.partner.SoapType
	 */
	private static final com.sforce.ws.bind.TypeInfo soapType__typeInfo = new com.sforce.ws.bind.TypeInfo(
			...
			"urn:partner.soap.sforce.com", "soapType", 1, 1, true);
	...
	/**
	 * * element : type of type {urn:partner.soap.sforce.com}fieldType * java
	 * type: com.sforce.soap.partner.FieldType
	 */
	private static final com.sforce.ws.bind.TypeInfo type__typeInfo = new com.sforce.ws.bind.TypeInfo(
			...
			"urn:partner.soap.sforce.com", "fieldType", 1, 1, true);
	...
	protected void writeFields(com.sforce.ws.parser.XmlOutputStream __out,
			com.sforce.ws.bind.TypeMapper __typeMapper)
			throws java.io.IOException {
		__typeMapper.writeBoolean(__out, autoNumber__typeInfo, autoNumber,
				autoNumber__is_set);
		__typeMapper.writeInt(__out, byteLength__typeInfo, byteLength,
				byteLength__is_set);
		__typeMapper.writeBoolean(__out, calculated__typeInfo, calculated,
				calculated__is_set);
		__typeMapper.writeString(__out, calculatedFormula__typeInfo,
				calculatedFormula, calculatedFormula__is_set);
		__typeMapper.writeBoolean(__out, cascadeDelete__typeInfo,
				cascadeDelete, cascadeDelete__is_set);
		__typeMapper.writeBoolean(__out, caseSensitive__typeInfo,
				caseSensitive, caseSensitive__is_set);
		__typeMapper.writeString(__out, controllerName__typeInfo,
				controllerName, controllerName__is_set);
		__typeMapper.writeBoolean(__out, createable__typeInfo, createable,
				createable__is_set);
		__typeMapper.writeBoolean(__out, custom__typeInfo, custom,
				custom__is_set);
		__typeMapper.writeString(__out, defaultValueFormula__typeInfo,
				defaultValueFormula, defaultValueFormula__is_set);
		__typeMapper.writeBoolean(__out, defaultedOnCreate__typeInfo,
				defaultedOnCreate, defaultedOnCreate__is_set);
		__typeMapper.writeBoolean(__out, dependentPicklist__typeInfo,
				dependentPicklist, dependentPicklist__is_set);
		...
		__typeMapper.writeBoolean(__out, displayLocationInDecimal__typeInfo,
				displayLocationInDecimal, displayLocationInDecimal__is_set);
		__typeMapper.writeBoolean(__out, externalId__typeInfo, externalId,
				externalId__is_set);
		__typeMapper.writeBoolean(__out, filterable__typeInfo, filterable,
				filterable__is_set);
		__typeMapper.writeBoolean(__out, groupable__typeInfo, groupable,
				groupable__is_set);
		__typeMapper.writeBoolean(__out, htmlFormatted__typeInfo,
				htmlFormatted, htmlFormatted__is_set);
		__typeMapper.writeBoolean(__out, idLookup__typeInfo, idLookup,
				idLookup__is_set);
		__typeMapper.writeString(__out, inlineHelpText__typeInfo,
				inlineHelpText, inlineHelpText__is_set);
		__typeMapper.writeString(__out, label__typeInfo, label, label__is_set);
		__typeMapper.writeInt(__out, length__typeInfo, length, length__is_set);
		__typeMapper.writeString(__out, name__typeInfo, name, name__is_set);
		__typeMapper.writeBoolean(__out, nameField__typeInfo, nameField,
				nameField__is_set);
		__typeMapper.writeBoolean(__out, namePointing__typeInfo, namePointing,
				namePointing__is_set);
		__typeMapper.writeBoolean(__out, nillable__typeInfo, nillable,
				nillable__is_set);
		__typeMapper.writeBoolean(__out, permissionable__typeInfo,
				permissionable, permissionable__is_set);
		__typeMapper.writeObject(__out, picklistValues__typeInfo,
				picklistValues, picklistValues__is_set);
		__typeMapper.writeInt(__out, precision__typeInfo, precision,
				precision__is_set);
		__typeMapper.writeObject(__out, referenceTo__typeInfo, referenceTo,
				referenceTo__is_set);
		__typeMapper.writeString(__out, relationshipName__typeInfo,
				relationshipName, relationshipName__is_set);
		__typeMapper.writeInt(__out, relationshipOrder__typeInfo,
				relationshipOrder, relationshipOrder__is_set);
		__typeMapper.writeBoolean(__out, restrictedDelete__typeInfo,
				restrictedDelete, restrictedDelete__is_set);
		__typeMapper.writeBoolean(__out, restrictedPicklist__typeInfo,
				restrictedPicklist, restrictedPicklist__is_set);
		__typeMapper.writeInt(__out, scale__typeInfo, scale, scale__is_set);
		__typeMapper.writeObject(__out, soapType__typeInfo, soapType,
				soapType__is_set);
		__typeMapper.writeBoolean(__out, sortable__typeInfo, sortable,
				sortable__is_set);
		__typeMapper.writeObject(__out, type__typeInfo, type, type__is_set);
		__typeMapper.writeBoolean(__out, unique__typeInfo, unique,
				unique__is_set);
		__typeMapper.writeBoolean(__out, updateable__typeInfo, updateable,
				updateable__is_set);
		__typeMapper.writeBoolean(__out, writeRequiresMasterRead__typeInfo,
				writeRequiresMasterRead, writeRequiresMasterRead__is_set);
	}
	...
	protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
		...
		if (__typeMapper.verifyElement(__in, autoNumber__typeInfo)) {
			setAutoNumber((boolean) __typeMapper.readBoolean(__in,
					autoNumber__typeInfo, boolean.class));
		}
		__in.peekTag();
		if (__typeMapper.verifyElement(__in, byteLength__typeInfo)) {
			setByteLength((int) __typeMapper.readInt(__in,
					byteLength__typeInfo, int.class));
		}
		__in.peekTag();
		if (__typeMapper.verifyElement(__in, calculated__typeInfo)) {
			setCalculated((boolean) __typeMapper.readBoolean(__in,
					calculated__typeInfo, boolean.class));
		}
		__in.peekTag();
		if (__typeMapper.isElement(__in, calculatedFormula__typeInfo)) {
			setCalculatedFormula((java.lang.String) __typeMapper.readString(
					__in, calculatedFormula__typeInfo, java.lang.String.class));
		}
		__in.peekTag();
		...
		if (__typeMapper.verifyElement(__in, caseSensitive__typeInfo)) {
			setCaseSensitive((boolean) __typeMapper.readBoolean(__in,
					caseSensitive__typeInfo, boolean.class));
		}
		__in.peekTag();
		if (__typeMapper.isElement(__in, controllerName__typeInfo)) {
			setControllerName((java.lang.String) __typeMapper.readString(__in,
					controllerName__typeInfo, java.lang.String.class));
		}
		__in.peekTag();
		if (__typeMapper.verifyElement(__in, createable__typeInfo)) {
			setCreateable((boolean) __typeMapper.readBoolean(__in,
					createable__typeInfo, boolean.class));
		}
		__in.peekTag();
		if (__typeMapper.verifyElement(__in, custom__typeInfo)) {
			setCustom((boolean) __typeMapper.readBoolean(__in,
					custom__typeInfo, boolean.class));
		}
		__in.peekTag();
		if (__typeMapper.isElement(__in, defaultValueFormula__typeInfo)) {
			setDefaultValueFormula((java.lang.String) __typeMapper
					.readString(__in, defaultValueFormula__typeInfo,
							java.lang.String.class));
		}
		__in.peekTag();
		if (__typeMapper.verifyElement(__in, defaultedOnCreate__typeInfo)) {
			setDefaultedOnCreate((boolean) __typeMapper.readBoolean(__in,
					defaultedOnCreate__typeInfo, boolean.class));
		}
		__in.peekTag();
		if (__typeMapper.isElement(__in, dependentPicklist__typeInfo)) {
			setDependentPicklist((boolean) __typeMapper.readBoolean(__in,
					dependentPicklist__typeInfo, boolean.class));
		}
		__in.peekTag();
		...
		if (__typeMapper.verifyElement(__in, digits__typeInfo)) {
			setDigits((int) __typeMapper.readInt(__in, digits__typeInfo,
					int.class));
		}
		__in.peekTag();
		if (__typeMapper.isElement(__in, displayLocationInDecimal__typeInfo)) {
			setDisplayLocationInDecimal((boolean) __typeMapper.readBoolean(
					__in, displayLocationInDecimal__typeInfo, boolean.class));
		}
		__in.peekTag();
		if (__typeMapper.isElement(__in, externalId__typeInfo)) {
			setExternalId((boolean) __typeMapper.readBoolean(__in,
					externalId__typeInfo, boolean.class));
		}
		__in.peekTag();
		if (__typeMapper.verifyElement(__in, filterable__typeInfo)) {
			setFilterable((boolean) __typeMapper.readBoolean(__in,
					filterable__typeInfo, boolean.class));
		}
		__in.peekTag();
		if (__typeMapper.verifyElement(__in, groupable__typeInfo)) {
			setGroupable((boolean) __typeMapper.readBoolean(__in,
					groupable__typeInfo, boolean.class));
		}
		__in.peekTag();
		if (__typeMapper.isElement(__in, htmlFormatted__typeInfo)) {
			setHtmlFormatted((boolean) __typeMapper.readBoolean(__in,
					htmlFormatted__typeInfo, boolean.class));
		}
		__in.peekTag();
		if (__typeMapper.verifyElement(__in, idLookup__typeInfo)) {
			setIdLookup((boolean) __typeMapper.readBoolean(__in,
					idLookup__typeInfo, boolean.class));
		}
		__in.peekTag();
		if (__typeMapper.isElement(__in, inlineHelpText__typeInfo)) {
			setInlineHelpText((java.lang.String) __typeMapper.readString(__in,
					inlineHelpText__typeInfo, java.lang.String.class));
		}
		__in.peekTag();
		if (__typeMapper.verifyElement(__in, label__typeInfo)) {
			setLabel((java.lang.String) __typeMapper.readString(__in,
					label__typeInfo, java.lang.String.class));
		}
		__in.peekTag();
		if (__typeMapper.verifyElement(__in, length__typeInfo)) {
			setLength((int) __typeMapper.readInt(__in, length__typeInfo,
					int.class));
		}
		__in.peekTag();
		...
		if (__typeMapper.verifyElement(__in, nameField__typeInfo)) {
			setNameField((boolean) __typeMapper.readBoolean(__in,
					nameField__typeInfo, boolean.class));
		}
		__in.peekTag();
		if (__typeMapper.isElement(__in, namePointing__typeInfo)) {
			setNamePointing((boolean) __typeMapper.readBoolean(__in,
					namePointing__typeInfo, boolean.class));
		}
		__in.peekTag();
		if (__typeMapper.verifyElement(__in, nillable__typeInfo)) {
			setNillable((boolean) __typeMapper.readBoolean(__in,
					nillable__typeInfo, boolean.class));
		}
		__in.peekTag();
		if (__typeMapper.verifyElement(__in, permissionable__typeInfo)) {
			setPermissionable((boolean) __typeMapper.readBoolean(__in,
					permissionable__typeInfo, boolean.class));
		}
		__in.peekTag();
		if (__typeMapper.isElement(__in, picklistValues__typeInfo)) {
			setPicklistValues((com.sforce.soap.partner.PicklistEntry[]) __typeMapper
					.readObject(__in, picklistValues__typeInfo,
							com.sforce.soap.partner.PicklistEntry[].class));
		}
		__in.peekTag();
		if (__typeMapper.verifyElement(__in, precision__typeInfo)) {
			setPrecision((int) __typeMapper.readInt(__in, precision__typeInfo,
					int.class));
		}
		__in.peekTag();
		if (__typeMapper.isElement(__in, referenceTo__typeInfo)) {
			setReferenceTo((java.lang.String[]) __typeMapper.readObject(__in,
					referenceTo__typeInfo, java.lang.String[].class));
		}
		__in.peekTag();
		...
		if (__typeMapper.isElement(__in, relationshipOrder__typeInfo)) {
			setRelationshipOrder((int) __typeMapper.readInt(__in,
					relationshipOrder__typeInfo, int.class));
		}
		__in.peekTag();
		...
		if (__typeMapper.verifyElement(__in, restrictedPicklist__typeInfo)) {
			setRestrictedPicklist((boolean) __typeMapper.readBoolean(__in,
					restrictedPicklist__typeInfo, boolean.class));
		}
		__in.peekTag();
		...
		if (__typeMapper.verifyElement(__in, soapType__typeInfo)) {
			setSoapType((com.sforce.soap.partner.SoapType) __typeMapper
					.readObject(__in, soapType__typeInfo,
							com.sforce.soap.partner.SoapType.class));
		}
		__in.peekTag();
		if (__typeMapper.isElement(__in, sortable__typeInfo)) {
			setSortable((boolean) __typeMapper.readBoolean(__in,
					sortable__typeInfo, boolean.class));
		}
		__in.peekTag();
		if (__typeMapper.verifyElement(__in, type__typeInfo)) {
			setType((com.sforce.soap.partner.FieldType) __typeMapper
					.readObject(__in, type__typeInfo,
							com.sforce.soap.partner.FieldType.class));
		}
		__in.peekTag();
		if (__typeMapper.verifyElement(__in, unique__typeInfo)) {
			setUnique((boolean) __typeMapper.readBoolean(__in,
					unique__typeInfo, boolean.class));
		}
		__in.peekTag();
		if (__typeMapper.verifyElement(__in, updateable__typeInfo)) {
			setUpdateable((boolean) __typeMapper.readBoolean(__in,
					updateable__typeInfo, boolean.class));
		}
		__in.peekTag();
		if (__typeMapper.isElement(__in, writeRequiresMasterRead__typeInfo)) {
			setWriteRequiresMasterRead((boolean) __typeMapper.readBoolean(__in,
					writeRequiresMasterRead__typeInfo, boolean.class));
		}
	}
	...
	public String toString() {
		...
		sb.append("'"
				+ com.sforce.ws.util.Verbose.toString(defaultValueFormula)
				+ "'\n");
		...
		sb.append("'"
				+ com.sforce.ws.util.Verbose.toString(displayLocationInDecimal)
				+ "'\n");
		...
		sb.append("'"
				+ com.sforce.ws.util.Verbose.toString(writeRequiresMasterRead)
				+ "'\n");
		sb.append("]\n");
		return sb.toString();
	}
