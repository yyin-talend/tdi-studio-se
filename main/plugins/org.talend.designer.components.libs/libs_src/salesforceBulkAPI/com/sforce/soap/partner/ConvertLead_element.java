...
public class ConvertLead_element implements com.sforce.ws.bind.XMLizable {
    ...
    /**
     * * element : leadConverts of type {urn:partner.soap.sforce.com}LeadConvert * java type:
    ...
    private static final com.sforce.ws.bind.TypeInfo leadConverts__typeInfo = new com.sforce.ws.bind.TypeInfo(
            "urn:partner.soap.sforce.com", "leadConverts", "urn:partner.soap.sforce.com", "LeadConvert", 0, -1, true);
    ...
    protected void loadFields(com.sforce.ws.parser.XmlInputStream __in, com.sforce.ws.bind.TypeMapper __typeMapper)
        ...
        if (__typeMapper.isElement(__in, leadConverts__typeInfo)) {
            setLeadConverts((com.sforce.soap.partner.LeadConvert[]) __typeMapper.readObject(__in, leadConverts__typeInfo,
