...
public class DataCategory implements com.sforce.ws.bind.XMLizable {
    ...
    /**
     * * element : childCategories of type {urn:partner.soap.sforce.com}DataCategory * java type:
    ...
    private static final com.sforce.ws.bind.TypeInfo childCategories__typeInfo = new com.sforce.ws.bind.TypeInfo(
            "urn:partner.soap.sforce.com", "childCategories", "urn:partner.soap.sforce.com", "DataCategory", 0, -1, true);
    ...
    protected void loadFields(com.sforce.ws.parser.XmlInputStream __in, com.sforce.ws.bind.TypeMapper __typeMapper)
        ...
        if (__typeMapper.isElement(__in, childCategories__typeInfo)) {
            setChildCategories((com.sforce.soap.partner.DataCategory[]) __typeMapper.readObject(__in, childCategories__typeInfo,
                    com.sforce.soap.partner.DataCategory[].class));
        }
        __in.peekTag();
