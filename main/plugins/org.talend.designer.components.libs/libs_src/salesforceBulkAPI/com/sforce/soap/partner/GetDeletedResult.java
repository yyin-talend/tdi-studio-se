...
public class GetDeletedResult implements com.sforce.ws.bind.XMLizable {
    ...
    /**
     * * element : deletedRecords of type {urn:partner.soap.sforce.com}DeletedRecord * java type:
     * com.sforce.soap.partner.DeletedRecord[]
     */
    private static final com.sforce.ws.bind.TypeInfo deletedRecords__typeInfo = new com.sforce.ws.bind.TypeInfo(
            "urn:partner.soap.sforce.com", "deletedRecords", "urn:partner.soap.sforce.com", "DeletedRecord", 0, -1, true);
    ...
    /**
     * * element : earliestDateAvailable of type {http://www.w3.org/2001/XMLSchema}dateTime * java type:
     * java.util.Calendar
     */
    private static final com.sforce.ws.bind.TypeInfo earliestDateAvailable__typeInfo = new com.sforce.ws.bind.TypeInfo(
            "urn:partner.soap.sforce.com", "earliestDateAvailable", "http://www.w3.org/2001/XMLSchema", "dateTime", 1, 1, true);
    ...
    /** * element : latestDateCovered of type {http://www.w3.org/2001/XMLSchema}dateTime * java type: java.util.Calendar */
    private static final com.sforce.ws.bind.TypeInfo latestDateCovered__typeInfo = new com.sforce.ws.bind.TypeInfo(
            "urn:partner.soap.sforce.com", "latestDateCovered", "http://www.w3.org/2001/XMLSchema", "dateTime", 1, 1, true);
    ...
    /** * element : sforceReserved of type {http://www.w3.org/2001/XMLSchema}string * java type: java.lang.String */
    private static final com.sforce.ws.bind.TypeInfo sforceReserved__typeInfo = new com.sforce.ws.bind.TypeInfo(
            "urn:partner.soap.sforce.com", "sforceReserved", "http://www.w3.org/2001/XMLSchema", "string", 0, 1, true);
    ...
    protected void loadFields(com.sforce.ws.parser.XmlInputStream __in, com.sforce.ws.bind.TypeMapper __typeMapper)
        ...
        if (__typeMapper.isElement(__in, deletedRecords__typeInfo)) {
            setDeletedRecords((com.sforce.soap.partner.DeletedRecord[]) __typeMapper.readObject(__in, deletedRecords__typeInfo,
                    com.sforce.soap.partner.DeletedRecord[].class));
        }
        __in.peekTag();
        if (__typeMapper.verifyElement(__in, earliestDateAvailable__typeInfo)) {
            setEarliestDateAvailable((java.util.Calendar) __typeMapper.readObject(__in, earliestDateAvailable__typeInfo,
                    java.util.Calendar.class));
        }
        __in.peekTag();
        if (__typeMapper.verifyElement(__in, latestDateCovered__typeInfo)) {
            setLatestDateCovered((java.util.Calendar) __typeMapper.readObject(__in, latestDateCovered__typeInfo,
                    java.util.Calendar.class));
        }
        __in.peekTag();
