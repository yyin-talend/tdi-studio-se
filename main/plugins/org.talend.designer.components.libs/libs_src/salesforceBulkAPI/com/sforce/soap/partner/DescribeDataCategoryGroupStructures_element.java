...
public class DescribeDataCategoryGroupStructures_element implements com.sforce.ws.bind.XMLizable {
    ...
    /**
     * * element : pairs of type {urn:partner.soap.sforce.com}DataCategoryGroupSobjectTypePair * java type:
    ...
    private static final com.sforce.ws.bind.TypeInfo pairs__typeInfo = new com.sforce.ws.bind.TypeInfo(
            "urn:partner.soap.sforce.com", "pairs", "urn:partner.soap.sforce.com", "DataCategoryGroupSobjectTypePair", 0, 100,
            true);
    ...
    /** * element : topCategoriesOnly of type {http://www.w3.org/2001/XMLSchema}boolean * java type: boolean */
    private static final com.sforce.ws.bind.TypeInfo topCategoriesOnly__typeInfo = new com.sforce.ws.bind.TypeInfo(
            "urn:partner.soap.sforce.com", "topCategoriesOnly", "http://www.w3.org/2001/XMLSchema", "boolean", 1, 1, true);
    ...
    protected void loadFields(com.sforce.ws.parser.XmlInputStream __in, com.sforce.ws.bind.TypeMapper __typeMapper)
        ...
        if (__typeMapper.isElement(__in, pairs__typeInfo)) {
            setPairs((com.sforce.soap.partner.DataCategoryGroupSobjectTypePair[]) __typeMapper.readObject(__in, pairs__typeInfo,
                    com.sforce.soap.partner.DataCategoryGroupSobjectTypePair[].class));
        }
        __in.peekTag();
