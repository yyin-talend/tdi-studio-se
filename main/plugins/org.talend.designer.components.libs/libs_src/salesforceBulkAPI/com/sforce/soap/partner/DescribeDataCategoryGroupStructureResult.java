...
public class DescribeDataCategoryGroupStructureResult implements com.sforce.ws.bind.XMLizable {
    ...
    /**
     * * element : topCategories of type {urn:partner.soap.sforce.com}DataCategory * java type:
    ...
    private static final com.sforce.ws.bind.TypeInfo topCategories__typeInfo = new com.sforce.ws.bind.TypeInfo(
            "urn:partner.soap.sforce.com", "topCategories", "urn:partner.soap.sforce.com", "DataCategory", 0, -1, true);
    ...
    protected void loadFields(com.sforce.ws.parser.XmlInputStream __in, com.sforce.ws.bind.TypeMapper __typeMapper)
        ...
        if (__typeMapper.isElement(__in, topCategories__typeInfo)) {
            setTopCategories((com.sforce.soap.partner.DataCategory[]) __typeMapper.readObject(__in, topCategories__typeInfo,
