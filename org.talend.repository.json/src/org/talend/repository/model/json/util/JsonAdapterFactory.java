...
public class JsonAdapterFactory extends AdapterFactoryImpl {
    ...
    protected JsonSwitch<Adapter> modelSwitch =
        new JsonSwitch<Adapter>() {
            @Override
            public Adapter caseJSONFileConnection(JSONFileConnection object) {
                return createJSONFileConnectionAdapter();
            }
            @Override
            public Adapter caseJSONFileConnectionItem(JSONFileConnectionItem object) {
                return createJSONFileConnectionItemAdapter();
            }
            @Override
            public Adapter caseJSONXPathLoopDescriptor(JSONXPathLoopDescriptor object) {
                return createJSONXPathLoopDescriptorAdapter();
            }
            @Override
            public Adapter caseJSONFileNode(JSONFileNode object) {
                return createJSONFileNodeAdapter();
            }
            @Override
    ...
    /**
     * Creates a new adapter for an object of class '{@link org.talend.repository.model.json.JSONFileConnection <em>JSON File Connection</em>}'.
     * <!-- begin-user-doc -->
     ...
     * @generated
     */
    public Adapter createJSONFileConnectionAdapter() {
        return null;
    }

    /**
     * Creates a new adapter for an object of class '{@link org.talend.repository.model.json.JSONFileConnectionItem <em>JSON File Connection Item</em>}'.
     * <!-- begin-user-doc -->
     * This default implementation returns null so that we can easily ignore cases;
     * it's useful to ignore a case when inheritance will catch all the cases anyway.
     * <!-- end-user-doc -->
     ...
     * @generated
     */
    public Adapter createJSONFileConnectionItemAdapter() {
        return null;
    }

    /**
     * Creates a new adapter for an object of class '{@link org.talend.repository.model.json.JSONXPathLoopDescriptor <em>JSONX Path Loop Descriptor</em>}'.
     * <!-- begin-user-doc -->
     * This default implementation returns null so that we can easily ignore cases;
     * it's useful to ignore a case when inheritance will catch all the cases anyway.
     * <!-- end-user-doc -->
     ...
     * @generated
     */
    public Adapter createJSONXPathLoopDescriptorAdapter() {
        return null;
    }

    /**
     * Creates a new adapter for an object of class '{@link org.talend.repository.model.json.JSONFileNode <em>JSON File Node</em>}'.
     * <!-- begin-user-doc -->
     * This default implementation returns null so that we can easily ignore cases;
     * it's useful to ignore a case when inheritance will catch all the cases anyway.
     * <!-- end-user-doc -->
     ...
     * @generated
     */
    public Adapter createJSONFileNodeAdapter() {
        return null;
    }

    /**
     * Creates a new adapter for an object of class '{@link org.talend.repository.model.json.SchemaTarget <em>Schema Target</em>}'.
     * <!-- begin-user-doc -->
     * This default implementation returns null so that we can easily ignore cases;
     * it's useful to ignore a case when inheritance will catch all the cases anyway.
     * <!-- end-user-doc -->
