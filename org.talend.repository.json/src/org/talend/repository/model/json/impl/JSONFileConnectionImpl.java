...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>JSON File Connection</b></em>'.
 * <!-- end-user-doc -->
 * <p>
...
public class JSONFileConnectionImpl extends ConnectionImpl implements JSONFileConnection {
    ...
    /**
     * The cached value of the '{@link #getSchema() <em>Schema</em>}' reference list.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see #getSchema()
     * @generated
    ...
    public EList<JSONXPathLoopDescriptor> getSchema() {
        if (schema == null) {
            schema = new EObjectWithInverseResolvingEList<JSONXPathLoopDescriptor>(JSONXPathLoopDescriptor.class, this, JsonPackage.JSON_FILE_CONNECTION__SCHEMA, JsonPackage.JSONX_PATH_LOOP_DESCRIPTOR__CONNECTION);
        }
        return schema;
    }
