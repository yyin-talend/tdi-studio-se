...
public class AlfrescoOutputModelManager {
	...
	public void load() throws AlfrescoOutputException {
        ...
        List<Map<String,String>> availableModelsTable = (List<Map<String,String>>) alfrescoOutputComponent.getElementParameter(PARAM_AVAILABLE_MODELS).getValue(); // TABLE
        ...
        List<Map<String,String>> availableNamespacesTable = (List<Map<String,String>>) alfrescoOutputComponent.getElementParameter(PARAM_AVAILABLE_NAMESPACES).getValue(); // TABLE
        ...
        List<Map<String,String>> aspectNamesTable = (List<Map<String,String>>) alfrescoOutputComponent.getElementParameter(PARAM_ASPECT_NAMES).getValue();
	...
	public void save() {
		// available models :
        List<Map<String,String>> availableModelsTable = (List<Map<String,String>>)
        		alfrescoOutputComponent.getElementParameter(PARAM_AVAILABLE_MODELS).getValue(); // TABLE
        ...
        List<Map<String,String>> availableNamespacesTable = (List<Map<String,String>>)
        		alfrescoOutputComponent.getElementParameter(PARAM_AVAILABLE_NAMESPACES).getValue(); // TABLE
		...
		// chosen aspects :
        List<Map<String,String>> aspectNamesTable = (List<Map<String,String>>)
        		alfrescoOutputComponent.getElementParameter(PARAM_ASPECT_NAMES).getValue(); // TABLE
	...
	protected void saveMetadatas(String metadataMappingParamName, Map<String,Element> metadataMap) {
		List<Map<String,String>> metadataMappingTable = (List<Map<String,String>>) alfrescoOutputComponent
