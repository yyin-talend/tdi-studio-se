 ...
 * @generated
 */
public class BusinessItemRelationshipNameEditPart extends LabelEditPart implements ITextAwareEditPart {
     ...
     * @generated
     */
    public BusinessItemRelationshipNameEditPart(View view) {
        super(view);
    }
            ...
            ParserHintAdapter hintAdapter = new ParserHintAdapter(getParserElement(), parserHint) {
                ...
                public Object getAdapter(Class adapter) {
                    if (IElementType.class.equals(adapter)) {
                        return BusinessElementTypes.BusinessItemRelationship_3001;
                    }
    ...
    protected IFigure createFigurePrim() {
        return new BusinessItemRelationshipNameFigure();
    }
