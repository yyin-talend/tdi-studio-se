 ...
 * @generated
 */
public class DirectionalBusinessItemRelationshipNameEditPart extends LabelEditPart implements ITextAwareEditPart {
     ...
     */
    static {
        registerSnapBackPosition(BusinessVisualIDRegistry
                .getType(DirectionalBusinessItemRelationshipNameEditPart.VISUAL_ID), new Point(0, 40));
    }

    /**
     * @generated
     */
    public DirectionalBusinessItemRelationshipNameEditPart(View view) {
        super(view);
    }
    ...
    public void setLabelText(String text) {
        ...
        if (pdEditPolicy instanceof BusinessTextSelectionEditPolicy) {
            ((BusinessTextSelectionEditPolicy) pdEditPolicy).refreshFeedback();
        }
    }
            ...
            ParserHintAdapter hintAdapter = new ParserHintAdapter(getParserElement(), parserHint) {
                ...
                public Object getAdapter(Class adapter) {
                    if (IElementType.class.equals(adapter)) {
                        return BusinessElementTypes.DirectionalBusinessItemRelationship_3002;
                    }
    ...
    protected DirectEditManager getManager() {
        if (manager == null) {
            setManager(new TextDirectEditManager(this, TextDirectEditManager.getTextCellEditorClass(this),
                    BusinessEditPartFactory.getTextCellEditorLocator(this)));
        }
        return manager;
    }
    ...
    protected IFigure createFigurePrim() {
        return new DirectionalBusinessItemRelationshipNameFigure();
    }

    /**
     * @generated
     */
    public class DirectionalBusinessItemRelationshipNameFigure extends
