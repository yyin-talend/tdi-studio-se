 ...
 * @generated
 */
public class DatabaseBusinessItemViewFactory extends AbstractShapeViewFactory {

    /**
     * @generated NOT
     */
    private static final Color DEFAULT_COLOR = new Color(null, new RGB(157, 198, 204));
    ...
    protected void decorateView(View containerView, View view, IAdaptable semanticAdapter, String semanticHint, int index,
        ...
        if (semanticHint == null) {
            semanticHint = BusinessVisualIDRegistry
                    .getType(org.talend.designer.business.model.business.diagram.edit.parts.DatabaseBusinessItemEditPart.VISUAL_ID);
        ...
        getViewService().createNode(semanticAdapter, view,
                BusinessVisualIDRegistry.getType(DatabaseBusinessItemNameEditPart.VISUAL_ID), ViewUtil.APPEND, true,
                getPreferencesHint());
    }
