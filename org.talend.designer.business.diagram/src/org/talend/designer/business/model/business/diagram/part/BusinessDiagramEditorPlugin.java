 ...
 * @generated
 */
public class BusinessDiagramEditorPlugin extends AbstractUIPlugin {

    /**
     * @generated
     */
    public static final String ID = "org.talend.designer.business.diagram"; //$NON-NLS-1$
     ...
     * @generated
     */
    private static BusinessDiagramEditorPlugin instance;
     ...
     * @generated
     */
    public BusinessDiagramEditorPlugin() {
    }
     ...
     * @generated
     */
    public static BusinessDiagramEditorPlugin getInstance() {
        return instance;
    }
    ...
    public void logError(String error, Throwable throwable) {
        ...
        getLog().log(new Status(IStatus.ERROR, BusinessDiagramEditorPlugin.ID, IStatus.OK, error, throwable));
    ...
    public void logInfo(String message, Throwable throwable) {
        ...
        getLog().log(new Status(IStatus.INFO, BusinessDiagramEditorPlugin.ID, IStatus.OK, message, throwable));
