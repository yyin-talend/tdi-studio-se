 ...
 * @generated
 */
public class DecisionBusinessItemViewFactory extends AbstractShapeViewFactory {

    /**
     * @generated NOT
     */
    private static final Color DEFAULT_COLOR = new Color(null, new RGB(135, 206, 235));
    ...
    protected void decorateView(View containerView, View view, IAdaptable semanticAdapter, String semanticHint, int index,
        ...
        if (semanticHint == null) {
            semanticHint = BusinessVisualIDRegistry
                    .getType(org.talend.designer.business.model.business.diagram.edit.parts.DecisionBusinessItemEditPart.VISUAL_ID);
        ...
        getViewService().createNode(semanticAdapter, view,
                BusinessVisualIDRegistry.getType(DecisionBusinessItemNameEditPart.VISUAL_ID), ViewUtil.APPEND, true,
                getPreferencesHint());
    }
